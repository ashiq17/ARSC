...
Autumn term – 31 October</li>
    ...
    <span class="w-meta-value number-animate"  data-animation-duration="1500"><?= $total_parents; ?></span>
                                <span class="w-meta-title">Total Guardian</span>
                            </div>
                        </div>
                         </a>
                    </div>
    ...
    <span class="w-meta-value number-animate"  data-animation-duration="1500"><?= $total_user; ?></span>
                ...
                <div class="row">
                   ...
                   <!--  <img class="img-responsive img-circle" alt="No Image Found" style="width:70px; height:70px; padding: 0px; margin-right: 10px;" src="<?php echo base_url('assets/images/users/').$user[0]['image'] ?>"> -->
                            ...
                            <h2 align="center" style="font-size: 26px;color: #2c3e50; font-weight: 600; text-transform: uppercase;">
                                <?= $title; ?>
                            </h2>
                    ...
                    <div class="col-md-6" style="padding-right: 0px!important;">
                        <div class="box-widget widget-module" style="height: 275px;">
                            <div class="widget-head clearfix">
                                ...
                                <h4><i style="color: #ffffff;" class="fa fa-calendar"></i> Today's Task</h4>
                    ...
                    <div class="col-md-6">
                        <div class="box-widget widget-module" style="height: 275px;">
                            <div class="widget-head clearfix">
                                ...
                                <h4><i style="color: #ffffff;" class="fa fa-star"></i> Fees Collection & Expenses</h4>
                    ...
                    <div class="col-md-6" style="padding-right: 0px!important;">
                        <div class="box-widget widget-module" style="height: 275px;">
                            <div class="widget-head clearfix">
                                ...
                                <h4><i style="color: #ffffff;" class="fa fa-star"> </i> Website Controller</h4>
                    ...
                    <div class="col-md-6">
                        <div class="box-widget widget-module" style="height: 275px;">
                            <div class="widget-head clearfix">
                                ...
                                <h4> <i style="color: #ffffff;" class="fa fa-user-plus"></i> New User</h4>
                            </div>
