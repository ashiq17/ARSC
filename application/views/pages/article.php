...
$get_all_author_published_article = $this->Home_Model->all_author_published_article_finding();
?>

 <section class="container" style="padding:0px;">
	<div class="col-md-8" style="padding:0px;">
		 	<?php foreach ($get_all_author_published_article as $key => $value): ?>
		 		<br>
		<div class="content-grid single_border">					 
