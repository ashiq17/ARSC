...
<!-- 
            ...
            <table id="tblExport" class="table table-striped table-bordered table-hover dataTables-example" style="margin-bottom: 5px;">
                ...
                <thead class="theight">
                    ...
                    <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($marks_result[0]['Marks_Sum_Bangla_Ist'])) { echo  $marks_result[0]['Marks_Sum_Bangla_Ist'];
                    } ?></strong></td> 
                    <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($marks_result[0]['Marks_Sum_Bangla_2nd'])) { echo  $marks_result[0]['Marks_Sum_Bangla_2nd'];
                    } ?></strong></td> 

                    <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($marks_result[0]['Marks_Sum_English_1st'])) { echo  $marks_result[0]['Marks_Sum_English_1st'];
                    } ?></strong></td>
                    <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($marks_result[0]['Marks_Sum_English_2nd'])) { echo  $marks_result[0]['Marks_Sum_English_2nd'];
                    } ?></strong></td>
                    ...
                    <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($marks_result[0]['Marks_Sum_Agri_H_Science'])) { echo  $marks_result[0]['Marks_Sum_Agri_H_Science'];
                    } ?></strong></td>
                     <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($marks_result[0]['Marks_Sum_ICT'])) { echo  $marks_result[0]['Marks_Sum_ICT'];
                    } ?></strong></td> 
