                ...
                <div class="col-md-12 ">
                    <div class="wrapper wrapper-content">
                        <div class="ibox float-e-margins">
                                    ...
                                    <h4 style="font-size: 15px; margin-top: 0px; text-align: center">All Student Exam Result Creation <strong></strong></h4>
                                    </div>
                                ...
                                <div class="panel-heading">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade in active" id="tab1default">
                                            <form class="well form-horizontal" action="<?php echo base_url();?>exam/exam/create_exam_report_position" method="post" target="_blank" enctype="multipart/form-data">
