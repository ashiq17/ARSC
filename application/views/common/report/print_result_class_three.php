                                    ...
                                    <tbody class="theight">
                                        ...
                                        foreach ($print_exam_report_all_find as $key => $value):
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($marks_result[0]['Marks_Sum_Bangla'])) {
                                            ...
                                            ?></strong></td> 
                                                ...
                                                <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($marks_result[0]['Marks_Sum_English'])) {
                                            ...
                                            ?></strong></td>
                                                ...
                                                <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($marks_result[0]['Marks_Sum_Moktab'])) {
                                                        echo $marks_result[0]['Marks_Sum_Moktab'];
                                                    }
                                            ?></strong></td>
                                                <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($marks_result[0]['Marks_Sum_Practical'])) {
