                        ...
                        <div class="" style="margin-top: 1px;">
                            ...
                            <div class="company-head" style="">
                                ...
                                <span><p class=""><?php
                                        ...
                                        ?></p></span>
                               <!--  <span><p class="backside_bottom"><?php
                            ...
                            <div class="ibox-title" style="height:55px; padding: 0px">
                                <h6 style="font-size: 17px; margin-top: 0px; margin-bottom: 2px;">  <strong> <?php
                                        if (!empty($exam_name)) {
                                            echo $exam_name;
                                        }
                                ?></strong></h6>
                                ...
                                <table id="tblExport" class="table table-striped table-bordered table-hover dataTables-example" style="margin-bottom: 5px;">
                                    ...
                                    <thead class="theight">
                                        ...
                                        <tr>
                                            ...
                                            <th style="width: 7%;  text-align: center"><span style="margin-left:10px; ">Environment</span></th> 
                                            <th style="width: 7%;  text-align: center"><span style="margin-left:10px; ">G. Knowledge </span></th> 
                                            <th style="width: 6%;  text-align: center"><span style="margin-left:10px; ">Drowing</span></th> 
                                    ...
                                    <tbody class="theight">
                                        ...
                                        foreach ($print_exam_report_all_find as $key => $value):
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 10%; text-align:left"><strong style="margin-left:10px;"><?php
                                                        if (!empty($value['Std_Name'])) {
                                                            echo $value['Std_Name'];
                                                        }
                                                        ?></strong></td>
                                                <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php
                                                        if (!empty($value['STD_UNQ_ID'])) {
                                                            echo $value['STD_UNQ_ID'];
                                                        }
                                                        ?></strong></td> 
                                                <td style="width: 4%; text-align:center"><strong style="margin-left:10px;"><?php
                                                    if (!empty($value['Std_roll'])) {
                                                        echo $value['Std_roll'];
                                                    }
                                                        ?></strong></td> 
                                                <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php
                                                    if (!empty($marks_result[0]['Marks_Sum_Bangla'])) {
                                                        echo $marks_result[0]['Marks_Sum_Bangla'];
                                                    }
                                                        ?></strong></td> 
                                                <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php
                                                ...
                                                <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php
                                                        if (!empty($marks_result[0]['Marks_Sum_English'])) {
                                                            echo $marks_result[0]['Marks_Sum_English'];
                                                        }
                                                        ?></strong></td>
                                                <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php
                                                        if (!empty($marks_result[0]['Marks_Sum_Arabic'])) {
                                                            echo $marks_result[0]['Marks_Sum_Arabic'];
                                                        }
                                                        ?></strong></td>

                                                <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php
                                                    if (!empty($marks_result[0]['Marks_Sum_Environment'])) {
                                                        echo $marks_result[0]['Marks_Sum_Environment'];
                                                    }
                                                        ?></strong></td>
                                                <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php
                                                    if (!empty($marks_result[0]['Marks_Sum_GKnowledge'])) {
                                                        echo $marks_result[0]['Marks_Sum_GKnowledge'];
                                                    }
                                                        ?></strong></td> 

                                                <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php
                                                        if (!empty($marks_result[0]['Marks_Sum_Moktab'])) {
                                                            echo $marks_result[0]['Marks_Sum_Moktab'];
                                                        }
                                                        ?></strong></td>
                                                <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php
                                                        if (!empty($marks_result[0]['Marks_Sum_Drawing'])) {
                                                            echo $marks_result[0]['Marks_Sum_Drawing'];
                                                        }
                                                        ?></strong></td>
                                                <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php
                                                        if (!empty($marks_result[0]['Marks_Sum_Practical'])) {
                                                            echo $marks_result[0]['Marks_Sum_Practical'];
                                                        }
                                                        ?></strong></td> 
                                                ...
                                                <td style="width: 7%; text-align:center"><strong style="margin-left:10px;">
                                                        ...
                                                        if (!empty($marks_result[0]['Marks_Sum_Environment'])) {
                                                            $environment = $marks_result[0]['Marks_Sum_Environment'];
                                                        };
                                                        ...
                                                        $TOTAL_MARKS = $bangla + $english + $mathematics + $environment + $gknowledge + $arabic + $moktab + $drawing + $practical;
