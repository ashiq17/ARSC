        ...
        <div class=" float-e-margins">
            ...
            <table id="tblExport" class="table table-striped table-bordered table-hover dataTables-example" style="margin-bottom: 5px;">
                ...
                <thead class="theight">
                    ...
                    <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php echo $marks_result['0']['Marks_Sum_Bangla']; ?></strong></td>

                    <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php echo $marks_result['0']['Marks_Sum_Mathematics']; ?></strong>
                    </td> 
                    <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php echo $marks_result['0']['Marks_Sum_English']; ?></strong></td></td>

                    <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php echo $marks_result['0']['Marks_Sum_Religion']; ?></strong></td>

                    <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php echo $marks_result['0']['Marks_Sum_Computer']; ?></strong></td>
                      <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php echo $marks_result['0']['Marks_Sum_GKnowledge']; ?></strong></td> 
                    
                     <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php echo $marks_result['0']['Marks_Sum_Moktab']; ?></strong></td>
                     
                     <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php echo $marks_result['0']['Marks_Sum_Drawing']; ?></strong></td>
                      <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php echo $marks_result['0']['Marks_Sum_Practical']; ?></strong></td>
                  ...
                  <td style="width: 7%; text-align:center"><strong style="margin-left:10px;">
                    <?php 
                        ...
                        $TOTAL_MARKS  =$bangla+$mathematics+$english+$religion+$computer+$gknowledge+$moktab+$drawing+$practical;
