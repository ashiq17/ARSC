            ...
            <table id="tblExport" class="table table-striped table-bordered table-hover dataTables-example" style="margin-bottom: 5px;">
                ...
                <thead class="theight">
                    ...
                    <tr>
                        ...
                        <th style="width: 12%;  text-align: center"><span style="margin-left:10px; ">G. Knowledge </span></th> 
                       
                        <th style="width: 12%;  text-align: center"><span style="margin-left:10px; ">Practical</span></th> 
                       
                        <th style="width: 14%;  text-align: center"><span style="margin-left:10px; ">Total Marks</span></th> 
                   ...
                   <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($value['Std_roll'])) {echo $value['Std_roll'];} ?></strong></td> 
                    ...
                    <td style="width: 12%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($marks_result[0]['Marks_Sum_GKnowledge'])) { echo  $marks_result[0]['Marks_Sum_GKnowledge'];
                    } ?></strong></td> 
                   
                     <td style="width: 12%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($marks_result[0]['Marks_Sum_Practical'])) { echo  $marks_result[0]['Marks_Sum_Practical'];
                    } ?></strong></td> 

                  <td style="width: 14%; text-align:center"><strong style="margin-left:10px;">
                      <?php  
                        ...
                        $TOTAL_MARKS  =$bangla+$english+$mathematics+$arabic+$gknowledge+$practical;
