        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                ?></p>
                                ...
                                <h6 style="font-size: 17px; margin-top: 0px; margin-bottom: 2px;">  <strong> <?php if (!empty($exam_name)) {
                                            echo $exam_name;
                                        } ?></strong></h6>
                                ...
                                <table id="tblExport" class="table table-striped table-bordered table-hover dataTables-example" style="margin-bottom: 5px;">
                                    ...
                                    <thead class="theight">
                                        ...
                                        <tr>
                                            ...
                                            <th style="width: 7%;  text-align: center"><span style="margin-left:10px; ">Bangla 1st Paper</span></th> 
                                            <th style="width: 7%;  text-align: center"><span style="margin-left:10px; ">Bangla 2nd Paper</span></th> 
                                            <th style="width: 7%;  text-align: center"><span style="margin-left:10px; ">English 1st Paper</span></th> 
                                            <th style="width: 7%;  text-align: center"><span style="margin-left:10px; ">English 2nd Paper</span></th> 
                                            ...
                                            <th style="width: 7%;  text-align: center"><span style="margin-left:10px; ">Agri./H. Science</span></th> 
                                            <th style="width: 7%;  text-align: center"><span style="margin-left:10px; ">I.C.T </span></th> 
                                        ...
                                        foreach ($print_exam_report_all_find as $key => $value):
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($value['STD_UNQ_ID'])) {
                                                        echo $value['STD_UNQ_ID'];
                                                    }
                                            ?></strong></td> 
                                                <td style="width: 4%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($value['Std_roll'])) {
                                                        echo $value['Std_roll'];
                                                    } ?></strong></td> 
                                                <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($marks_result[0]['Marks_Sum_Bangla_Ist'])) {
                                                        echo $marks_result[0]['Marks_Sum_Bangla_Ist'];
                                                    }
                                            ?></strong></td> 
                                                <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($marks_result[0]['Marks_Sum_Bangla_2nd'])) {
                                                        echo $marks_result[0]['Marks_Sum_Bangla_2nd'];
                                                    }
                                                    ?></strong></td> 

                                                <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($marks_result[0]['Marks_Sum_English_1st'])) {
                                                        echo $marks_result[0]['Marks_Sum_English_1st'];
                                                    }
                                            ?></strong></td>
                                                <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($marks_result[0]['Marks_Sum_English_2nd'])) {
                                                        echo $marks_result[0]['Marks_Sum_English_2nd'];
                                                    }
                                            ?></strong></td>
                                                <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($marks_result[0]['Marks_Sum_Mathematics'])) {
                                                        echo $marks_result[0]['Marks_Sum_Mathematics'];
                                                    }
                                            ?></strong></td>

                                                <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($marks_result[0]['Marks_Sum_B_G_Science'])) {
                                                        echo $marks_result[0]['Marks_Sum_B_G_Science'];
                                                    }
                                            ?></strong></td>
                                                <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($marks_result[0]['Marks_Sum_Science'])) {
                                                        echo $marks_result[0]['Marks_Sum_Science'];
                                                    }
                                            ?></strong></td> 
                                                <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($marks_result[0]['Marks_Sum_Religion'])) {
                                                        echo $marks_result[0]['Marks_Sum_Religion'];
                                                    }
                                            ?></strong></td>

                                                <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($marks_result[0]['Marks_Sum_Agri_H_Science'])) {
                                                        echo $marks_result[0]['Marks_Sum_Agri_H_Science'];
                                                    }
                                            ?></strong></td>
                                                <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($marks_result[0]['Marks_Sum_ICT'])) {
                                                        echo $marks_result[0]['Marks_Sum_ICT'];
                                                    }
                                            ?></strong></td> 

                                                <td style="width: 7%; text-align:center"><strong style="margin-left:10px;">
                                                        <?php
                                                        if (!empty($marks_result[0]['Marks_Sum_Bangla_Ist'])) {
                                                            $bangla_1st = $marks_result[0]['Marks_Sum_Bangla_Ist'];
                                                        };

                                                        if (!empty($marks_result[0]['Marks_Sum_Bangla_2nd'])) {
                                                            $bangla_2nd = $marks_result[0]['Marks_Sum_Bangla_2nd'];
                                                        };

                                                        if (!empty($marks_result[0]['Marks_Sum_English_1st'])) {
                                                            $english_1st = $marks_result[0]['Marks_Sum_English_1st'];
                                                        };

                                                        if (!empty($marks_result[0]['Marks_Sum_English_2nd'])) {
                                                            $english_2nd = $marks_result[0]['Marks_Sum_English_2nd'];
                                                        };
                                                        ...
                                                        if (!empty($marks_result[0]['Marks_Sum_Agri_H_Science'])) {
                                                            $agri = $marks_result[0]['Marks_Sum_Agri_H_Science'];
                                                        };

                                                        if (!empty($marks_result[0]['Marks_Sum_ICT'])) {
                                                            $ict = $marks_result[0]['Marks_Sum_ICT'];
                                                        };
                                                        ...
                                                        $TOTAL_MARKS = $bangla_1st + $bangla_2nd + $english_1st + $english_2nd + $mathematics + $bgscience + $science + $religion + $agri + $ict;
