                ...
                <div class="col-md-12 ">
                    <div class="wrapper wrapper-content">
                        <div class="ibox float-e-margins">
                                    ...
                                    <h4 style="font-size: 15px; margin-top: 0px; text-align: center">Student Single Exam Result <strong></strong></h4>
                                    </div>
                                ...
                                <div class="panel-heading">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade in active" id="tab1default">
                                            <form class="well form-horizontal" action="<?php echo base_url();?>exam/exam/print_exam_report_single"  target="_blank" method="post" enctype="multipart/form-data">
                                               ...
                                               <div class="col-md-12" style="text-align: left;">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                            ...
                                                            <option value="" ></option>
                                                                <?php foreach ($all_student_find_unique_id as $key => $value): ?>
