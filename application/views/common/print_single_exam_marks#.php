                        ...
                        <div class="" style="">
                                ...
                                <table class="table table-striped table-hover dataTables-example topics" style="margin-bottom: 2px;">
                                    ...
                                    <div class="company-head" style=" min-height: 82px; margin-top: 0px;">                
                                        <div class="" style="margin-top: 30px;">
                                            ...
                                            <h2 class="text_title"><strong><?php
                            ...
                            <table  class="table " id="table2"  style="width:75%; border: 1px solid #ddd; margin: auto; margin-top: 5px;">
                                ...
                                <tr >
                                    ...
                                    <!-- <th style="width: 1%; text-align: left">:</th> -->
                                    <th style="width: 11%; text-align: left"><?php
                                        if (!empty($info['0']['Section_Name'])) {
                                            echo $info['0']['Section_Name'];
                                        }
                                        ?>  </th>
                                    <th style="width: 4%; text-align: left">Shift :</th>
                                    <!-- <th style="width: 1%; text-align: left">:</th> -->
                                    <th style="width: 10%; text-align: left"><?php
                                        if (!empty($info['0']['Std_shift_ID']) && $info['0']['Std_shift_ID'] == 1) {
                                            echo 'Day';
                                        } elseif (!empty($info['0']['Std_shift_ID']) && $info['0']['Std_shift_ID'] == 2) {
                                            echo 'Morning';
                                        }
                                        ?> </th> 
                                    <th style="width: 9%; text-align: left">Stu. ID No- </th>
                                    <!-- <th style="width: 1%; text-align: left">: </th> -->
                                    <th style="width: 15%; text-align: left">  <?php
                                        if (!empty($info['0']['Marks_stu_UNQ_ID'])) {
                                            echo $info['0']['Marks_stu_UNQ_ID'];
                                        }
                                        ?> </th> 
                                    <!--  <th style="width: 10%; text-align: left"> Group</th>
                                     <th style="width: 1%; text-align: left">:</th>
                                     <th style="width: 10%; text-align: left"><?php
                                    if (!empty($info['0']['Group_Name'])) {
                            ...
                            <div class="">
                                ...
                                foreach ($print_exam_report_single_find as $key => $info):
                                    ...
                                    <?php
                                    if (!empty($info['Marks_stu_sub_total_marks'])) {
                                        ...
                                        foreach ($sub_highest_marks as $key => $sub_highest_marks) {
                                            ...
                                            <tr >
                                               <!-- <th style="width: 2%; text-align: center"><?php echo $sl; ?></th> -->
                                                <th style="width: 20%; text-align: left; padding-left: 15px !important;"><?php
                                                    if (!empty($info['Subject_Name'])) {
                                                        echo $info['Subject_Name'];
                                                    }
                                                    ?></th>
                                                <th style="width: 10%; text-align: center;"> <?php
                                                    if (!empty($info['Marks_stu_sub_full_marks'])) {
                                                        echo $info['Marks_stu_sub_full_marks'];
                                                    }
                                                    ?></th> 
                                                <th style="width: 10%; text-align: center"> <?php
                                                    if (!empty($sub_highest_marks['sub_highest_marks'])) {
                                                        echo $sub_highest_marks['sub_highest_marks'];
                                                    }
                                                    ?></th> 
                                                <th style="width: 10%; text-align: center"> <?php
                                                    if (!empty($info['Marks_stu_sub_ct_marks'])) {
                                                        echo $info['Marks_stu_sub_ct_marks'];
                                                    }
                                                    ?></th>
                                                <th style="width: 10%; text-align: center"> <?php
                                                    if (!empty($info['Marks_stu_sub_mt_marks'])) {
                                                        echo $info['Marks_stu_sub_mt_marks'];
                                                    }
                                                    ?></th>
                                                <th style="width: 8%; text-align: center"> <?php
                                                    if (!empty($info['Marks_stu_sub_mcq_marks'])) {
                                                        echo $info['Marks_stu_sub_mcq_marks'];
                                                    }
                                                    ?></th>
                                                <th style="width: 8%; text-align: center"> <?php
                                                    if (!empty($info['Marks_stu_sub_cq_marks'])) {
                                                        echo $info['Marks_stu_sub_cq_marks'];
                                                    }
                                                    ?></th> 
                                                <th style="width: 8%; text-align: center"> <?php
                                                    if (!empty($info['Marks_stu_sub_total_marks'])) {
                                                        echo $info['Marks_stu_sub_total_marks'];
                                                    }
                                                    ?></th>
                                                <th style="width: 8%; text-align: center"><?php
                                                    if (!empty($info['Marks_stu_sub_total_marks'])) {
