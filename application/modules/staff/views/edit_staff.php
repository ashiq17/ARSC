                              ...
                              <div class="panel-body">
                                 <div class="tab-content">
                                    <div class="tab-pane fade in active" id="tab1default">
                                       ...
                                       <form class=" form-horizontal" action="<?php echo base_url();?>Staff/Staff/Staff_update" method="post" enctype="multipart/form-data">
                                          <fieldset   style="width:900px; margin-top: 10px!important; height:px; text-align:left;margin:auto;" >
                                            <h1 style="text-align: center;color:black;"> <u>Staff Basic Information </u></h1>
                                             ...
                                             <div class="col-md-12" style="margin-top: 20px;">
                                                <div class="col-md-6">
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                       <input value="<?php if (!empty($edit_staff_find[0]['Staff_UniqueID'])) {
                                                            echo $edit_staff_find[0]['Staff_UniqueID'] ;}?>" name="Staff_UniqueID"  class="form-control"  type="text" >
                                                      </div>
                                                   </div> 

                                                   <div class="form-group  col-md-12 ">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left;margin-top: 7px;margin-top: 5px;" class=" control-label"> <span class=""></span>Staff Name</label> 
                                                      </div>
                                                      <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                        <input value="<?php echo $edit_staff_find[0]['Staff_ID'] ?>" name="Staff_ID" type="hidden">
                                                         <input value="<?php if (!empty($edit_staff_find[0]['Staff_Name'])) {
                                                echo $edit_staff_find[0]['Staff_Name'] ;}?>" name="Staff_Name"  class="form-control"  type="text" >
                                                      </div>
                                                   </div>
                                                   ...
                                                   <div class="form-group  col-md-12 ">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                         <input value="<?php if (!empty($edit_staff_find[0]['Staff_FathersName'])) {
                                                echo $edit_staff_find[0]['Staff_FathersName'] ;}?>" name="Staff_FathersName"  class="form-control"  type="text" >
                                                      </div>
                                                   </div>
                                                    ...
                                                    <div class="form-group  col-md-12 ">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                         <input value="<?php if (!empty($edit_staff_find[0]['Staff_MothersName'])) {
                                                echo $edit_staff_find[0]['Staff_MothersName'] ;}?>" name="Staff_MothersName"  class="form-control"  type="text" >
                                                      </div>
                                                   </div>
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                       <input value="<?php if (!empty($edit_staff_find[0]['Staff_IndexNo'])) {
                                                            echo $edit_staff_find[0]['Staff_IndexNo'] ;}?>" name="Staff_IndexNo"  class="form-control"  type="text" >
                                                      </div>
                                                   </div>
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                       <input value="<?php if (!empty($edit_staff_find[0]['Staff_NationalID'])) {
                                                            echo $edit_staff_find[0]['Staff_NationalID'] ;}?>" name="Staff_NationalID"  class="form-control"  type="text" >
                                                      </div>
                                                   </div>
                                                   <div class="form-group col-md-12">
                                                      <div class="col-md-4">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                       <input value="<?php if (!empty($edit_staff_find[0]['Staff_email'])) {
                                                            echo $edit_staff_find[0]['Staff_email'] ;}?>" name="Staff_email"  class="form-control"  type="text" >
                                                      </div>
                                                   </div>
                                                   <div class="form-group col-md-12">
                                                      <div class="col-md-4">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                         <input value="<?php if (!empty($edit_staff_find[0]['Staff_mobile'])) {
                                                            echo $edit_staff_find[0]['Staff_mobile'] ;}?>" name="Staff_mobile"  class="form-control"  type="text" >
                                                      </div>
                                                   </div>
                                                   ...
                                                   <div class="form-group col-md-12 data_1">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer"  style="margin-top:5px;">
                                                         <div class="input-group date">
                                                            ...
                                                            <input id="date1" value="<?php if (!empty($edit_staff_find[0]['Staff_DateOfBirth'])) {echo $edit_staff_find[0]['Staff_DateOfBirth'] ;}?>" name="Staff_DateOfBirth"  class="start_date form-control"  type="text" >
                                                         </div>
                                                      </div>
                                                   </div>
                                                   <div class="form-group col-md-12 data_2">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer"  style="margin-top:5px;">
                                                         <div class="input-group date">
                                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                            <input id="date2" value="<?php if (!empty($edit_staff_find[0]['Staff_joining_date'])) {echo $edit_staff_find[0]['Staff_joining_date'] ;}?>" name="Staff_joining_date"  class="start_date form-control"  type="text" >
                                                         </div>
                                                      </div>
                                                   </div>
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer"  style="margin-top:5px;">
                                                            ...
                                                            <textarea class="form-control" name="Staff_address"  rows="3">
                                                              <?php if (!empty($edit_staff_find[0]['Staff_address'])) {
                                                            echo $edit_staff_find[0]['Staff_address'] ;}?>
                                                            </textarea>
                                                      </div>
                                                   </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                                <select name="Staff_designation" style="text-align:center"  class="form-control selectpicker select2" ">
                                                                <option value="" ></option>
                                                                <?php foreach ($all_active_designation_find as $key => $value): ?>
                                                                    <option value="<?php echo $value['DesignationID']; ?>" <?php if($edit_staff_find['0']['Staff_designation']==$value['DesignationID']) { echo "selected";}?>><?php echo $value['DesignationName'] ?></option>
                                                                <?php endforeach ?>
                                                            </select>
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                         <select name="Staff_BloodGroup"  style="text-align:center "  class="form-control selectpicker select2">
                                                      <option value="1" <?php if ($edit_staff_find['0']['Staff_BloodGroup']=='1') {echo 'selected';} ?>>A</option>

                                                      <option value="2" <?php if ($edit_staff_find['0']['Staff_BloodGroup'] =='2') { echo 'selected';
                                                      }?>>A -</option> 
                                                      <option value="3" <?php if ($edit_staff_find['0']['Staff_BloodGroup'] =='3') { echo 'selected';
                                                      }?>>B +</option>
                                                       <option value="4" <?php if ($edit_staff_find['0']['Staff_BloodGroup'] =='4') { echo 'selected';
                                                      }?>>B -</option> 
                                                      <option value="5" <?php if ($edit_staff_find['0']['Staff_BloodGroup'] =='5') { echo 'selected';
                                                      }?>>AB +</option> 
                                                      <option value="6" <?php if ($edit_staff_find['0']['Staff_BloodGroup'] =='6') { echo 'selected';
                                                      }?>>AB -</option> 
                                                      <option value="7" <?php if ($edit_staff_find['0']['Staff_BloodGroup'] =='7') { echo 'selected';
                                                      }?>>O +</option> 
                                                      <option value="8" <?php if ($edit_staff_find['0']['Staff_BloodGroup'] =='8') { echo 'selected';
                                                      }?>>O -</option>
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                         <select name="Staff_gender"  style="text-align:center "  class="form-control selectpicker">
                                                            <option value="1" <?php if ($edit_staff_find['0']['Staff_gender']=='1') {echo 'selected';} ?>>Male</option>
                                             <option value="2" <?php if ($edit_staff_find['0']['Staff_gender'] =='2') { echo 'selected';
                                             }?>>Female</option>
                                                         </select>
                                                      </div>
                                                   </div>
                                                    <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                         <select name="Staff_marital_status"  style="text-align:left "  class="form-control selectpicker">
                                                            <option value="1" <?php if ($edit_staff_find['0']['Staff_marital_status']=='1') {echo 
                                                               'selected';} ?>>Married</option>
                                                               <option value="2" <?php if ($edit_staff_find['0']['Staff_marital_status'] =='2') { echo 'selected';
                                                               }?>>Unmarried</option>
                                                         </select>
                                                      </div>
                                                   </div> 
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                         <select name="Staff_shift"  style="text-align:left "  class="form-control selectpicker">
                                                             <option value="1" <?php if ($edit_staff_find['0']['Staff_shift']=='1') {echo 
                                                               'selected';} ?>>Day</option>
                                                               <option value="2" <?php if ($edit_staff_find['0']['Staff_shift'] =='2') { echo 'selected';
                                                               }?>>Morning</option>
                                                         </select>
                                                      </div>
                                                   </div> 
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                         <select name="Staff_medium"  style="text-align:left "  class="form-control selectpicker">
                                                            <option value="1" <?php if ($edit_staff_find['0']['Staff_medium']=='1') {echo 
                                                               'selected';} ?>>Bangla</option>
                                                               <option value="2" <?php if ($edit_staff_find['0']['Staff_medium'] =='2') { echo 'selected';
                                                               }?>>English</option>
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                         <select name="Staff_religion"  style="text-align:center "  class="form-control selectpicker">
                                                          <option value="1" <?php if ($edit_staff_find['0']['Staff_religion']=='1') {echo 
                                                               'selected';} ?>>MUSLIM</option>
                                                               <option value="2" <?php if ($edit_staff_find['0']['Staff_religion'] =='2') { echo 'selected';
                                                               }?>>HINDU</option>
                                                                  <option value="3" <?php if ($edit_staff_find['0']['Staff_religion'] =='3') { echo 'selected';
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                         ...
                                                         <input type="hidden"  id="old"  name="old_image"  value="<?php echo $edit_staff_find['0']['Image']; ?>">
                                                         <input type="file" name="image"  id="imgInp" class="form-control" style="padding-top:5px;">
                                                         <br>
                                                         <img  class="img-responsive" style="width:80px;height:70px;" alt="No Image Found" id="blah"  src="<?php echo base_url('/images/Staff/').$edit_staff_find['0']['Image'];?>"/>
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8  inputGroupContainer selectContainer" style="margin-top:2px;">
                                                         ...
                                                         <option value="1" <?php if ($edit_staff_find['0']['Staff_status']==1) {echo 
                                                   'selected';} ?>>Active</option>
                                                   <option value="2" <?php if ($edit_staff_find['0']['Staff_status'] ==2) { echo 'selected';
                                                   }?>>Inactive</option>
                                                         </select>
                                                      </div>
                                                   </div>
