                            ...
                            <div class="ibox-content col-md-12" style="padding:2px 0;">
                                <div class="panel with-nav-tabs panel-default">
                                    <div class="panel-heading">
                                         <h3 style="color:black; text-align: center"> Teacher Basic Info. Report</h3> 
                                        <h5 style="color:red; text-align: center">Please Search Here</h5
                                    </div>
                                    <div class="panel-body">
                                    <div class="tab-content">
                                        <div class="tab-pane fade in active" id="tab1default">
                                            <form class="well form-horizontal" action="<?php echo base_url();?>teacher/teacher/print_all_teacher" method="post" enctype="multipart/form-data">
