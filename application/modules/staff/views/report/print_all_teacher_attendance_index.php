                                            ...
                                            <div class="col-md-12">
                                               <div class="col-md-12" style="text-align: left;">
                                                 <div class="form-group col-md-12 data_1">
                                                   ...
                                                   <!--  <div class="form-group col-md-12 data_1">
                                                        <div class="col-md-4">
                                                            <label style="" class=" control-label"> <span class=""></span> Month 2018 </label>
                                                        </div>  
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <div class="col-md-4">
                                                            <label style="" class=" control-label"><span class="" color:red;></span>  Teacher ID  </label>
                                                        </div>  
                                                       <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <div class="col-md-4">
                                                            <label style="" class=" control-label"> <span class="required"></span>  Presrnt Status</label> 
                                                        </div> 
