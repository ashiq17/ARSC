...
<body>
    <div id="wrapper">
        ...
        <nav  style="background-color: #1969ca; color: #fff; ">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item"><a href="#">Admin Panel</a></li>
                <li class="breadcrumb-item active" aria-current="page">Add Class Time</li>
              </ol>
            </nav>
			<section id="">      
                <div class="row">
                                                ...
                                                <table class="table table-striped table-bordered table-hover" id="editable" >
                                                     <thead style=" background: #000000;">
                                                        <tr>
                                                            ...
                                                            <th style="width: 60%; text-align: center;">Class Time Name</th>
                                                    ...
                                                    <tbody class="theight">
                                                    	<?php
                                                    		$sl = 1;
                                                    		foreach($Year_Data as $key=>$allInfo) {
                                                    			?>
                                                    				<tr>
                                                                        <td style="text-align: center;"><?php echo $sl; ?></td>
                                                                        <td style="text-align: center;"><?php echo $allInfo->ClassTime_Name; ?></td>
                                                                        <td style="text-align: center;">
                                                                            <a  
                                                                                data-toggle="modal"
                                                                                data-editid="<?php echo $allInfo->ClassTime_ID; ?>" 
                                                                                data-name="<?php echo $allInfo->ClassTime_Name; ?>" 
                                                                                data-activestatus="<?php echo $allInfo->ClassTime_Status; ?>"  
                                                                            ...
                                                                            <a href="<?= base_url() ?>academic/academic/ClassTime_delete/<?= $allInfo->ClassTime_ID ?>" onClick="return confirm('Are you sure want to delete?')">
	...
	<div class="modal" id="newClassModal" role="dialog"  aria-hidden="true">
        <div class="modal-dialog" >
            <div class="modal-content animated fadeIn">
                <div class="ibox-title" style="text-align: center; border-bottom: 2px solid #222c43;">
                    <h3><strong>New Class Time Entry Form</strong></h3>
                </div>
            	<form class="form-horizontal form_class" id="form_id" role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>academic/academic/new_classTime_entry">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-12" style="padding-top: 10px;">
                                    <div class="col-lg-3" style="text-align: right;">
                                        <h5><strong>Class Time Name :</strong></h5>
                                    </div>
                                    <div class="col-lg-8">
                                        <input type="text" name="ClassTime_Name" id="stname"  placeholder="Please input Name" class="form-control" required> 
                                    </div>
                                </div>
     ...
     <script>
        ...
        $(document).on("click", ".open-deleteModal", function () {
            var ClassTime_ID = $(this).attr('data-professionid');
             alert(ClassTime_ID);
            var ClassTime_Name = $(this).attr('data-title');
               alert(ClassTime_Name);
            $("#ClassTime_Name").html(ClassTime_Name);
            $("#delete_ClassTime_ID").val(ClassTime_ID);
    ...
    <div class="modal fade" id="deleteModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url();?>academic/academic/classTime_delete" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div id="media-upload" class="panel blank-panel">
                            <input type="hidden" id="delete_ClassTime_ID" name="delete_ClassTime_ID" value="">
	...
	<div class="modal" id="divisionEdit" role="dialog"  aria-hidden="true">
        <div class="modal-dialog" >
            <div class="modal-content animated fadeIn">
                <div class="ibox-title" style="text-align: center; border-bottom: 2px solid #222c43;">
                    <h3><strong>ClassTimeUpdate Form</strong></h3>
                </div>
            	<form class="form-horizontal form_class" id="form_id" role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>academic/academic/update_classTime_entry">
                   <div class="ibox-content" style="padding-top: 10px;">
                    <!--<p>Sign in today for more expirience.</p>-->
