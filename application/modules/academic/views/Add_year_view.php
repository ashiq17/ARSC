...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
			<div class="row border-bottom">
               ...
               <div class="row  border-bottom white-bg dashboard-header">
                <div class="col-xs-6 col-sm-4">
                    <a data-toggle="modal"  class="btn btn-info" href="#newYearModal">&nbsp;Create New</a>
                </div>
            </div>
			...
			<section id="">
                                                ...
                                                <table class="table table-striped table-bordered table-hover" id="editable" >
                                                     <thead style=" background: #000000;">
                                                        <tr>
                                                            ...
                                                            <th style="width: 60%; text-align: center;">Year</th>
                                                    		...
                                                    		foreach($Year_Data as $key=>$allInfo) {
                                                    			?>
                                                    				<tr>
                                                                        ...
                                                                        <td style="text-align: center;"><?php echo $allInfo->Year_Name; ?></td>
                                                                        <td style="text-align: center;">
                                                                            <a  
                                                                                data-toggle="modal"
                                                                                data-editid="<?php echo $allInfo->Year_ID; ?>" 
                                                                                data-name="<?php echo $allInfo->Year_Name; ?>" 
                                                                                data-activestatus="<?php echo $allInfo->Year_status; ?>"  
                ...
                <a href="<?= base_url() ?>academic/academic/year_delete/<?= $allInfo->Year_ID ?>" onClick="return confirm('Are you sure want to delete?')">
  <button class="btn btn-danger btn-xs">
	...
	<div class="modal" id="newYearModal" role="dialog"  aria-hidden="true">
        <div class="modal-dialog" >
            <div class="modal-content animated fadeIn">
                <div class="ibox-title" style="text-align: center; border-bottom: 2px solid #222c43;">
                    <h3><strong>New Year Entry Form</strong></h3>
                </div>
            	<form class="form-horizontal form_class" id="form_id" role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>academic/academic/new_year_entry">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-12" style="padding-top: 10px;">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="Year_Name" id="stname"  placeholder="Please input Name" class="form-control" required> 
                                    </div>
                                </div>
     ...
     <script>
        ...
        $(document).on("click", ".open-deleteModal", function () {
            var Year_ID = $(this).attr('data-professionid');
             alert(Year_ID);
            var Year_Name = $(this).attr('data-title');
               alert(Year_Name);
            $("#Year_Name").html(Year_Name);
            $("#delete_Year_ID").val(Year_ID);
    ...
    <div class="modal fade" id="deleteModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url();?>academic/academic/year_delete" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div id="media-upload" class="panel blank-panel">
                            <input type="hidden" id="delete_Year_ID" name="delete_Year_ID" value="">
	...
	<div class="modal" id="divisionEdit" role="dialog"  aria-hidden="true">
        <div class="modal-dialog" >
            <div class="modal-content animated fadeIn">
                <div class="ibox-title" style="text-align: center; border-bottom: 2px solid #222c43;">
                    <h3><strong>Year Update Form</strong></h3>
                </div>
            	<form class="form-horizontal form_class" id="form_id" role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>academic/academic/update_year_entry">
                   <div class="ibox-content" style="padding-top: 10px;">
                    <!--<p>Sign in today for more expirience.</p>-->
