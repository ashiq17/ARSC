                  ...
                  <div class="wrapper wrapper-content">
                     <div class="ibox float-e-margins">
                        <div class="ibox-title" style="background:#1979ca">
                           <h5 style="color:#ffffff;"><i class="fa fa-plus"></i>Add Subject With Class </h5>
                           <div class="ibox-tools">
                              <a class="btn btn-primary" style="padding: 0 10px 0 10px;" href="<?php echo base_url();?>fees/fees/fees_invoice"><i class='fa fa-eye'></i> Subject With Class List</a>
                                 ...
                                 <div class="tab-content">
                                    <div class="tab-pane fade in active" id="tab1default">
                                       <div class="panel-body" id="emp_basic_info1" style="display:none;">
                                         ...
                                         <h3 align="center" style="margin-top: 15px!important;">Add Subject With Class </h3>
                                             ...
                                             for (i = 1; i <= data.total; i++) {  
                                              ...
                                              // $('#present_status'+i).find(":selected").text();
                                                ...
                                                $("#voucher_container").append('<tr id="trr_'+i+'" class="gradeC">'
                                                   +'<td>'+i+'</td>'
                                                   +'<input type="hidden" readonly class="form-control" name="Class_ID[]" style="width: 100%; text-align:center" value="'+data.exam_routine_List[i]['Class_ID']+'">' 
                                                   +'<input type="hidden" readonly class="form-control" name="Group_ID[]" style="width: 100%; text-align:center" value="'+data.exam_routine_List[i]['Group_ID']+'">'
                                                   +'<input type="hidden" readonly class="form-control"  name="Section_ID[]" style="width: 100%; text-align:center" value="'+data.exam_routine_List[i]['Section_ID']+'">'
                                                   +'<input type="hidden" readonly class="form-control" name="Medium_ID[]" style="width: 100%; text-align:center" value="'+data.exam_routine_List[i]['Medium_ID']+'">'
                                                   +'<input type="hidden" readonly class="form-control" name="Shift_ID[]" style="width: 100%; text-align:center" value="'+data.exam_routine_List[i]['Shift_ID']+'">'
                                                  ...
                                                  +'<td>'+'<input type="text" readonly class="form-control" name="exam_date[]" style="width: 100%; text-align:center" value=<?= date("Y")?>>'+'</td>'
                                                   +'<td>'+'<input type="text"  class="form-control" name="Subject_Code[]" style="width: 100%; text-align:center" value="'+data.exam_routine_List[i]['Subject_Code']+'">'+'</td>' 
                                                +'</tr>');
                                       ...
                                       <form action=""  id="form1" role="form" name="allVoucherEntryForm" method="post" enctype="multipart/form-data">
                                          ...
                                          <div class="ibox-content" >
                                             ...
                                             <div class="col-md-12" style="padding-top: 10px; border-top: 1px solid #e7eaec;">
                                                <div class="row">
                                                   <div class="col-md-12">
                                                      <label class="col-md-10" style="text-align: right; padding: 0px;" for="item_name">Total Sunject = </label>
                                          ...
                                          <div class="row">
                                             <div class="form-group col-md-6 col-md-offset-2" style="margin-top:0px;padding: 0px">
                                                ...
                                                <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                   <select class="form-control select2" name="Exam_routine_UNQ_ID" id="Exam_routine_UNQ_ID" required="required">
                                                      <option value=""></option>
                                                        <option value="">Select an option</option>
                                                      <option value="1" >1st Term Exam</option>
                                                      <option value="2"> 2nd Term Exam</option>
                                                      <option value="3"> 3rd Term Exam</option>
                                                   </select>
                                               ...
                                               <div class="col-md-12 col-md-offset-3">
                                                   <div class="form-horizontal" style="">
                                                       <div class="col-md-3" style="padding-bottom:0.5%;">  
                                                           <button style="width: 100%;" class="btn btn-primary" onclick="submitForm('<?php echo base_url();?>exam/exam/exam_routine_creation')"><i class="fa fa-floppy-o"></i> Save</button>
                                                       </div>
                                                       <div class="col-md-3" style="padding-bottom:0.5%;">
