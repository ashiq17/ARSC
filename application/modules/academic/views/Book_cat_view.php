        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row  border-bottom white-bg dashboard-header">
                <div class="col-xs-6 col-sm-4">
                    ...
                    <a data-toggle="modal"  class="btn btn-info" href="#newbookcatModal">&nbsp;Create New</a>
                </div>
...
<nav aria-label="breadcrumb" style="background-color: #1969ca; color: #fff;">
    ...
    <li class="breadcrumb-item active" aria-current="page">Add Book Category</li>
           ...
           <!-- OPT IN SECTION
			...
			<section id="">
                                                ...
                                                <table class="table table-striped table-bordered table-hover" id="editable" >
                                                     <thead style=" background: #000000;">
                                                        <tr>
                                                            ...
                                                            <th style="width: 60%; text-align: center;">Book Categry Name</th>
                                                    ...
                                                    <tbody class="theight">
                                                    	<?php
                                                    		$sl = 1;
                                                    		foreach($bookCat_Data as $key=>$allInfo) {
                                                    			?>
                                                    				<tr>
                                                                        <td style="text-align: center;"><?php echo $sl; ?></td>
                                                                        <td style="text-align: center;"><?php echo $allInfo->Book_cat_Name; ?></td>
                                                                        <td style="text-align: center;">
                                                                            <a  
                                                                                data-toggle="modal"
                                                                                data-editid="<?php echo $allInfo->Book_cat_ID; ?>" 
                                                                                data-name="<?php echo $allInfo->Book_cat_Name; ?>" 
                                                                                data-activestatus="<?php echo $allInfo->Book_cat_Status; ?>"  
                ...
                <a href="<?= base_url() ?>academic/academic/book_cat_delete/<?= $allInfo->Book_cat_ID ?>" onClick="return confirm('Are you sure want to delete?')">
  <button class="btn btn-danger btn-xs">
	...
	<div class="modal" id="newbookcatModal" role="dialog"  aria-hidden="true">
        <div class="modal-dialog" >
            <div class="modal-content animated fadeIn">
                <div class="ibox-title" style="text-align: center; border-bottom: 2px solid #222c43;">
                    <h3><strong>New Book Category Entry Form</strong></h3>
                </div>
            	<form class="form-horizontal form_class" id="form_id" role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>academic/academic/book_cat_entry">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-12" style="padding-top: 10px;">
                                    <div class="col-lg-3" style="text-align: right;">
                                        <h5><strong>Book Category Name :</strong></h5>
                                    </div>
                                    <div class="col-lg-8">
                                        <input type="text" name="Book_cat_Name" id="stname"  placeholder="Please input Name" class="form-control" required> 
                                    </div>
                                </div>
	...
	<div class="modal" id="divisionEdit" role="dialog"  aria-hidden="true">
        <div class="modal-dialog" >
            <div class="modal-content animated fadeIn">
                <div class="ibox-title" style="text-align: center; border-bottom: 2px solid #222c43;">
                    <h3><strong>Book Category Update Form</strong></h3>
                </div>
            	<form class="form-horizontal form_class" id="form_id" role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>academic/academic/update_book_cat_entry">
                   <div class="ibox-content" style="padding-top: 10px;">
                    <!--<p>Sign in today for more expirience.</p>-->
