        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row  border-bottom white-bg dashboard-header">
                <div class="col-xs-6 col-sm-4">
                    ...
                    <a data-toggle="modal"  class="btn btn-info" href="#newexpensecatModal">&nbsp;Create New</a>
                </div>
...
<nav aria-label="breadcrumb" style="background-color: #1969ca; color: #fff;">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Add Expense Category</li>
  </ol>
</nav>
           ...
           <!-- OPT IN SECTION
			...
			<section id="">
                                                ...
                                                <table class="table table-striped table-bordered table-hover" id="editable" >
                                                     <thead style=" background: #000000;">
                                                        <tr>
                                                            ...
                                                            <th style="width: 60%; text-align: center;">Expense Categry Name</th>
                                                    ...
                                                    <tbody class="theight">
                                                    	<?php
                                                    		$sl = 1;
                                                    		foreach($expenseCat_Data as $key=>$allInfo) {
                                                    			?>
                                                    				<tr>
                                                                        <td style="text-align: center;"><?php echo $sl; ?></td>
                                                                        <td style="text-align: center;"><?php echo $allInfo->expense_cat_Name; ?></td>
                                                                        <td style="text-align: center;">
                                                                            <a  
                                                                                data-toggle="modal"
                                                                                data-editid="<?php echo $allInfo->expense_cat_ID; ?>" 
                                                                                data-name="<?php echo $allInfo->expense_cat_Name; ?>" 
                                                                                data-activestatus="<?php echo $allInfo->expense_cat_Status; ?>"  
                                                                                class="open-divisionEdit" href="#division1Edit">
                ...
                <a href="<?= base_url() ?>academic/academic/expense_cat_delete/<?= $allInfo->expense_cat_ID ?>" onClick="return confirm('Are you sure want to delete?')">
  <button class="btn btn-danger btn-xs">
	...
	<div class="modal" id="newexpensecatModal" role="dialog"  aria-hidden="true">
        <div class="modal-dialog" >
            <div class="modal-content animated fadeIn">
                <div class="ibox-title" style="text-align: center; border-bottom: 2px solid #222c43;">
                    <h3 style="color: #ffffff;"><strong>New Expense Category Entry Form</strong></h3>
                </div>
            	<form class="form-horizontal form_class" id="form_id" role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>academic/academic/expense_cat_entry">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-12" style="padding-top: 10px;">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="expense_cat_Name" id="stname"  placeholder="Please input Name" class="form-control" required> 
                                    </div>
                                </div>
     ...
     <script>
        ...
        $(document).on("click", ".open-deleteModal", function () {
            var expense_ID = $(this).attr('data-professionid');
             alert(expense_ID);
            var expense_cat_Name = $(this).attr('data-title');
               alert(Class_Name);
            $("#expense_cat_Name").html(expense_cat_Name);
            $("#delete_Class_ID").val(expense_ID);
	...
	<div class="modal" id="division1Edit" role="dialog"  aria-hidden="true">
        <div class="modal-dialog" >
            <div class="modal-content animated fadeIn">
                <div class="ibox-title" style="text-align: center; border-bottom: 2px solid #222c43;">
                    <h3><strong>Expense Category Update Form</strong></h3>
                </div>
            	<form class="form-horizontal form_class" id="form_id" role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>academic/academic/update_expense_cat_entry">
                   <div class="ibox-content" style="padding-top: 10px;">
                    <!--<p>Sign in today for more expirience.</p>-->
