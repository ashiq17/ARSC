          ...
          <div class="col-lg-12">
            ...
            <div class="ibox">
                <div class="col-xs-6 col-sm-4">
                    <a data-toggle="modal"   class="btn btn-primary" href="#newExamModal">&nbsp;Add Exam Category</a>
                </div>
            </div>
                              ...
                              <div id="tab-1" class="tab-pane active">
                                <table class="table table-striped table-bordered table-hover" id="editable" >
                                  ...
                                  <tbody>
                                    <?php
                                    $sl = 1;
                                    foreach($Exam_Data as $key=>$allInfo) {?>
                                    <tr class="gradeC">
                                      <td ><?php echo $sl; ?></td>
                                      
                                    <td style="text-align:center;""><?php echo $allInfo->Exam_term_Name; ?></td>
                          
                                   
                                    <td style="text-align: center;">
                                      <a  data-toggle="modal" data-editid="<?php echo $allInfo->Exam_term_ID; ?>" 

                                        data-name="<?php echo $allInfo->Exam_term_Name; ?>" 
                                        data-nameresult="<?php echo $allInfo->Exam_term_Name_Result; ?>" 
                                      
                                        data-activestatus="<?php echo $allInfo->Exam_term_Status; ?>"  
                                      ...
                                      <a href="<?= base_url() ?>academic/academic/exam_delete/<?= $allInfo->Exam_term_ID ?>" onClick="return confirm('Are you sure want to delete?')">
...
<!-- Message View Modal End-->
  ...
  <div class="modal" id="newExamModal" role="dialog"  aria-hidden="true">
        <div class="modal-dialog" >
            <div class="modal-content animated fadeIn">
                <div class="ibox-title" style="text-align: center; border-bottom: 1px solid #222c43;">
                    <h3><strong style="color: #ffffff;">New Exam  Entry Form</strong></h3>
                </div>
              <form class="form-horizontal form_class" id="form_id" role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>academic/academic/new_exam_entry">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-12" style="padding-top: 10px;">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="Exam_term_Name" id="stname"  placeholder="Please input Name" class="form-control" required> 
                                    </div>
                                </div>  
                                <div class="col-lg-12" style="padding-top: 10px;">
                                    <div class="col-lg-3" style="text-align: right;">
                                        <h5><strong>Exam Result Name :</strong></h5>
                                    </div>
                                    <div class="col-lg-8">
                                        <input type="text" name="Exam_term_Name_Result" id="stname_result"  placeholder="Please input result sheet  Name" class="form-control" required> 
                                    </div>
                                </div>  
    ...
    <script type="text/javascript">
        $(document).on("click", ".open-divisionEdit", function () {
            ...
            var nameresult  = $(this).data('nameresult');
            ...
            $(".ibox-content #stnameEdit_Result").val( nameresult ); 
        ...
        <div class="modal-dialog" >
            <div class="modal-content animated fadeIn">
                <div class="ibox-title" style="text-align: center; border-bottom: 2px solid #222c43;">
                    <h3><strong>Exam  Update Form</strong></h3>
                </div>
                            ...
                            <div class="col-lg-12">
                              ...
                              <input type="hidden" name="editID" id="editID" value="">                                
                                ...
                                <div class="col-lg-12" style="padding-top: 10px;">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="Exam_term_Name_Result" id="stnameEdit_result"  placeholder="Please input result sheet  Name" class="form-control" required> 
                                    </div>
                                </div>  
