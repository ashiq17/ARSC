  ...
  <nav aria-label="breadcrumb" style="background-color: #1969ca; color: #fff;">
                                                ...
                                                <table class="table table-striped table-bordered table-hover" id="editable" >
                                                     <thead style=" background: #000000;">
                                                        <tr>
                                                            ...
                                                            <th style="width: 60%; text-align: center;">Room Name</th>
                                                    ...
                                                    <tbody class="theight">
                                                    	<?php
                                                    		$sl = 1;
                                                    		foreach($Room_Data as $key=>$allInfo) {
                                                    			?>
                                                    				<tr>
                                                                        <td style="text-align: center;"><?php echo $sl; ?></td>
                                                                        <td style="text-align: center;"><?php echo $allInfo->Room_Name; ?></td>
                                                                        <td style="text-align: center;">
                                                                            <a  
                                                                                data-toggle="modal"
                                                                                data-editid="<?php echo $allInfo->Room_ID; ?>" 
                                                                                data-name="<?php echo $allInfo->Room_Name; ?>" 
                                                                                data-activestatus="<?php echo $allInfo->Room_Status; ?>"  
                                                                            ...
                                                                            <a href="<?= base_url() ?>academic/academic/Room_delete/<?= $allInfo->Room_ID ?>" onClick="return confirm('Are you sure want to delete?')">
	...
	<div class="modal" id="newClassModal" role="dialog"  aria-hidden="true">
        <div class="modal-dialog" >
            <div class="modal-content animated fadeIn">
                <div class="ibox-title" style="text-align: center; border-bottom: 2px solid #222c43;">
                    <h3><strong>New Room Entry Form</strong></h3>
                </div>
            	<form class="form-horizontal form_class" id="form_id" role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>academic/academic/new_room_entry">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-12" style="padding-top: 10px;">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="Room_Name" id="stname"  placeholder="Please input Name" class="form-control" required> 
                                    </div>
                                </div>
     ...
     <script>
        ...
        $(document).on("click", ".open-deleteModal", function () {
            var Room_ID = $(this).attr('data-professionid');
             alert(Room_ID);
            var Room_Name = $(this).attr('data-title');
               alert(Room_Name);
    ...
    <div class="modal fade" id="deleteModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url();?>academic/academic/room_delete" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div id="media-upload" class="panel blank-panel">
                            <input type="hidden" id="delete_Room_ID" name="delete_Room_ID" value="">
	...
	<div class="modal" id="divisionEdit" role="dialog"  aria-hidden="true">
        <div class="modal-dialog" >
            <div class="modal-content animated fadeIn">
                <div class="ibox-title" style="text-align: center; border-bottom: 2px solid #222c43;">
                    <h3><strong>RoomUpdate Form</strong></h3>
                </div>
            	<form class="form-horizontal form_class" id="form_id" role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>academic/academic/update_room_entry">
                   <div class="ibox-content" style="padding-top: 10px;">
                    <!--<p>Sign in today for more expirience.</p>-->
