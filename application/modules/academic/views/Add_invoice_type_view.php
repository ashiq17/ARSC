...
<body>
  ...
  <nav aria-label="breadcrumb" style="background-color: #1969ca; color: #fff;">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Add Invoice Type</li>
              </ol>
            </nav>
    <section id="">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="editable" >
                                            <thead style=" background: #000000!important;">
                                                <tr>
                                                    ...
                                                    <th style="width: 60%; text-align: center;">Category Name</th>
                                            ...
                                            <tbody class="theight">
                                                <?php
                                                $sl = 1;
                                                foreach($add_invoice_Data as $key=>$allInfo) {
                                                    ?>
                                                    <tr>
                                                        <td style="text-align: center;"><?php echo $sl; ?></td>
                                                        <td style="text-align: center;"><?php echo $allInfo->Invoice_type_Name; ?></td>
                                                        <td style="text-align: center;">
                                                            <a  
                                                            data-toggle="modal"
                                                            data-editid="<?php echo $allInfo->Invoice_type_ID; ?>" 
                                                            data-name="<?php echo $allInfo->Invoice_type_Name; ?>" 
                                                            data-activestatus="<?php echo $allInfo->Invoice_Status; ?>"  
                                                        ...
                                                        <a href="<?= base_url() ?>academic/academic/add_invoice_type_delete/<?= $allInfo->Invoice_type_ID ?>" onClick="return confirm('Are you sure want to delete?')">
    ...
    <div class="modal-dialog" >
        <div class="modal-content animated fadeIn">
            <div class="ibox-title" style="text-align: center; border-bottom: 2px solid #222c43;">
                <h3><strong>New Invoice Type Entry Form</strong></h3>
            </div>
            <form class="form-horizontal form_class" id="form_id" role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>academic/academic/new_add_invoice_type_entry">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-12" style="padding-top: 10px;">
                                <div class="col-lg-3" style="text-align: right;">
                                    <h5><strong>Invoice Type Name :</strong></h5>
                                </div>
                                <div class="col-lg-8">
                                    <input type="text" name="Invoice_type_Name" id="stname"  placeholder="Please input Name" class="form-control" required> 
                                </div>
                            </div>
...
$(document).on("click", ".open-deleteModal", function () {
    var Add_fee_ID = $(this).attr('data-professionid');
    alert(Add_fee_ID);
    var Add_fee_Name = $(this).attr('data-title');
    alert(Add_fee_Name);
    $("#Add_fee_Name").html(Add_fee_Name);
    $("#delete_Add_fee_ID").val(Add_fee_ID);
            ...
            <form action="<?php echo base_url();?>academic/academic/class_delete" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    <div id="media-upload" class="panel blank-panel">
                        <input type="hidden" id="delete_Add_fee_ID" name="delete_Add_fee_ID" value="">
...
<div class="modal" id="divisionEdit" role="dialog"  aria-hidden="true">
    <div class="modal-dialog" >
        <div class="modal-content animated fadeIn">
            <div class="ibox-title" style="text-align: center; border-bottom: 2px solid #222c43;">
                <h3><strong>Fees Category Update Form</strong></h3>
            </div>
            <form class="form-horizontal form_class" id="form_id" role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>academic/academic/update_add_invoice_type_entry">
                <div class="ibox-content" style="padding-top: 10px;">
                    <!--<p>Sign in today for more expirience.</p>-->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-12" style="padding-top: 10px;">
                                <div class="col-lg-3" style="text-align: right;">
                                    <h5><strong>Fees Category:</strong></h5>
                                </div>
                                <div class="col-lg-8">
