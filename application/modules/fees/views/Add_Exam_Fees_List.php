          ...
          <div class="col-lg-12">
            ...
            <div class="ibox">
                <div class="col-xs-6 col-sm-4">
                    <a   class="btn btn-primary" href="<?php echo base_url();?>fees/fees/add_exam_fees">&nbsp;Fees Collection</a>
                </div>
            </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="editable" >
                                  <thead style=" background: #1979CA; color: #3F3F3F;">
                                    <tr class="table-primary">
                                      ...
                                      <th style="color:#3F3F3F;text-align:center;" > Invoice Number</th>
                                      <th style="color:#3F3F3F;text-align:center;" > Class</th>
                                      <th style="color:#3F3F3F;text-align:center;" > Section</th>
                                      <th style="color:#3F3F3F;text-align:center;" > Invoice Type</th>
                                  ...
                                  <tbody>
                                    ...
                                    <td style="text-align:center;""><?php echo $allInfo['Invoice_tdetails_Number']; ?></td>
                                    ...
                                    <td style="text-align:center;""><?php echo $allInfo['Invoice_type_Name']; ?></td>
                                      ...
                                      <td  style="text-align:center;""><?php if(!empty($allInfo['total_amount'])){
                                                      echo $allInfo['total_amount'];
                                                    }else{
                                                      echo '0.00';
                                                    }; ?></td>

                                                     <td style="text-align:center;""><?php echo $allInfo['Invoice_tdetails_Date']; ?></td>
