                                ...
                                <div class="panel with-nav-tabs panel-default">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade in active" id="tab1default">
                                            <form class="well form-horizontal" action="<?php echo base_url();?>fees/fees/print_all_student_account" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-12" style="text-align: left;">
                                               <div class="col-md-12">
                                                    <div class="form-group col-md-12">
                                                        <div class="col-md-4">
                                                            <label style="text-align:left" class=" control-label"><span class="" color:red;></span>ID</label>
                                                        </div>  
                                                ...
                                                <div class="form-group col-md-12 data_1">
                                                   ...
                                                   <div class="form-group col-md-12 data_1">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                       ...
                                                       <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                         <select name="Std_cattype_ID"  style="text-align:left "  class="form-control selectpicker select2">
                                                            <option value="" ></option>
                                                            <option value="">Select an option</option>
                                                     ...
                                                     <div class="form-group col-md-12">
                                                        <div class="col-md-4">
                                                            <label style="text-align:left" class=" control-label"><span class="" color:red;></span>Invoice Month : </label>
                                                        </div>  
                                                       <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                            <select class="form-control select2" name="Invoice_month" id="Invoice_month">
                                                  ...
                                                  <option value=""></option>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <div class="col-md-4">
                                                            <label style="text-align:left" class=" control-label"> <span ></span>Status</label> 
                                                        </div> 
