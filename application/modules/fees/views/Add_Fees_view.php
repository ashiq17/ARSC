                            ...
                            <div class="panel-body">
                                <div class="panel-options" style="padding-bottom: 10px;">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a id="allPosts" data-toggle="tab" href="#tab-1">Fees Category List</a></li>
                                    </ul>
                                </div>
                                    ...
                                    <div id="tab-1" class="tab-pane active">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="editable" >
                                            ...
                                            <tbody class="theight">
                                                <?php
                                                $sl = 1;
                                                foreach($add_fees_Data as $key=>$allInfo) {
                                                    ?>
                                                    <tr>
                                                        <td style="text-align: center;"><?php echo $sl; ?></td>
                                                        <td style="text-align: center;"><?php echo $allInfo->Add_fee_Name; ?></td>
                                                        <td style="text-align: center;">
                                                            <a  
                                                            data-toggle="modal"
                                                            data-editid="<?php echo $allInfo->Add_fee_ID; ?>" 
                                                            data-name="<?php echo $allInfo->Add_fee_Name; ?>" 
                                                            data-activestatus="<?php echo $allInfo->Add_fee_Status; ?>"  
                                                        ...
                                                        <a href="<?= base_url() ?>fees/fees/add_fees_delete/<?= $allInfo->Add_fee_ID ?>" onClick="return confirm('Are you sure want to delete?')">
    ...
    <div class="modal-dialog" >
        <div class="modal-content animated fadeIn">
            <div class="ibox-title" style="text-align: center; border-bottom: 2px solid #222c43;">
                <h3><strong>New Fees Category Entry Form</strong></h3>
            </div>
            <form class="form-horizontal form_class" id="form_id" role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>fees/fees/new_add_fees_entry">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-12" style="padding-top: 10px;">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" name="Add_fee_Name" id="stname"  placeholder="Please input Name" class="form-control" required> 
                                </div>
                            </div>
...
<div class="modal" id="divisionEdit" role="dialog"  aria-hidden="true">
    <div class="modal-dialog" >
        <div class="modal-content animated fadeIn">
            ...
            <form class="form-horizontal form_class" id="form_id" role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>fees/fees/update_add_fee_entry">
                <div class="ibox-content" style="padding-top: 10px;">
                    <!--<p>Sign in today for more expirience.</p>-->
