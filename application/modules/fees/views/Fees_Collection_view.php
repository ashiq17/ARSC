                  ...
                  <div class="wrapper wrapper-content">
                     <div class="ibox float-e-margins">
                        <div class="ibox-title" style="background:#1979ca">
                           <h5 style="color:#ffffff;"><i class="fa fa-plus"></i>Fees Collection</h5>
                           <div class="ibox-tools">
                              <a class="btn btn-primary" style="padding: 0 10px 0 10px;" href="<?php echo base_url();?>fees/fees/fees_invoice"><i class='fa fa-eye'></i> Invoice List</a>
                                 ...
                                 <div class="tab-content">
                                    <div class="tab-pane fade in active" id="tab1default">
                                       <div class="panel-body" id="emp_basic_info1" style="display:none;">
                                         ...
                                         <h3 align="center" style="margin-top: 15px!important;">Fees Collection</h3>
                                          ...
                                          <fieldset   style="width:1000px; padding-bottom: 250px; height:60px; text-align:left;margin:auto;" >
                                             ...
                                             <div class=" panel col-md-12" style="margin-top: 5px;">
                                                ...
                                                <div class="row">
                                                   <div class="form-group  col-md-9 col-md-offset-2 data_1" style="margin-top:0px;padding: 0px">
                                                     ...
                                                     <select class="form-control selectpicker select2" name="student_id" id="student_id">
                                                     <option value=""></option>
                                                     <option value="">Select an option</option>
                                                     <?php
                                                         foreach($all_teacher_find_summary as $key=>$classInfo) {
                                                             ?>
                                                                 <option value="<?php echo $classInfo->   STD_UNQ_ID; ?>"><?php echo $classInfo->   STD_UNQ_ID; ?></option>
                                                             <?php
                                                         }
                                                     ?>
                                                 </select>
                                             ...
                                             <select class="form-control select2" name="Section_ID" id="Section_ID" required="required">
                                                 ...
                                                 <div class="row">
                                                   <div class="form-group col-md-9 col-md-offset-2" style="margin-top:0px;padding: 0px">
                                                      <div class="col-md-2">
                                                        <label style="text-align:left ; margin-top:5px;" class=" control-label"> <span class=""></span>Invoice Type :</label> 
                                                      </div>
                                                      <div class="col-md-7 selectContainer"  style="margin-top:5px;">
                                             <select class="form-control select2" name="Invoice_type_ID" id="Invoice_type_ID" required="required">
                                                     ...
                                                     <option value="">Select an option</option>
                                                     <?php
                                                         foreach($invoice_type_select as $key=>$typeInfo) {
                                                             ?>
                                                                 <option value="<?php echo $typeInfo->Invoice_type_ID; ?>"><?php echo $typeInfo->Invoice_type_Name; ?></option>
                                                             <?php
                                                         }
                                                     ?>
                                                 </select>
                                                ...
                                                <div class="row">
                                                   <div class="form-group col-md-9 col-md-offset-2" style="margin-top:0px;padding: 0px">
                                                      <div class="col-md-2">
                                                        <label style="text-align:left ; margin-top:5px;" class=" control-label"> <span class=""></span>Invoice Month :</label> 
                                                      </div>
                                                      <div class="col-md-7 selectContainer"  style="margin-top:5px;">
                                             <select class="form-control select2" name="Invoice_month" id="Invoice_month" required="required">
                                                 ...
                                                 <div class="col-md-2">
                                                      ...
                                                      <div class="col-md-6">
                                                         <button style=" text-align:center;width: 130px; margin-top: 10px;" class="btn btn-sm btn-primary" onclick="student_invoice_search()"> Find</button>
                                                      </div>
                                                   </div>
                                                   </div>
                                    ...
                                    <script>
                                       function student_invoice_search(){
                                          ...
                                          var Invoice_type_ID = $('#Invoice_type_ID').val();
                                              ...
                                              // alert(Invoice_type_ID);

                                          $.getJSON("<?php echo base_url();?>fees/fees/student_invoice_search?1=1&student_id="+student_id+"&Class_ID="+Class_ID+"&Section_ID="+Section_ID+"&Invoice_type_ID="+Invoice_type_ID, function(data) { 
                                             ...
                                             for (i = 1; i <= data.total; i++) {  
                                                ...
                                                $("#voucher_container").append('<tr id="trr_'+i+'" class="gradeC">'
                                                   +'<td>'+i+'</td>'
                                                   +'<td>'+'<input type="text" readonly class="form-control" name="STD_UNQ_ID[]" style="width: 100%; text-align:center" value="'+data.student_invoice_List[i]['STD_UNQ_ID']+'">'+'</td>'
                                                   +'<td>'+'<input type="text" readonly class="form-control" name="Std_Name[]" style="width: 100%; text-align:center" value="'+data.student_invoice_List[i]['Std_Name']+'">'+'</td>'
                                                   +'<input type="hidden" name="Class_ID[]" value="'+data.student_invoice_List[i]['Class_ID']+'">'
                                                   +'<td>'+'<input type="text" readonly class="form-control" name="Class_Name[]" style="width: 100%; text-align:center" value="'+data.student_invoice_List[i]['Class_Name']+'">'+'</td>'
                                                   +'<td>'+'<input type="text" readonly class="form-control"  name="Section_Name[]" style="width: 100%; text-align:center" value="'+data.student_invoice_List[i]['Section_Name']+'">'+'</td>'
                                                   +'<td>'+'<input type="text" readonly class="form-control" name="St_Invoice_number[]" style="width: 100%; text-align:center" value="'+data.student_invoice_List[i]['St_Invoice_number']+'">'+'</td>'
                                                   +'<td>'+'<input type="text" readonly class="form-control" name="Invoice_type_Name[]" style="width: 100%; text-align:center" value="'+data.student_invoice_List[i]['Invoice_type_Name']+'">'+'</td>'
                                                   +'<td>'+'<input type="text" readonly class="form-control" name="St_Collect_Amount[]" style="width: 100%; text-align:center" value="'+data.student_invoice_List[i]['St_Invoice_Amount']+'">'+'</td>'
                                                   +'<td>'+'<input type="text" class="form-control" name="St_payment_Amount[]" style="width: 100%; text-align:center" value="'+data.student_invoice_List[i]['St_Collect_Amount']+'">'+'</td>'
                                                   // +'<td>'+'<input type="text" readonly class="form-control" name="Std_attendance_date[]" style="width: 100%; text-align:center" value=<?= date("Y/m/d")?>>'+'</td>'
                                                   +'<td>'
                                                   +'<select name="present_status[]" id="present_status'+i+'" style="width:100%;" class="form-control">'
                                                   // +'<option></option>'
                                                   +'<option value="'+data.student_invoice_List[i]['St_Invoice_Status']+'" >'+data.student_invoice_List[i]['status_text']+'</option>'
                                                   +'<option value="1">Paid</option>'
                                                   +'<option value="2">Due</option>'
                                                   +'</select>'
                                                   +'</td>'
                                                +'</tr>');
                                                // alert(data.student_invoice_List[i]['status_text']);
                                               // var text1 = data.student_invoice_List[i]['St_Collect_Amount'];
                                                ...
                                                <table class="table table-striped table-bordered table-hover dataTables-example" style="margin-bottom: 0px;">
                                                   <thead class="theight">
                                                      <tr>
                                                         ...
                                                         <th style=" text-align:center;width: 8%">Invoice  Number</th>
                                                         <th style=" text-align:center;width: 18%">Invoice Type.</th>
                                               ...
                                               <div class="col-md-12 col-md-offset-3">
                                                   <div class="form-horizontal" style="">
                                                       <div class="col-md-3" style="padding-bottom:0.5%;">  
                                                           <button style="width: 100%;" class="btn btn-primary" onclick="submitForm('<?php echo base_url();?>fees/fees/student_fees_collection')"><i class="fa fa-floppy-o"></i> Save</button>
                                                       </div>
                                                       <div class="col-md-3" style="padding-bottom:0.5%;">
