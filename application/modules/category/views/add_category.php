...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="my-bg dashbard-1">
            ...
            <form action="<?php echo base_url();?>category/category/add_category_info" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="col-lg-12">
                        ...
                        ?>                 
                                            <div class="ibox-title" style="background:#243948">
                                                <h5 style="color:#D7E1ED"><i class=""></i> Add New Category</h5> 
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-6 inputGroupContainer" style="margin-top:15px;">
                                                            <input name="category_name" id="category_name" class="form-control"  type="text" required>
                                                        </div>
                                                    </div>
                                                   ...
                                                   <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-6 selectContainer">
                                                           <select name="category_status" class="form-control selectpicker select2" required="required">
                                                                <option value="">Select an option</option>
                                                                <option value="1" selected="selected">Active</option>
                                                                <option value="0">Inactive</option>
                                                           </select>
