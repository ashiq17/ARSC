                            ...
                            <div class="wrapper wrapper-content">
                                <div class="ibox float-e-margins">
                                    <div class="ibox-title" style="background:#1969ca">
                                        <h5 style="color:#D7E1ED"><i class="fa fa-circle-o"></i> Phot Gallery Add</h5> 
                                        <div class="ibox-tools">
                                            ...
                                            <a class="btn btn-primary" style="padding: 0 10px 0 10px;" href="<?php echo base_url(); ?>photo_gallery/gallery/gallery_list"><i class='fa fa-list'></i> Photo Gallery/Album List</a>
                                    ...
                                    <div class="panel-heading">
                                            <ul class="nav nav-tabs tab-menu">
                                                <li class="active"><a href="#tab1default" data-toggle="tab">Photo Gallery Add</a></li>
                                            </ul>
                                    </div> -->
                                    <div class="panel-body well">
                                    <div class="tab-content">
                                    <div class="tab-pane fade in active" id="tab1default">
                                        <form class="form-horizontal" action="<?php echo base_url();?>photo_gallery/gallery/gallery_add" method="post" enctype="multipart/form-data">
                                            <fieldset>
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        <label style="text-align:left" class="col-md-2 control-label"> <span class="required">*</span>Gallery Tilte</label>  
                                                        <div class="col-md-4 inputGroupContainer">
                                                            <input name="gallery_title" id="gallery_title" class="form-control"  type="text" required>
                                                        </div>
                                                    </div>
                                                    <div class="clearfix" style="margin-top:15px;"></div>
                                                   <!-- <label style="text-align:left" class="col-md-2 control-label"> <span class="required">*</span>Position/Slider Type</label>  
                                                   <div class="col-md-6 selectContainer">
                                                       <select name="slider_position" class="form-control selectpicker select2" required="required">
                                                   ...
                                                   <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-4 selectContainer">
                                                           <select name="gallery_status" class="form-control selectpicker select2" required="required">
                                                                <option value="">Select an option</option>
                                                    ...
                                                    <div class="col-md-12">
                                                        <br>
                                                        <label style="text-align:left" class="col-md-2 control-label"> <span class="required">*</span>Photo Gallery Slider Status</label>  
                                                        <div class="col-md-4 selectContainer">
                                                           <select name="ph_slider_images" class="form-control selectpicker select2" required="required">
                                                                <option value="">Select an option</option>
                                                    ...
                                                    <div class="col-md-12">
                                                        <br>
                                                        <label style="text-align:left" class="col-md-2 control-label"> <span class="required">*</span> Photo Gallery 1 Status</label>  
                                                        <div class="col-md-4 selectContainer">
                                                           <select name="ph_gallery1_image" class="form-control selectpicker select2" required="required">
                                                                <option value="">Select an option</option>
                                                                <option value="1" >Yes</option>
                                                                <option value="0" selected>No</option>
                                                           </select>
                                                    ...
                                                    <div class="col-md-12">
                                                        <br>
                                                        <label style="text-align:left" class="col-md-2 control-label"> <span class="required">*</span> Photo Gallery 2 Status</label>  
                                                        <div class="col-md-4 selectContainer">
                                                           <select name="ph_gallery2_image" class="form-control selectpicker select2" required="required">
                                                                <option value="">Select an option</option>
                                                                <option value="1">Yes</option>
                                                                <option value="0" selected>No</option>
                                                           </select>
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 inputGroupContainer">
                                    <input value="<?php if(!empty($header_data[0]['mobile'])){echo $header_data[0]['mobile'];}?>" name="mobile_no" id="employee_id" class="form-control"  type="text" required>
                                </div>
                            </div>
                            <div class="form-group">
