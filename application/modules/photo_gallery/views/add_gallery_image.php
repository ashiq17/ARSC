                            ...
                            <div class="wrapper wrapper-content">
                                <div class="ibox float-e-margins">
                                    <div class="ibox-title" style="background:#243948">
                                        <h5 style="color:#D7E1ED"><i class="fa fa-plus"></i> Gallery Image Add</h5> 
                                        <div class="ibox-tools">
                                            <a class="btn btn-primary" style="padding: 0 10px 0 10px;" href="<?php echo base_url(); ?>photo_gallery/gallery/gallery_image_list/<?php echo $gallery_id; ?>"><i class='fa fa-list'></i> Gallery Image List</a>
                                    ...
                                    <div class="tab-pane fade in active" id="tab1default">
                                        <form class="well form-horizontal" action="<?php echo base_url();?>photo_gallery/gallery/gallery_content_add" method="post" enctype="multipart/form-data">
                                            <fieldset>
                                                <input name="gallery_id" id="gallery_id" value="<?php echo $gallery_id; ?>" type="hidden">
                                            	<div class="form-group">
                                            	    ...
                                            	    <div class="col-md-3 inputGroupContainer">
                                            	        <img class="img-responsive" id="blah" alt="Image Preview Here" width="150px"/>  
                                            	    </div>
                                            	</div>
                                                <div class="form-group">
                                                    <label style="text-align:left" class="col-md-2 control-label"> <span class="required">*</span>Caption</label>  
                                                    <div class="col-md-6 inputGroupContainer">
                                                        <input name="sc_caption" id="sc_caption" class="form-control"  type="text" required>
                                                    </div>
                                                </div>
                                               <div class="form-group">
                                                   <label style="text-align:left" class="col-md-2 control-label">Order</label>  
                                                   <div class="col-md-6 inputGroupContainer">
                                                       <input name="sc_order" class="form-control"  type="number">
                                                   </div>
                                               </div>
                                               <div class="form-group">
                                               <label style="text-align:left" class="col-md-2 control-label">Status</label> 
                                                   <div class="col-md-6 selectContainer">
                                                       <select name="sc_status" class="form-control selectpicker select2" required="required">
                                               ...
                                               <div class="form-group">
                                               <label style="text-align:left" class="col-md-2 control-label">Photo Gallery Slider Status</label> 
                                                   <div class="col-md-6 selectContainer">
                                                       <select name="ph_slider_images" class="form-control selectpicker select2">
                                                            <option value="">Select an option</option>
                                                            <option value="1" selected="selected">Active</option>
                                                            <option value="0">Inactive</option>
                                                       </select>
                                               ...
                                               <div class="form-group">
                                               <label style="text-align:left" class="col-md-2 control-label">Photo Gallery 1 Status</label> 
                                                   <div class="col-md-6 selectContainer">
                                                       <select name="ph_gallery1_image" class="form-control selectpicker select2" >
                                                            <option value="">Select an option</option>
                                                            <option value="1" selected="selected">Active</option>
                                                            <option value="0">Inactive</option>
                                                       </select>
                                               ...
                                               <div class="form-group">
                                               <label style="text-align:left" class="col-md-2 control-label">Photo Gallery 2 Status</label> 
                                                   <div class="col-md-6 selectContainer">
                                                       <select name="ph_gallery2_image" class="form-control selectpicker select2">
                                                            <option value="">Select an option</option>
