    ...
    <div class="ibox float-e-margins">
        <div id="" class="panel blank-panel">
            ...
            <div class="ibox-title" style="background:#1969ca">
                <h5 style="color:#D7E1ED"><i class="fa fa-list" aria-hidden="true"></i></i> Photo Album List</h5> 
                <div class="ibox-tools ">
                	<a class="btn btn-primary" style="padding: 0 10px 0 10px;" href="<?php echo base_url();?>photo_gallery/gallery/add_gallery"><i class="fa fa-plus" aria-hidden="true"></i> New Photo Gallery/Album</a>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="tab-1" class="tab-pane active">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="myTable" >
                                ...
                                <tbody>
                                    <?php 
                                        if (empty($get_gallery_data)) {
                                           echo "<tr><td><strong>No data are found!</strong></td></tr>";
                                        }
                                     ?>
                                    <?php  $i=0; ?>
                                    <?php foreach ($get_gallery_data as $key => $value): ?>
                                    <?php $i++; ?>  
	                                    ...
	                                    <tr class="gradeC">
	                                        ...
	                                        <td>
	                                            <?php 
	                                            if($value['gallery_status']==1){echo '<span style = "color:green;"><i class="fa fa-thumbs-up" aria-hidden="true"></i>
	                                            Active</spane>';}else{echo '<span style = "color:red;"><i class="fa fa-thumbs-down" aria-hidden="true"></i>
	                                            Inactive</spane>';} 
	                                            ?>
	                                        </td>
	                                        <td class='text-center'>
	                                        	<a class="btn btn-rounded btn-sm btn-icon btn-primary" href="<?php echo base_url();?>photo_gallery/gallery/gallery_image_list/<?php echo $value['gallery_id'];?>" style="margin:5px;"><i class="fa fa-tasks" aria-hidden="true"></i> Manage Photo</a> | 
	                                        	...
	                                        	<!-- <a class="btn btn-rounded btn-sm btn-icon btn-primary" data-toggle="modal" data-target="#view-modal" id="open-sliderModal" data-id="<?php //echo $value['gallery_id']; ?>"><i class='fa fa-edit'></i> Edit</a>  --> 
	                                        	<a  data-toggle="modal" data-id="<?php echo $value['gallery_id']; ?>" data-title="<?php echo $value['gallery_title']; ?>" class="open-deleteModal btn btn-rounded btn-sm btn-icon btn-danger" href="#deleteModal"><i class='fa fa-times text-white text'></i> Delete</a>
	                                        </td>
	                                    </tr>  
                                    <?php endforeach ?> 
                                </tbody>
...
<div class="modal-content">
    ...
    <form action="<?php echo base_url();?>photo_gallery/gallery/delete_slider" method="post" enctype="multipart/form-data">
