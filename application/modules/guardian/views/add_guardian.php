                  ...
                  <div class="wrapper wrapper-content">
                     <div class="ibox float-e-margins">
                        <div class="ibox-title" style="background:#1979CA;">
                           <h5 style="color:#D7E1ED"><i class="fa fa-user-plus"></i>Guardian Information</h5>
                           <div class="ibox-tools">
                              <a class="btn btn-success" style="padding: 0 10px 0 10px;" href="<?php echo base_url();?>guardian/guardian/guardian_list"><i class='fa fa-user'></i> Guardian List</a>
                           ...
                           <div class="panel with-nav-tabs panel-default">
                              <div class="panel-heading">
                                 <ul class="nav nav-tabs tab-menu">
                                    <li class="active">
                                       <a  href="#tab1default" data-toggle="tab">Add Guardian</a>
                                    </li>
                              ...
                              <div class="panel-body">
                                 <div class="tab-content">
                                    <div class="tab-pane fade in active" id="tab1default">
                                       ...
                                       <form class="well form-horizontal" action="<?php echo base_url();?>guardian/guardian/guardian_info_add" method="post" enctype="multipart/form-data">
                                          <fieldset   style="width:900px; height:px; text-align:left;margin:auto;" >
                                             ...
                                             <div class="col-md-12" style="margin-top: 10!important;">
                                                <div class="col-md-6">
                                                   <div class="form-group  col-md-12 data_1">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                         <input name="Guardian_UNQ_ID" class="form-control" type="text" >
                                                      </div>
                                                   </div> 
                                                   <div class="form-group  col-md-12 data_1">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class=" control-label"> <span class=""></span>Guardian Name</label> 
                                                      </div>
                                                      <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                         <input name="Guardian_Name" class="form-control" type="text" required>
                                                      </div>
                                                   </div>
                                                   <div class="form-group col-md-12">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class="control-label"><span ></span>Mobile No.</label> 
                                                      </div>
                                                      <div class="col-md-8 inputGroupContainer">
                                                         <input name="Guardian_mobile" style="margin-top:5px;" class="form-control" type="mobile">
                                                      </div>
                                                   </div>
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer">
                                                         <input name="Guardian_NID" style="margin-top:5px;" class="form-control"  type="text">
                                                      </div>
                                                   </div>
                                                    <div class="form-group col-md-12">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class=" control-label"><span ></span>Email</label> 
                                                      </div>
                                                      <div class="col-md-8 inputGroupContainer">
                                                         <input name="Guardian_email" style="margin-top:5px;" class="form-control" type="email">
                                                      </div>
                                                   </div>
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer">
                                                         ...
                                                         <select name="Guardian_st_link" style="text-align:left; margin-top: 7px"  class="form-control selectpicker select2" onchange="ClassTitle(this.value)">
                                                                <option value="" ></option>
                                                                <?php foreach ($all_student_find as $key => $value): ?>
                                                                    <option value="<?php echo $value['STD_UNQ_ID']; ?>"><?php echo $value['STD_UNQ_ID'] ?></option>
                                                                <?php endforeach ?>
                                                            </select>
                                                        <!--  <input name="Guardian_st_link" style="margin-top:5px;" class="form-control"  type="text"> -->
                                                      </div>
                                                   </div>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <div class="form-group col-md-12">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left;margin-top: 7px" class=" control-label"> <span class=""></span>Blood Group</label>
                                                      </div>
                                                      <div class="col-md-8 selectContainer" style="margin-top:5px;">
                                                         <select name="Guardian_BloodGroup" style="text-align:left "  class="form-control selectpicker select2">
                                                             <option value="" ></option> 
                                                    ...
                                                    <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 selectContainer" style="margin-top:5px;">
                                                         <select name="Guardian_gender" style="text-align:left "  class="form-control selectpicker">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                         <select name="Guardian_religion"  style="text-align:left "  class="form-control selectpicker">
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class=" control-label"><span class=""></span>Profile Picture </label>
                                                      </div>
                                                      <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                               ...
                               <div class="tab-pane fade" id="tab2default">
                                       <div class="panel-body  well" id="guardian_basic_info2" style="display:none;">
                                                ...
                                                <div class="panel panel-default">
                                                   <div class="panel-body ">
                                                      <div class="col-md-12">
                                                         <div class="col-md-7">
                                                         <div class="col-md-4">
                                                            <label style="text-align:left; padding:0px">Guardian Name:</label>
                                                         </div>
                                                         <div class="col-md-8 inputGroupContainer">
                                                          ...
                                                          <div class="col-md-5">
                                                            <div class="col-md-4">
                                                               <span style="text-align:right; padding:0px">Email:</span>
                                                            </div>
                                                            <div class="col-md-8 inputGroupContainer">
                                                      ...
                                                      <!-- <div class=" col-md-12 clearfix">
                                                         <div class="col-md-7">
                                                            ...
                                                            <div class="col-md-8 inputGroupContainer">
                                                               <span class="guardian_medium bold"></span>
                                                            </div>
                                                         </div>
                                                         <div class="col-md-5">
                                                            <div class="col-md-4">
                                                            ...
                                                            <div class="col-md-8 inputGroupContainer">
                                                               <span class="guardian_shift bold"></span>
                                                            </div>
                                                         </div>
                                                      </div> -->
                                                   </div>
