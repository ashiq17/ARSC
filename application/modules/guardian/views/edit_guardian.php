                  ...
                  <div class="wrapper wrapper-content">
                     <div class="ibox float-e-margins">
                        <div class="ibox-title" style="background:#1979CA">
                           <h5 style="color:#D7E1ED"><i class="fa fa-user-plus"></i>Guardian Update Info</h5>
                           <div class="ibox-tools">
                              <a class="btn btn-primary" style="padding: 0 10px 0 10px;" href="<?php echo base_url();?>Guardian/Guardian/Guardian_list"><i class='fa fa-user'></i> Guardian List</a>
                           ...
                           <div class="panel with-nav-tabs panel-default">
                              <div class="panel-heading">
                                 <ul class="nav nav-tabs tab-menu">
                                    <li class="active"><a href="#tab1default" data-toggle="tab">Guardian Update Info</a></li>
                              ...
                              <div class="panel-body">
                                 <div class="tab-content">
                                    <div class="tab-pane fade in active" id="tab1default">
                                       ...
                                       <form class="well form-horizontal" action="<?php echo base_url();?>Guardian/Guardian/Guardian_update" method="post" enctype="multipart/form-data">
                                          <fieldset   style="width:900px; height:px; text-align:center;margin:auto;" >
                                             <h2 style="text-align: center;color:#000;"> <u>Guardian Basic Information Edit </u></h2>
                                             <div class="col-md-12">
                                                <div class="col-md-6">
                                                   <div class="form-group  col-md-12 data_1">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class=" control-label"> <span class=""></span>Guard. Unique ID</label> 
                                                      </div>
                                                      <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                      <input value="<?php if (!empty($edit_guardian_find[0]['Guardian_UNQ_ID'])) {
                                                         echo $edit_guardian_find[0]['Guardian_UNQ_ID'] ;}?>" name="Guardian_UNQ_ID" class="form-control" type="text" readonly>
                                                      
                                                      </div>
                                                   </div> 
                                                   <div class="form-group  col-md-12 data_1">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class=" control-label"> <span class=""></span>Pasrents Name</label> 
                                                      </div>
                                                      <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                      <input value="<?php echo $edit_guardian_find[0]['Guardian_ID'] ?>" name="Guardian_ID" type="hidden">
                                                         <input value="<?php if (!empty($edit_guardian_find[0]['Guardian_Name'])) {
                                                         echo $edit_guardian_find[0]['Guardian_Name'] ;}?>" name="Guardian_Name"  class="form-control"  type="text">
                                                      </div>
                                                   </div>
                                                   <div class="form-group col-md-12">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class=" control-label"><span ></span>Mobile Number</label> 
                                                      </div>
                                                      <div class="col-md-8 inputGroupContainer">
                                                         <input value="<?php if (!empty($edit_guardian_find[0]['Guardian_mobile'])) {
                                                            echo $edit_guardian_find[0]['Guardian_mobile'] ;}?>" 
                                                            name="Guardian_mobile"  class="form-control" type="text">
                                                      </div>
                                                   </div>   
                                                   <div class="form-group col-md-12">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class="control-label"><span ></span>National ID</label> 
                                                      </div>
                                                      <div class="col-md-8 inputGroupContainer">
                                                         <input value="<?php if (!empty($edit_guardian_find[0]['Guardian_NID'])) {
                                                            echo $edit_guardian_find[0]['Guardian_NID'] ;}?>" 
                                                            name="Guardian_NID"  class="form-control" type="text">
                                                      </div>
                                                   </div> 
                                                   <div class="form-group col-md-12">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class="control-label"><span ></span>Student ID</label> 
                                                      </div>
                                                      <div class="col-md-8 inputGroupContainer">
                                                          <select name="Guardian_st_link" style="text-align:center"  class="form-control selectpicker select2" ">
                                                                <option value="" ></option>
                                                                <?php foreach ($all_student_find as $key => $value): ?>
                                                                    <option value="<?php echo $value['STD_UNQ_ID']; ?>" <?php if($edit_guardian_find['0']['Guardian_st_link']==$value['STD_UNQ_ID']) { echo "selected";}?>><?php echo $value['STD_UNQ_ID'] ?></option>
                                                                <?php endforeach ?>
                                                            </select>
                                                      </div>
                                                   </div>  
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer">
                                                         <input value="<?php if (!empty($edit_guardian_find[0]['Guardian_email'])) {
                                                      echo $edit_guardian_find[0]['Guardian_email'] ;}?>" name="Guardian_email" class="form-control"  type="text">
                                                      </div>
                                                   </div>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                         <select name="Guardian_shift"  style="text-align:left "  class="form-control selectpicker">
                                                             <option value="1" <?php if ($edit_guardian_find['0']['Guardian_shift']=='1') {echo 
                                                               'selected';} ?>>Day</option>
                                                               <option value="2" <?php if ($edit_guardian_find['0']['Guardian_shift'] =='2') { echo 'selected';
                                                               }?>>Morning</option>
                                                         </select>
                                                      </div>
                                                   </div> 
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                         <select name="Guardian_medium"  style="text-align:left "  class="form-control selectpicker">
                                                            <option value="1" <?php if ($edit_guardian_find['0']['Guardian_medium']=='1') {echo 
                                                               'selected';} ?>>Bangla</option>
                                                               <option value="2" <?php if ($edit_guardian_find['0']['Guardian_medium'] =='2') { echo 'selected';
                                                               }?>>English</option>
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      <div class="col-md-4">
                                                        <label style="text-align:left" class="control-label">Address</label> 
                                                      </div>
                                                      <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                         <textarea name="Guardian_address" class="form-control">
                                                         <?php if (!empty($edit_guardian_find[0]['Guardian_address'])) {
                                                         echo $edit_guardian_find[0]['Guardian_address'] ;}?>
                                                            </textarea>
                                                      </div>
                                                   </div>
                                                ...
                                                <div class="form-group col-md-6">
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 selectContainer" style="margin-top:5px;">
                                                         <select name="Guardian_BloodGroup" style="text-align:center "  class="form-control selectpicker select2">
                                                      <option value="1" <?php if ($edit_guardian_find['0']['Guardian_BloodGroup']=='1') {echo 'selected';} ?>>A</option>

                                                      <option value="2" <?php if ($edit_guardian_find['0']['Guardian_BloodGroup'] =='2') { echo 'selected';
                                                      }?>>A -</option> 
                                                      <option value="3" <?php if ($edit_guardian_find['0']['Guardian_BloodGroup'] =='3') { echo 'selected';
                                                      }?>>B +</option>
                                                       <option value="4" <?php if ($edit_guardian_find['0']['Guardian_BloodGroup'] =='4') { echo 'selected';
                                                      }?>>B -</option> 
                                                      <option value="5" <?php if ($edit_guardian_find['0']['Guardian_BloodGroup'] =='5') { echo 'selected';
                                                      }?>>AB +</option> 
                                                      <option value="6" <?php if ($edit_guardian_find['0']['Guardian_BloodGroup'] =='6') { echo 'selected';
                                                      }?>>AB -</option> 
                                                      <option value="7" <?php if ($edit_guardian_find['0']['Guardian_BloodGroup'] =='7') { echo 'selected';
                                                      }?>>O +</option> 
                                                      <option value="8" <?php if ($edit_guardian_find['0']['Guardian_BloodGroup'] =='8') { echo 'selected';
                                                      }?>>O -</option>
                                                    ...
                                                    <div class="form-group col-md-12" style="margin-top:5px;">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class=" control-label"> <span class=""></span>Gender</label>
                                                      </div>
                                                      <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                       <select name="Guardian_gender" class="form-control">
                                                            <option value="">Select Status</option>
                                                            <option value="1" <?php if ($edit_guardian_find['0']['Guardian_gender']=='1') {echo 
                                                            'selected';} ?>>Male</option>
                                                            <option value="2" <?php if ($edit_guardian_find['0']['Guardian_gender'] =='2') { echo 'selected';
                                                            }?>>Female</option>
                                                        </select>
                                                      </div>
                                                   </div>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                        <select name="Guardian_religion"  style="text-align:center "  class="form-control selectpicker">
                                                          <option value="1" <?php if ($edit_guardian_find['0']['Guardian_religion']=='1') {echo 
                                                               'selected';} ?>>MUSLIM</option>
                                                               <option value="2" <?php if ($edit_guardian_find['0']['Guardian_religion'] =='2') { echo 'selected';
                                                               }?>>HINDU</option>
                                                                  <option value="3" <?php if ($edit_guardian_find['0']['Guardian_religion'] =='3') { echo 'selected';
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                         ...
                                                         <input type="hidden"  id="old"  name="old_image"  value="<?php echo $edit_guardian_find['0']['Image']; ?>">
                                                         <input type="file" name="image"  id="imgInp" class="form-control" style="padding-top:5px;">
                                                         <br>
                                                         <img  class="img-responsive" style="width:80px;height:70px;" alt="No Image Found" id="blah"  src="<?php echo base_url('/images/guardian/').$edit_guardian_find['0']['Image'];?>"/>
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <select name="Guardian_status" class="form-control">
                                                            <option value="">Select Status</option>
                                                            <option value="1" <?php if ($edit_guardian_find['0']['Guardian_status']==1) {echo 
                                                            'selected';} ?>>Active</option>
                                                            <option value="2" <?php if ($edit_guardian_find['0']['Guardian_status'] ==2) { echo 'selected';
                                                            }?>>Inactive</option>
                                                        </select>
                                                      </div>
                                                   </div>
                                    ...
                                    <div class="tab-pane fade" id="tab2default">
                                       <div class="panel-body  well" id="emp_basic_info2" style="display:none;">
                                          <fieldset class="" style="width:900px; height:px; text-align:center;margin:auto;" >
                                       ...
                                       <form id="basicform" class="well form-horizontal" action="<?php echo base_url();?>employee/employee/employee_info_add" method="post" enctype="multipart/form-data">
                                          <fieldset style="width:600px; text-align:center;margin:auto;">
