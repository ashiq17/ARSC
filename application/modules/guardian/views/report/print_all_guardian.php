            ...
            <div class="" style="">
                ...
                <div class="company-head">
                 <h5 class="text_title"><strong><?php if(!empty($header_data[0]['HeaderTitle'])){
                    ...
                    <h6 style="font-size: 13px; margin-top: 0px;">Guardian Information <strong></strong></h6>
            ...
            <table id="tblExport" class="table table-striped table-bordered table-hover dataTables-example" style="margin-bottom: 5px;">
                ...
                <thead class="theight">
                    ...
                    <tr>
                        ...
                        <th style="width: 14%; text-align: center"><span style="margin-left:0px; ">Guardian's Name</span></th>  
                        <th style="width: 6%; text-align: center"><span style="margin-left:0px; ">Guardian's ID</span></th>
                    ...
                    <tbody class="theight">
                     ...
                     <?php 
                      $sl=0;
                     foreach ($print_guardian_all_find as $key => $info):
                    
                      $sl++;
                      ?>
                    <tr>
                    <td style="width: 2%;  text-align:center"><strong style="margin-left:0px;"> <?php echo $sl ;?></strong></td>
                    <td style="width: 14%; text-align:center"><strong style="margin-left:0px;"><?php echo $info['Guardian_Name'] ?></strong></td>
                 
                    <td style="width: 6%; text-align:center"><strong style="margin-left:0px;"><?php echo $info['Guardian_UNQ_ID'] ?></strong></td>
                    <td style="width: 6%; text-align:center"><strong style="margin-left:0px;"><?php echo $info['Guardian_mobile'] ?></strong></td>
                  
                    <td style="width: 4%; text-align:center"><strong style="margin-left:0px;"><?php if ($info['Guardian_religion']==1) {echo 'Muslim';} elseif ($info['Guardian_religion']==2) { echo 'Hindus';
                              }?></strong></td>
                    <td style="width: 4%; text-align:center"><strong style="margin-left:0px;"><?php if ($info['Guardian_gender']==1) {echo 'Male';} elseif ($info['Guardian_gender']==2) { echo 'Female';
                              }?></strong></td>
                    
                     <td style="width: 4%; text-align:center"><strong style="margin-left:0px;"><?php 
                     if ($info['Guardian_BloodGroup']==1) {echo ' A +';} 
                     if ($info['Guardian_BloodGroup']==2) { echo 'A -';}
                     if ($info['Guardian_BloodGroup']==3) { echo 'B +';}
                     if ($info['Guardian_BloodGroup']==4) { echo 'B -';}
                     if ($info['Guardian_BloodGroup']==5) { echo 'AB +';}
                     if ($info['Guardian_BloodGroup']==6) { echo 'AB -';}
                     if ($info['Guardian_BloodGroup']==7) { echo 'O +';}
                     if ($info['Guardian_BloodGroup']==8) { echo 'O -';}
                     ?></strong></td>
                    <td style="width: 6%; text-align:center"><strong style="margin-left:0px;"><?php echo $info['Guardian_NID'] ?></strong></td>
                    <td style="width: 6%; text-align:center"><strong style="margin-left:0px;"><?php echo $info['Guardian_email'] ?></strong></td>
                    <td style="width: 10%; text-align:center"><strong style="margin-left:0px;"><?php echo $info['Guardian_address'] ?></strong></td>
                    </tr> 
                       <?php endforeach ?>
                </tbody>            
