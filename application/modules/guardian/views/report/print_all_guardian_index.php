                            ...
                            <div class="ibox-content col-md-12" style="padding:2px 0;">
                                <div class="panel with-nav-tabs panel-default">
                                    <div class="panel-heading">
                                         <h3 style="color:black; text-align: center"> Guardian Basic Info. Report</h3> 
                                        <h5 style="color:red; text-align: center">Please Search Here</h5>
                                    </div>
                                    <div class="panel-body">
                                    <div class="tab-content">
                                        <div class="tab-pane fade in active" id="tab1default">
                                            <form class="well form-horizontal" action="<?php echo base_url();?>guardian/guardian/print_all_guardian" method="post" enctype="multipart/form-data">
                                               ...
                                               <div class="col-md-12" style="text-align: left;">
                                                 <div class="form-group col-md-12 data_1">
                                                   ...
                                                   <!--  <div class="form-group col-md-12">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <div class="col-md-4">
                                                            <label style="" class=" control-label"><span class="" color:red;></span>ID  </label>
                                                        </div>  
                                                       <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                        <select class="form-control select2" name="Guardian_UNQ_ID" id="Guardian_UNQ_ID" >
                                                        <option value=""></option>
                                                        <?php
                                                            foreach($all_guardian_unique_id as $key=>$uniqueInfo) {?>
                                                                 <option value="<?php echo $uniqueInfo['Guardian_UNQ_ID']; ?>"><?php echo $uniqueInfo['Guardian_UNQ_ID'];?></option>
                                                                <?php
                                                            }?>
                                                        </select>                          
                                                      </div>
