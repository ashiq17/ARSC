...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="my-bg dashbard-1">
            ...
            <form action="<?php echo base_url();?>about/about/add_about_info_bangla" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="col-lg-8">
                                    ...
                                    <div class="col-lg-12" style="padding-right: 0px; padding-left: 0px;">
                                        <div class="ibox float-e-margins">
                                            <div class="ibox-title">
                                                <h5 style="color:red">Add New About বাংলা <span class=" text-right">
                            ...
                            <div class="wrapper wrapper-content">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="ibox float-e-margins">
                                            <div class="ibox-title">
                                                <h5 style="color:red">Save Only</h5>
                                                <div class="ibox-tools">
                                                    <a class="collapse-link">
                                                        <i class="fa fa-chevron-up"></i>
                                                    </a>                                                   
                                            ...
                                            <div class="ibox-content">
                                                <div class="pull-left" >
                                                    <input class="btn btn-primary" style="height: 30px; width:150px;"  type="submit" name="submit" value="Save">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="ibox ">
                                            <div class="ibox-title">
                                                <h5  style="color:red">  Save & Published </h5>
                                            </div>
                                            <div class="ibox-content" >
                                                <div class="pull-left">
                                                    <input class="btn btn-primary" style="height: 30px; width:150px;" type="submit" name="submit" value="Published">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
