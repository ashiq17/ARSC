                                    ...
                                    <div class="col-lg-12">
                                        <div class="ibox float-e-margins">
                                            <div id="" class="panel blank-panel">
                                                <div class="ibox-name" >
                                                    <h5 style="color:red">All  Blog <a class="sd-button" style="padding: 0 10px 0 10px;" href="<?php echo base_url();?>about/about/index_bangla">Add New About বাংলা</a>
                                                   </h5> 
                                                        ...
                                                        <div class="tab-content">
                                                            <div id="tab-1" class="tab-pane active">
                                                                <table class="table table-striped table-bordered table-hover" id="editable" >
                                                                    ...
                                                                    <?php
                                                                    $sl = 1;
                                                                    foreach($all_about_find_bangla as $key=>$value) { ?>
                                                                    <tr class="gradeC">
                                                                    <td ><?php echo $sl; ?></td>
                                                                ...
                                                                <td  style="text-align: center;"><a href="<?php echo base_url();?>about/about/edit_about_bangla/<?php echo $value['AboutID']; ?>">Edit</a></td>
                                                            ...
                                                            <div id="tab-2" class="tab-pane">
                                                                <table class="table table-striped table-bordered table-hover" id="editable1" >
                                                                    ...
                                                                    <tbody>
                                                                        <?php
                                                                        $sl = 1;
                                                                        foreach($all_about_published_find_bangla as $key=>$value) {
                                                                                ?>
                                                                    <tr class="gradeC">
                                                                    <td ><?php echo $sl; ?></td>
                                                                    <td ><?php echo $value['AboutName']; ?></td>
                                                            ...
                                                            <div id="tab-3" class="tab-pane">
                                                                <table class="table table-striped table-bordered table-hover" id="editable2" >
                                                                    ...
                                                                    <?php
                                                                    $sl = 1;
                                                                    foreach($all_about_unpublished_find_bangla as $key=>$value) {
                                                                           ?>
                                                                    <tr class="gradeC">
                                                                    <td ><?php echo $sl; ?></td>
                                                                    <td ><?php echo $value['AboutName']; ?></td>
