...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="my-bg dashbard-1">
            ...
            <form action="<?php echo base_url();?>about/about/about_update_bangla" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="col-lg-8">
                                ...
                                <div class="col-lg-12" style="padding-right: 0px; padding-left: 0px;">
                                    <div class="ibox float-e-margins">
                                        <div class="ibox-title">
                                             <h5 style="color:red">Edit About বাংলা  <span class=" text-right"><a class="sd-button" style="padding: 0 10px 0 10px;" href="<?php echo base_url();?>about/about/all_about_bangla">Back</a>
                                              <a class="sd-button" style="padding: 0 10px 0 10px;" href="<?php echo base_url();?>about/about/index_bangla">Back To Main</a></span></h5>  
