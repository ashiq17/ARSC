                     ...
                     <div class="ibox float-e-margins">
                        <div class="ibox-title" style="background:#1979CA;">
                           ...
                           <div class="ibox-tools">
                              <a class="btn btn-primary" style="padding: 0 10px 0 10px;" href="<?php echo base_url();?>teacher/teacher/teacher_list"><i class='fa fa-user'></i> Teacher List</a>
                           ...
                           <div class="panel with-nav-tabs panel-default">
                              <div class="panel-heading">
                                 <ul class="nav nav-tabs tab-menu">
                                    <li class="active">
                                       <a  href="#tab1default" data-toggle="tab">Teacher Attendence Info</a>
                                    </li>
                                 ...
                                 <div class="tab-content">
                                       ...
                                       <!-- <form class="well form-horizontal" action="" method="post" enctype="multipart/form-data"> -->
                                          <fieldset   style="width:990px; height:px; text-align:center;margin:auto;" >
                                             ...
                                             <div class="col-md-12">
                                                ...
                                                <select class="form-control select2" name="Teacher_ShiftID" id="Teacher_ShiftID">
                                                 ...
                                                 <div class="col-md-3">
                                                   <div class="form-group col-md-12" style="margin-top:5px;padding: 0px">
                                                      ...
                                                      <div class="col-md-10 selectContainer"  style="margin-top:5px;">
                                                       <select class="form-control select2" name="Teacher_UniqueID" id="Teacher_UniqueID" required="required">
                                                        <option value=""></option>
                                                        <?php
                                                   ...
                                                   <div class="col-md-3">
                                                    <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8">
                                                         <button style=" text-align:center;width: 130px; height: 30px; margin-top: 10px; padding-left: 10px" class="btn btn-primary" onclick="teacher_attendance_search()"> Find</button>
                                                      </div>
                                                   </div>
                                                   </div>
                                                </div>
                                    ...
                                    <script>
                                       function teacher_attendance_search(){
                                          ...
                                          // alert(Teacher_ShiftID);
                                             // alert(Section_ID);
                                         
                                          $.getJSON("<?php echo base_url();?>teacher/teacher/teacher_attendence_search?1=1&Teacher_ShiftID="+Teacher_ShiftID+"&Teacher_MediumID="+Teacher_MediumID+"&Teacher_UniqueID="+Teacher_UniqueID, function(data) { 
                                             $('#voucher_container').empty();
                                              ...
                                              // if (data.teacher_attendance_List[i]['Teacher_medium']==1) {
                                              //   medium="Bangla";
                                              // }elseif(data.teacher_attendance_List[i]['Teacher_medium']==2){
                                              // medium="English"}
                                             for (i = 1; i <= data.total; i++) {  

                                                $("#voucher_container").append('<tr id="trr_'+i+'" class="gradeC">'
                                                  +'<td>'+i+'</td>'
                                                +'<input type="hidden" readonly class="form-control" name="Teacher_ID[]" style="width: 100%; text-align:center" value="'+data.teacher_attendance_List[i]['Teacher_ID']+'">'
                                                +'<td>'+'<input type="text" readonly class="form-control" name="Teacher_UniqueID[]" style="width: 100%; text-align:center" value="'+data.teacher_attendance_List[i]['Teacher_UniqueID']+'">'+'</td>'
                                                +'<td>'+'<input type="text" readonly class="form-control" name="Teacher_Name[]" style="width: 100%; text-align:center" value="'+data.teacher_attendance_List[i]['Teacher_Name']+'">'+'</td>'
                                                +'<input type="hidden" readonly class="form-control"  name="DesignationID[]" style="width: 100%; text-align:center" value="'+data.teacher_attendance_List[i]['DesignationID']+'">'
                                                +'<td>'+'<input type="text" readonly class="form-control" name="DesignationName[]" style="width: 100%; text-align:center" value="'+data.teacher_attendance_List[i]['DesignationName']+'">'+'</td>'
                                                +'<input type="hidden" class="form-control" name="Teacher_shiftID[]"   value="'+data.teacher_attendance_List[i]['Teacher_shiftID']+'">'
                                                +'<td>'+'<input type="text" readonly class="form-control" style="width: 100%; text-align:center" value="'+data.teacher_attendance_List[i]['Teacher_shift']+'">'+'</td>'
                                                +'<input type="hidden" class="form-control"  name="Teacher_mediumID[]"  value="'+data.teacher_attendance_List[i]['Teacher_mediumID']+'">'
                                                +'<td>'+'<input type="text" readonly class="form-control" style="width: 100%; text-align:center" value="'+data.teacher_attendance_List[i]['Teacher_medium']+'">'+'</td>'
                                                +'<td>'+'<input type="text" class="form-control" name="Teacher_attendance_date[]" style="width: 100%; text-align:center" value="'+data.teacher_attendance_List[i]['Teacher_attendance_date']+'">'+'</td>'
                                                +'<td>'+'<select style="text-align:center;" name="Teacher_present_status[]" id="Teacher_present_status" style="width:100%;" class="form-control">'+'<option value="1" selected>Present</option>'+'<option value="2">Absent</option>'
                                                  +'</select>'+'</td>'
                                                +'</tr>');
                                             }
