                  ...
                  <div class="wrapper wrapper-content">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="col-md-6">
                                                           <div class="form-group  col-md-12  data_1" style="margin-top:0px;padding: 0px">
                                                            ...
                                                            <div class="form-group  col-md-12 data_1" style="margin-top:0px;padding: 0px">
                                                              ...
                                                              <div class="col-md-9 inputGroupContainer" style="margin-top:10px;">
                                                                <textarea rows='8' class="form-control smsBody"> </textarea>
                                                              </div>
                                                           </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                           ...
                                                           <div class="form-group  col-md-12  data_1" style="margin-top:0px;padding: 0px">
                                                              ...
                                                              <div class="col-md-9 inputGroupContainer" style="margin-top:10px;">
                                                                <select class="form-control select2" name="student_status_attendance" id="student_status_attendance" required="required" >
                                       ...
                                       function sms_search_student_attendance(){
                                          ...
                                          $.getJSON("<?php echo base_url();?>sms/sms/sms_student_search_attendance?1=1&Class_ID="+Class_ID+"&Section_ID="+Section_ID+"&Group_ID="+Group_ID+"&Std_shift_ID="+Std_shift_ID+"&Std_medium_ID="+Std_medium_ID+"&attendance_date="+attendance_date+"&student_status_attendance="+student_status_attendance+"&smsBodyfind="+smsBodyfind, function(data) { 
                                             ...
                                             for (i = 1; i <= data.total; i++) {  
                                                ...
                                                +'<td>'+'<input type="text" readonly class="form-control" name="P_Group_ID[]" style="width: 100%; text-align:center" value="'+data.attendance_search_List[i]['Group_Name']+'">'+'</td>' 
                                                ...
                                                +'<td>'+'<input type="text" readonly class="form-control" name="smsBodyfind[]" style="width: 100%; text-align:center" value="'+data.attendance_search_List[i]['smsBodyfind']+'">'+'</td>'
                                                +'</tr>');
                                             }
                     ...
                     <!--   =========   tab2 start  here ==========   -->
                                   ...
                                   <div class="tab-pane fade in  " id="tab2default">
                                       <div class="panel-body" id="student_ems_basic_info2" style="display:none;">
                                       </div>
                                             ...
                                             for (i = 1; i <= data.total; i++) {  
                                                ...
                                                $("#stu_general_container").append('<tr id="trr_'+i+'" class="gradeC">'
                                                  ...
                                                  +'<td>'+'<input type="text" readonly class="form-control" name="Std_roll[]" style="width: 100%; text-align:center" value="'+data.general_student_search_List[i]['Std_roll']+'">'+'</td>'
                                                   +'<td>'+'<input type="text" id="Std_shift_ID" readonly class="form-control" name="Std_medium_ID[]" style="width: 100%; text-align:center" value="'+data.general_student_search_List[i]['student_medium']+'">'+'</td>'
                                                  +'<td>'+'<input type="text" id="Std_shift_ID" readonly class="form-control" name="Std_shift_ID[]" style="width: 100%; text-align:center" value="'+data.general_student_search_List[i]['student_shift']+'">'+'</td>' 
                                                  +'<td>'+'<input type="text" readonly class="form-control" name="Std_section_ID[]" style="width: 100%; text-align:center" value="'+data.general_student_search_List[i]['Section_Name']+'">'+'</td>' 
                                                  ...
                                                  +'<td>'+'<input type="text" readonly class="form-control" name="P_Group_ID[]" style="width: 100%; text-align:center" value="'+data.general_student_search_List[i]['Group_Name']+'">'+'</td>'
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="col-md-6">
                                                           <div class="form-group  col-md-12  data_1" style="margin-top:0px;padding: 0px">
                                                            ...
                                                            <div class="form-group  col-md-12 data_1" style="margin-top:0px;padding: 0px">
                                                              ...
                                                              <div class="col-md-9 inputGroupContainer" style="margin-top:10px;">
                                                                <textarea rows='8' class=" form-control smsBody3"> </textarea>
                                                              </div>
                                                           </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                           ...
                                                           <div class="form-group  col-md-12  data_1" style="margin-top:0px;padding: 0px">
                                                              ...
                                                              <div class="col-md-9 inputGroupContainer" style="margin-top:10px;">
                                                                <select class="form-control select2" name="student_status_absent" id="student_status_absent" required="required" >
                                                                    <option value="" >Select an option</option>
                                                                    <option value="2" selected>Absent</option>
                                                                    <option value="1">Present</option>
                                                                </select>
                         ...
                         <!-- ===========///for search start============= -->
                                    ...
                                    <script>
                                       function sms_search_student_result(){
                                          ...
                                          var attendance_date   = $('#attendance_date').val();
                                          var student_status_absent   = $('#student_status_absent').val();
                                          // var Subject_Name   = $('#subjectList').text();
                                        
                                              // alert(attendance_date);
                                              // alert(Subject_ID);
                                          $.getJSON("<?php echo base_url();?>sms/sms/sms_student_search?1=1&Class_ID="+Class_ID+"&Section_ID="+Section_ID+"&Group_ID="+Group_ID+"&Std_shift_ID="+Std_shift_ID+"&Std_medium_ID="+Std_medium_ID+"&attendance_date="+attendance_date+"&student_status_absent="+student_status_absent, function(data) { 
                                             ...
                                             for (i = 1; i <= data.total; i++) {  
                                                ...
                                                $("#sms_stu_result_container").append('<tr id="trr_'+i+'" class="gradeC">'
                                                  ...
                                                  +'<td>'+'<input type="text" readonly class="form-control" name="STD_UNQ_ID[]" style="width: 100%; text-align:center" value="'+data.attendance_search_List[i]['STD_UNQ_ID']+'">'+'</td>'
                                                  +'<td>'+'<input type="text" readonly class="form-control" name="Std_roll[]" style="width: 100%; text-align:center" value="'+data.attendance_search_List[i]['Std_roll']+'">'+'</td>'
                                                   +'<td>'+'<input type="text" id="Std_shift_ID" readonly class="form-control" name="Std_medium_ID[]" style="width: 100%; text-align:center" value="'+data.attendance_search_List[i]['student_medium']+'">'+'</td>'
                                                  +'<td>'+'<input type="text" id="Std_shift_ID" readonly class="form-control" name="Std_shift_ID[]" style="width: 100%; text-align:center" value="'+data.attendance_search_List[i]['student_shift']+'">'+'</td>' 
                                                  +'<td>'+'<input type="text" readonly class="form-control" name="Std_section_ID[]" style="width: 100%; text-align:center" value="'+data.attendance_search_List[i]['Section_Name']+'">'+'</td>' 
                                                  +'<td>'+'<input type="text" readonly class="form-control" name="P_Group_ID[]" style="width: 100%; text-align:center" value="'+data.attendance_search_List[i]['Group_Name']+'">'+'</td>'
                                                   +'<td>'+'<select name="sms_status[]" id="sms_status" style="width:100%;" class="form-control">'+'<option value="1" selected>YES</option>'+
                                          ...
                                          <div class="ibox-content" >
                                           ...
                                           <div class="ibox-content" style="padding-top: 2px; height: 50px; margin-bottom: 50px; margin-top: 50px;">
                                               <div class="col-md-12 col-md-offset-3">
                                                   <div class="form-horizontal" style="">
                                                       <div class="col-md-3" style="padding-bottom:0.5%;">  
                                                           <button style="width: 100%;" class="btn btn-primary" onclick="submitForm('<?php echo base_url();?>sms/sms/sms_send_student')"><i class="fa fa-floppy-o"></i> Send</button>
                                                       </div>
                                                       <div class="col-md-3" style="padding-bottom:0.5%;">
                                                           <a class="btn btn-danger" href="<?php echo base_url();?>admin_panel/welcome/dashboard" style="min-width: 100%; padding-left:0px; padding-right:0px;"><i class="fa fa-times"></i> Close</a>
                                                       </div>
                                         ...
                                         <fieldset   style="width:900px; height:px; text-align:left;margin:auto;" >
                                             <div class="panel col-md-12" style="margin-top: 5px;">
                                                  <div class="row">
                                                    ...
                                                    <div class="col-md-6"> 
                                                      <h4 style=" text-align: center;"> Teacher SMS</h4>
                                                    </div>
                                                  </div>
                                                      ...
                                                      <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-6">
                                                           <div class="form-group  col-md-12 data_1" style="margin-top:0px;padding: 0px">
                                                              ...
                                                              <div class="col-md-9 inputGroupContainer" style="margin-top:5px;">
                                                             <button style=" text-align:center;width: 180px; margin-top: 15px;" class="btn btn-sm btn-primary" onclick="sms_search_teacher()"> Find</button>
                                                              </div>
                                                           </div>
                                                        </div>
                                                      </div>
                         ...
                         <!-- ===========///for search start============= -->
                            ...
                            <script>
                                       function sms_search_teacher(){
                                          ...
                                          $.getJSON("<?php echo base_url();?>sms/sms/sms_teacher_search?1=1&Teacher_ShiftID="+Teacher_ShiftID+"&Teacher_MediumID="+Teacher_MediumID+"&Teacher_UniqueID="+Teacher_UniqueID+"&smsBodyTeacherfindGeneral="+smsBodyTeacherfindGeneral, function(data) { 
                                             $('#sms_teacher_container').empty();
                                              // alert(queryData);
                                              if (data.total=='0') {
                                                 alert("There is no data found !");
                                              }

                                              // if (data.teacher_sms_List[i]['Teacher_medium']==1) {
                                              //   medium="Bangla";
                                              // }elseif(data.teacher_sms_List[i]['Teacher_medium']==2){
                                              // medium="English"}
                                             for (i = 1; i <= data.total; i++) {  

                                                $("#sms_teacher_container").append('<tr id="trr_'+i+'" class="gradeC">'
                                                  +'<td>'+i+'</td>'
                                                +'<input type="hidden" readonly class="form-control" name="Teacher_ID[]" style="width: 100%; text-align:center" value="'+data.teacher_sms_List[i]['Teacher_ID']+'">'
                                                ...
                                                +'<input type="hidden" readonly class="form-control"  name="DesignationID[]" style="width: 100%; text-align:center" value="'+data.teacher_sms_List[i]['DesignationID']+'">'
                                                +'<td>'+'<input type="text" readonly class="form-control" name="DesignationName[]" style="width: 100%; text-align:center" value="'+data.teacher_sms_List[i]['DesignationName']+'">'+'</td>'
                                                +'<input type="hidden" class="form-control" name="Teacher_shiftID[]"   value="'+data.teacher_sms_List[i]['Teacher_shiftID']+'">'
                                                +'<td>'+'<input type="text" readonly class="form-control" style="width: 100%; text-align:center" value="'+data.teacher_sms_List[i]['Teacher_shift']+'">'+'</td>'
                                                +'<input type="hidden" class="form-control"  name="Teacher_mediumID[]"  value="'+data.teacher_sms_List[i]['Teacher_mediumID']+'">'
                                                +'<td>'+'<input type="text" readonly class="form-control" style="width: 100%; text-align:center" value="'+data.teacher_sms_List[i]['Teacher_medium']+'">'+'</td>'
                                                +'<td>'+'<input type="text" readonly class="form-control" style="width: 100%; text-align:center" value="'+data.teacher_sms_List[i]['Teacher_mobile']+'">'+'</td>'
                                                +'<td>'+'<input type="text" class="form-control" name="smsBodyTeacherfindGeneral[]" style="width: 100%; text-align:center" value="'+data.teacher_sms_List[i]['smsBodyTeacherfindGeneral']+'">'+'</td>'
                                 ...
                                 <div class="ibox-content" >
                                       ...
                                       <table class="table table-striped table-bordered table-hover dataTables-example" style="margin-bottom: 0px;">
                                          <thead class="theight">
                                              <tr style="color: #3F3F3F;">
                                                <th style=" text-align:center;width: 5%; padding-top:5px;">SL</th>
                                                <th style=" text-align:center;width: 10%">Teacher ID</th>
                                                ...
                                                <th style=" text-align:center;width: 15%">Mobile No.</th>
                                                <!-- <th style=" text-align:center;width: 15%">Date</th> -->
                                                <th style=" text-align:center;width: 20%"> SMS Status</th>
                                             </tr>
                                          </thead>
                                       
                                          <tbody id="sms_teacher_container" class="theight">
                                    ...
                                    <div class="ibox-content" style="padding-top: 2px; height: 50px; margin-bottom: 50px;">
                                               <div class="col-md-12 col-md-offset-3">
                                                   <div class="form-horizontal" style="">
                                                       <div class="col-md-3" style="padding-bottom:0.5%;">  
                                                           <button style="width: 100%;" class="btn btn-primary" onclick="submitForm('<?php echo base_url();?>teacher/teacher/teacher_attendance_submit')"><i class="fa fa-floppy-o"></i> Save</button>
                                                       </div>
                                                       <div class="col-md-3" style="padding-bottom:0.5%;">
                                                           <a class="btn btn-danger" href="<?php echo base_url();?>admin_panel/welcome/dashboard" style="min-width: 100%; padding-left:0px; padding-right:0px;"><i class="fa fa-times"></i> Close</a>
                                                       </div>
