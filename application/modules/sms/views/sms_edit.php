    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="my-bg dashbard-1">
            ...
            <section id="main-content">
                <form action="<?php echo base_url();?>sms/sms/sms_update" method="post">
                    <div class="row">
                        <div class="col-lg-12">
                                ...
                                <div class="ibox float-e-margins">
                                    ...
                                    <div class="ibox-content col-md-12">
                                        <div class="form-group col-md-8">
                                            <input type="hidden" name="SMSID" value="<?php echo $find_sms_data[0]['SMSID'] ?>">
                                            <label>SMS Title:</label>
                                            <input id="leave" onchange="userid_keyup()" type="text" name="sms_title" placeholder="Type a leave name!" class="form-control" value="<?php echo $find_sms_data[0]['SMSTitle'] ?>" required="required">
                                         ...
                                         <div class="form-group col-md-8">
                                            <label>SMS Category:</label>
                                             ...
                                             <select name="sms_category" class="form-control" required="required">
                                                 <option value="1" <?php if($find_sms_data[0]['SMSCategory'] == 1 ){echo 'selected';} ?>>Student Attendance</option> 
                                                <option value="2" <?php if($find_sms_data[0]['SMSCategory']  == 2 ){echo 'selected';}  ?>>Student General</option> 
                                                <option value="3" <?php if($find_sms_data[0]['SMSCategory']  == 3 ){echo 'selected';}  ?>>Student  Result</option> 
                                                <option value="4" <?php if($find_sms_data[0]['SMSCategory']  == 4 ){echo 'selected';}  ?>>Teacher  General</option> 
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group col-md-8">
                                           ...
                                           <!--  <textarea rows="4" name="notes" placeholder="Enter your notes" class="form-control" > -->
                                            <div class="form-group">
                                                    <textarea name="smsBody"><?php echo $find_sms_data[0]['SMSBody'] ?></textarea>
                                                </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-8">
                                            ...
                                            <select name="status" class="form-control" >
                                                <option value="1" <?php if($find_sms_data[0]['SMS_Status'] == 1 ){echo 'selected';} ?>>Active</option> 
                                                <option value="0" <?php if($find_sms_data[0]['SMS_Status']  == 0 ){echo 'selected';}  ?>>Inactive</option> 
                                              </select>
                                        </div>
