                            ...
                            <div class="wrapper wrapper-content">
                                <div class="ibox float-e-margins">
                                    <div class="ibox-title" style="background:#243948">
                                        <h5 style="color:#D7E1ED"><i class="fa fa-user-plus"></i> Slider Info</h5> 
                                        <div class="ibox-tools">
                                            ...
                                            <a class="btn btn-primary" style="padding: 0 10px 0 10px;" href="<?php echo base_url(); ?>slider/slider/list_slider"><i class='fa fa-list'></i> Slider List</a>
                                    ...
                                    <div class="panel-heading">
                                            <ul class="nav nav-tabs tab-menu">
                                                <li class="active"><a href="#tab1default" data-toggle="tab">Slider Info Add</a></li>
                                            </ul>
                                    </div>
                                    <div class="panel-body">
                                    <div class="tab-content">
                                    <div class="tab-pane fade in active" id="tab1default">
                                        <form class="well form-horizontal" action="<?php echo base_url();?>slider/slider/slider_add" method="post" enctype="multipart/form-data">
                                            <fieldset>
                                                <div class="form-group">
                                                    <label style="text-align:left" class="col-md-2 control-label"> <span class="required">*</span>Slider Name</label>  
                                                    <div class="col-md-6 inputGroupContainer">
                                                        <input name="slider_name" id="slider_name" class="form-control"  type="text" required>
                                                    </div>
                                                    <label style="text-align:left" class="col-md-2 control-label"> <span class="required">*</span>Width</label>  
                                                    <div class="col-md-6 inputGroupContainer">
                                                        <input type="number" name="slider_width" id="slider_width" class="form-control"  type="text" required>
                                                    </div>
                                                    <label style="text-align:left" class="col-md-2 control-label"> <span class="required">*</span>Height</label>  
                                                    <div class="col-md-6 inputGroupContainer">
                                                   ...
                                                   <div class="col-md-6 selectContainer">
                                                       <select name="slider_status" class="form-control selectpicker select2" required="required">
                                                            <option value="">Select an option</option>
