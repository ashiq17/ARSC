                            ...
                            <div class="wrapper wrapper-content">
                                <div class="ibox float-e-margins">
                                    <div class="ibox-title" style="background:#243948">
                                        <h5 style="color:#D7E1ED"><i class="fa fa-plus"></i> Slider Image Add</h5> 
                                        <div class="ibox-tools">
                                            <a class="btn btn-primary" style="padding: 0 10px 0 10px;" href="<?php echo base_url(); ?>slider/slider/slider_image_list/<?php echo $slider_id; ?>"><i class='fa fa-list'></i> Slider Content List</a>
                                    ...
                                    <div class="panel-heading">
                                            <ul class="nav nav-tabs tab-menu">
                                                <li class="active"><a href="#tab1default" data-toggle="tab">Slider Image Add</a></li>
                                            </ul>
                                    </div>
                                    <div class="panel-body">
                                    <div class="tab-content">
                                    <div class="tab-pane fade in active" id="tab1default">
                                        <form class="well form-horizontal" action="<?php echo base_url();?>slider/slider/slider_content_add" method="post" enctype="multipart/form-data">
                                            <fieldset>
                                                <input name="slider_id" id="slider_id" value="<?php echo $slider_id; ?>" type="hidden">
                                            	<!-- <input name="slider_position" id="slider_position" value="<?php echo $slider_position; ?>" type="hidden"> -->
                                                ...
                                                <div class="form-group">
                                                    <label style="text-align:left" class="col-md-2 control-label">Description</label>  
                                                    <div class="col-md-6 inputGroupContainer">
