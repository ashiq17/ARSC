...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="my-bg dashbard-1">
            ...
            <form action="<?php echo base_url();?>video/video/video_update" method="post" enctype="multipart/form-data">
                <div class="row">
                        <?php
                                    ...
                                    <div class="col-lg-12" style="padding-right: 0px; padding-left: 0px;">
                                        <div class="ibox float-e-margins">
                                            <div class="ibox-title">
                                                <h5 style="color:white "><u>EDIT VIDEO </u></h5> 
                                            ...
                                            <div class="ibox-content">
                                             ...
                                             <input type="hidden" id="VideoID" name="VideoID"  value="<?php echo $video_data['0']['VideoID']; ?>" class="form-control">
                                                <div class="form-group">
                                                    <input type="text" id="VideoTitle" name="VideoTitle" placeholder="Video Title"  value="<?php echo $video_data['0']['VideoTitle']; ?>" class="form-control" required="required">
                                                </div>
                                                <div class="form-group">
                                                <h5 style="color:green">VIDEO SLUG :</h5> 
                                                    <input type="text" id="VideoSlug" name="VideoSlug" value="<?php echo $video_data['0']['VideoSlug']; ?>" placeholder="Slug (Please do not use any special character in slug)" class="form-control" required="required">
                                                </div> 
                                                <div class="form-group">
                                                <h5 style="color:green">VIDEO URL :</h5> 
                                                    <input type="text" id="VideoUrl" name="VideoUrl" value="<?php echo $video_data['0']['VideoUrl']; ?>" placeholder=" Please input a url" class="form-control" required="required">
                                                </div>
                                                <div class="form-group">
                                                <h5 style="color:green"> STATUS :</h5> 
                                                    <select name="VideoStatus" class="form-control" required="required">
                                                        <option value="">Select Status</option>
                                                        <option value="1" <?php if ($video_data['0']['VideoStatus']==1) {echo 
                                                        'selected';} ?>>Active</option>
                                                        <option value="0" <?php if ($video_data['0']['VideoStatus'] ==0) { echo 'selected';
                                                        }?>>Inactive</option>
                                                    </select>
                                                </div>
                                            </div>
                            ...
                            <div class="wrapper wrapper-content">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="ibox float-e-margins">
                                            <div class="ibox-title">
                                                <h5  style="color:white">Gallary Slider Video</h5>
                                                <div class="ibox-tools">
                                                    <a class="collapse-link">
                                                        <i class="fa fa-chevron-up"></i>
                                                    </a>                                                   
                                             ...
                                             <div class="form-group"> 
                                                     <select name="VideoGallarySilderStatus" class="form-control" required="required">
                                                        <option value="">Select Status</option>
                                                        <option value="1" <?php if ($video_data['0']['VideoGallarySilderStatus']==1) {echo 
                                                        'selected';} ?>>Yes</option>
                                                        <option value="0" <?php if ($video_data['0']['VideoGallarySilderStatus'] ==0) { echo 'selected';
                                                        }?>>No</option>
                                                    </select>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="ibox float-e-margins">
                                            <div class="ibox-title">
                                                <h5  style="color:white">Gallary 1 Video</h5>
                                                <div class="ibox-tools">
                                                    <a class="collapse-link">
                                                        <i class="fa fa-chevron-up"></i>
                                                    </a>                                                   
                                             ...
                                             <div class="form-group">
                                                 <select name="VideoGallery1Status" class="form-control" required="required">
                                                        <option value="">Select Status</option>
                                                        <option value="1" <?php if ($video_data['0']['VideoGallery1Status']==1) {echo 
                                                        'selected';} ?>>Yes</option>
                                                        <option value="0" <?php if ($video_data['0']['VideoGallery1Status'] ==0) { echo 'selected';
                                                        }?>>No</option>
                                                    </select>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="ibox float-e-margins">
                                            <div class="ibox-title">
                                                <h5  style="color:white">Gallary 2 Video</h5>
                                                <div class="ibox-tools">
                                                    <a class="collapse-link">
                                                        <i class="fa fa-chevron-up"></i>
                                                    </a>                                                   
                                             ...
                                             <div class="form-group">
                                                 <select name="VideoGallery2Status" class="form-control" required="required">
                                                        <option value="">Select Status</option>
                                                        <option value="1" <?php if ($video_data['0']['VideoGallery2Status']==1) {echo 
                                                        'selected';} ?>>Yes</option>
                                                        <option value="0" <?php if ($video_data['0']['VideoGallery2Status'] ==0) { echo 'selected';
                                                        }?>>No</option>
                                                    </select>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="ibox float-e-margins">
                                            <div class="ibox-title">
                                                <h5 style="color:white">Published To Video Slider for Home page</h5>
                                                <div class="ibox-tools">
                                                    <a class="collapse-link">
                                                        <i class="fa fa-chevron-up"></i>
                                                    </a>                                                   
