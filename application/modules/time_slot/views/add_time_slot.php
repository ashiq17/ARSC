                  ...
                  <div class="wrapper wrapper-content">
                     <div class="ibox float-e-margins">
                        <div class="ibox-title" style="background:#1969CA;">
                           <h5 style="color:#D7E1ED"><i class="fa fa-user-plus"></i>Time Slots Information</h5>
                           <div class="ibox-tools">
                              <a class="btn btn-primary" style="padding: 0 10px 0 10px;" href="<?php echo base_url();?>time_slot/time_slot/time_slot_list"><i class='fa fa-eye'></i> Time Slots List</a>
                              ...
                              <div class="panel-body">
                                 <div class="tab-content">
                                    <div class="tab-pane fade in active" id="tab1default">
                                       ...
                                       <form class="well form-horizontal" action="<?php echo base_url();?>time_slot/time_slot/time_slot_info_add" method="post" enctype="multipart/form-data">
                                          <fieldset   style="width:900px; height:px; text-align:left;margin:auto;" >
                                             ...
                                             <div class="col-md-12">
                                                <div class="col-md-10">
                                                     ...
                                                     <div class="form-group col-md-12" style="margin-top:5px;">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class=" control-label"> <span class="required">*</span>Day</label>
                                                      </div>
                                                      <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                         <select name="Time_Day"  style="text-align:left "  class="form-control selectpicker">
                                             ...
                                             <div class="form-group col-md-12" style="margin-top:5px;">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class=" control-label"> <span class="required">*</span>Class Time</label>
                                                      </div>
                                                      <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                           <select class="form-control select2" name="Time_Slot" id="divisionID" required="required">
                                                            <option value=""></option>
                                                            <?php
                                                            foreach($Class_time_Data as $key=>$subInfo) {
                                                               ?>
                                                               <option value="<?php echo $subInfo['ClassTime_ID']; ?>"><?php echo $subInfo['ClassTime_Name']; ?></option>
                                                               <?php
                                                            }
                                                            ?>
                                                         </select>
                                                   ...
                                                   <div class="form-group col-md-12" style="margin-top:5px;">
                                                      ...
                                                      <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                          ...
                                                          <select name="Time_Class_ID" style="text-align:left"  class="form-control selectpicker select2" onchange="ClassTitle(this.value)">
                                                                <option value="" ></option>
                                                   ...
                                                   <div class="form-group col-md-12" style="margin-top:5px;">
                                                      ...
                                                      <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                          <select id="sectionList" name="Time_Section_ID" style="text-align:left" class="form-control selectpicker select2">
                                                                <option value="" ></option>
                                                            </select> 
                                                      </div>
                                                   </div>
                                                ...
                                                <div class="form-group col-md-12" style="margin-top:5px;">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class=" control-label"> <span class="required">*</span>Subject</label>
                                                      </div>
                                                      <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                         <select class="form-control select2" name="Time_Subject" id="divisionID" required="required">
                                                            <option value=""></option>
                                                            <?php
                                                            foreach($Subject_Data as $key=>$subInfo) {
                                                               ?>
                                                               <option value="<?php echo $subInfo['Subject_ID']; ?>"><?php echo $subInfo['Subject_Name']; ?></option>
                                                               <?php
                                                            }
                                                            ?>
                                                         </select>
                                               ...
                                               <div class="form-group col-md-12" style="margin-top:5px;">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class=" control-label"> <span class="required">*</span>Teacher</label>
                                                      </div>
                                                      <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                         <select class="form-control select2" name="Time_Teacher" id="divisionID" required="required">
                                                            <option value=""></option>
                                                            <?php
                                                            foreach($Teacher_Data as $key=>$teaInfo) {
                                                               ?>
                                                               <option value="<?php echo $teaInfo['Teacher_ID']; ?>"><?php echo $teaInfo['Teacher_Name']; ?></option>
                                                               <?php
                                                            }
                                                            ?>
                                                         </select>
                                                ...
                                                <div class="form-group col-md-12" style="margin-top:5px;">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class=" control-label"> <span class="required">*</span>Class Room</label>
                                                      </div>
                                                      <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                         <select class="form-control select2" name="Time_Class_Room" id="divisionID" required="required">
                                                            <option value=""></option>
                                                            <?php
                                                            foreach($Class_room_Data as $key=>$crInfo) {
                                                               ?>
                                                               <option value="<?php echo $crInfo['Room_ID']; ?>"><?php echo $crInfo['Room_Name']; ?></option>
                                                               <?php
                                                            }
                                                            ?>
                                                         </select>
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8  inputGroupContainer selectContainer" style="margin-top:2px;">
                                                         <select name="Time_Status" class="form-control selectpicker">
...
<script>
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo base_url();?>time_slot/get_section_data",
        data: data,
        dataType: 'json',
