                  ...
                  <div class="wrapper wrapper-content">
                     <div class="ibox float-e-margins">
                        <div class="ibox-title" style="background:#243948">
                           <h5 style="color:#D7E1ED"><i class="fa fa-user-plus"></i>Parents Update Info</h5>
                           <div class="ibox-tools">
                              <a class="btn btn-primary" style="padding: 0 10px 0 10px;" href="<?php echo base_url();?>parents/parents/parents_list"><i class='fa fa-user'></i> Parents List</a>
                           ...
                           <div class="panel with-nav-tabs panel-default">
                              <div class="panel-heading">
                                 <ul class="nav nav-tabs tab-menu">
                                    <li class="active"><a href="#tab1default" data-toggle="tab">Parents Update Info</a></li>
                              ...
                              <div class="panel-body">
                                 <div class="tab-content">
                                    <div class="tab-pane fade in active" id="tab1default">
                                       ...
                                       <form class="well form-horizontal" action="<?php echo base_url();?>parents/parents/parents_update" method="post" enctype="multipart/form-data">
                                             ...
                                             <div class="col-md-12">
                                                <div class="col-md-10">
                                                   <div class="form-group  col-md-12 data_1">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class=" control-label"> <span class="required">*</span>Pasrents Name</label> 
                                                      </div>
...
<input value="<?php echo $edit_parents_find[0]['Parents_ID'] ?>" name="Parents_ID" type="hidden">

<input value="<?php if (!empty($edit_parents_find[0]['Parents_Name'])) {
echo $edit_parents_find[0]['Parents_Name'] ;}?>" name="Parents_Name"  class="form-control"  type="text" required>
                                                   ...
                                                   <div class="form-group col-md-12" style="margin-top:5px;">
                                                      ...
                                                      <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                       <select name="Parents_gender" class="form-control" required="required">
                                                            <option value="">Select Status</option>
                                                            <option value="Male" <?php if ($edit_parents_find['0']['Parents_gender']=='Male') {echo 
                                                            'selected';} ?>>Male</option>
   <option value="Female" <?php if ($edit_parents_find['0']['Parents_gender'] =='Female') { echo 'selected';
                                                            }?>>Female</option>
                                                        </select>
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class=" control-label"><span required>*</span>Email Address</label> 
                                                      </div>
                                                      <div class="col-md-8 inputGroupContainer">
                                                   

<input value="<?php if (!empty($edit_parents_find[0]['Parents_email'])) {
echo $edit_parents_find[0]['Parents_email'] ;}?>" name="Parents_email"  class="form-control"  type="text" required>
                                                      </div>
                                                   </div>
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer"  style="margin-top:5px;">
                                                         <textarea name="Parents_address" class="form-control">

                                                         <?php if (!empty($edit_parents_find[0]['Parents_address'])) {
                                                         echo $edit_parents_find[0]['Parents_address'] ;}?>
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class=" control-label"><span required>*</span>Mobile Number</label> 
                                                      </div>
                                                      <div class="col-md-8 inputGroupContainer">
                                                         <input value="<?php if (!empty($edit_parents_find[0]['Parents_mobile'])) {
echo $edit_parents_find[0]['Parents_mobile'] ;}?>" name="Teacher_mobile"  class="form-control"  type="text" required>
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                         ...
                                                         <input type="hidden"  id="old"  name="old_image"  value="<?php echo $edit_parents_find['0']['Image']; ?>">
                                                         <input type="file" name="image"  id="imgInp" class="form-control" style="padding-top:5px;">
                                                         <br>
                                                         <img class="img-responsive" alt="No Image Found" id="blah"  src="<?php echo base_url('/images/parents/').$edit_parents_find['0']['Image'];?>"/>
 ...
 <select name="Parents_status" class="form-control" required="required">
                                                            <option value="">Select Status</option>
                                                            <option value="1" <?php if ($edit_parents_find['0']['Parents_status']==1) {echo 
                                                            'selected';} ?>>Active</option>
                                                            <option value="0" <?php if ($edit_parents_find['0']['Parents_status'] ==0) { echo 'selected';
                                                            }?>>Inactive</option>
                                                        </select>
                                                      </div>
                                                   </div>
