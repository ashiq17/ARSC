                  ...
                  <div class="wrapper wrapper-content">
                     <div class="ibox float-e-margins">
                        <div class="ibox-title" style="background:#1979ca">
                           <h5 style="color:#ffffff;"><i class="fa fa-plus"></i>Promotion Student</h5>
                                 ...
                                 <div class="tab-content">
                                    <div class="tab-pane fade in active" id="tab1default">
                                       <div class="panel-body" id="emp_basic_info1" style="display:none;">
                                         ...
                                         <h3 align="center" style="margin-top: 15px!important;"> Student Promotion </h3>
                                          ...
                                          <fieldset   style="width:1000px; padding-bottom: 250px; height:300px; text-align:left;margin:auto;" >
                                             ...
                                             <div class="panel col-md-12" style="margin-top: 5px;">
                                                ...
                                                <div class="row">
                                                  <div class="col-md-6">
                                                    <h4 style=" text-align: center;"> Current Infomation</h4>
                                                  </div>

                                                  <div class="col-md-6"> 
                                                    <h4 style=" text-align: center;"> Promotion Infomation</h4>
                                                  </div>
                                                ...
                                                <div class="row">
                                                  <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-6">
                                                       <div class="form-group  col-md-12 data_1" style="margin-top:0px;padding: 0px">
                                                          <div class="col-md-3">
                                                             <label style="text-align:right ; margin-top:8px;" class=" control-label"> <span class="required">P. Class   </span> <span style="color: red;"> *</span> <span style="margin-left: 15px;" >  : </span> </label> 
                                                          </div>
                                                          <div class="col-md-9 inputGroupContainer" style="margin-top:5px;">
                                                      
                                                          <select class="form-control select2" name="Std_roll" id="P_Class_ID" required="required">
                                                           <option value=""></option>
                                                           <option value="">Select an option</option>
                                                           <?php
                                                               foreach($Class_Data as $key=>$classInfo) {
	                                                 ...
	                                                 <div class="col-md-12">
	                                                	...
	                                                	<div class="col-md-6">
		                                                   <div class="form-group  col-md-12 data_1" style="margin-top:0px;padding: 0px">
		                                                      <div class="col-md-3">
		                                                         <label style="text-align:right ; margin-top:8px;" class=" control-label"> <span class="required">P. Medium  </span>  <span style="margin-left: 5px;" >  : </span> </label> 
		                                                      </div>
		                                                      <div class="col-md-9 inputGroupContainer" style="margin-top:5px;">
			                                                
			                                                   <select class="form-control select2" name="P_Std_medium_ID" id="P_Std_medium_ID" required="required" >
	                                                              <option value="">Select an option</option>
	                                                              <option value="1" selected>Bangla</option>
	                                                              <option value="2">English</option>
                                                         		</select>
                                                    ...
                                                    <div class="col-md-6">
                                                       <div class="form-group  col-md-12 data_1" style="margin-top:0px;padding: 0px">
                                                          <div class="col-md-3">
                                                             <label style="text-align:right ; margin-top:8px;" class=" control-label"> <span class="required"> P. Shift   </span>  <span style="margin-left: 27px;" >  : </span> </label> 
                                                          </div>
                                                          <div class="col-md-9 inputGroupContainer" style="margin-top:5px;">
                                                          <select class="form-control select2" name="P_Std_shift_ID" id="P_Std_shift_ID" required="required">
                                                                  <option value="">Select an option</option>
                                                                  <option value="1" selected >Day</option>
                                                                  <option value="2">Morning</option>
                                                            </select>
                                                  ...
                                                  <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-6">
                                                       <div class="form-group  col-md-12 data_1" style="margin-top:0px;padding: 0px">
                                                          <div class="col-md-3">
                                                             <label style="text-align:right ; margin-top:8px;" class=" control-label"> <span class="required">P. Section   </span>  <span style="margin-left: 10px;" >  : </span> </label> 
                                                          </div>
                                                          <div class="col-md-9 inputGroupContainer" style="margin-top:5px;">
                                                        <select class="form-control select2" name="Section_ID" id="Section_ID" required="required">
                                                              <option value=""></option>
                                                  ...
                                                  <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-6">
                                                       <div class="form-group  col-md-12 data_1" style="margin-top:0px;padding: 0px">
                                                          <div class="col-md-3">
                                                             <label style="text-align:right ; margin-top:8px;" class=" control-label"> <span class="required">P. Group  </span> <span style="margin-left: 18px;" >  : </span> </label> 
                                                          </div>
                                                          <div class="col-md-9 inputGroupContainer" style="margin-top:5px;">
                                                        <select class="form-control select2" name="Group_ID" id="Group_ID" required="required">
                                                         <option value=""></option>
                                               ...
                                               <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-6">
                                                       <div class="form-group  col-md-12 data_1" style="margin-top:0px;padding: 0px">
                                                          ...
                                                          <div class="col-md-9 inputGroupContainer" style="margin-top:5px;">
                                                         <button style=" text-align:center;width: 180px; margin-top: 15px;" class="btn btn-sm btn-primary" onclick="promotion_search()"> Find</button>
                                                          </div>
                                                       </div>
                                                    </div>
                                                  </div>
                                    ...
                                    <script>
                                       function promotion_search(){
                                          ...
                                          var P_Class_ID     = $("#P_Class_ID").val();
                                          var Section_ID   = $('#Section_ID').val();
                                          var P_Section_ID   = $('#P_Section_ID').val();
                                          var Group_ID     = $('#Group_ID').val();
                                          var P_Group_ID     = $('#P_Group_ID').val();
                                          var Std_medium_ID= $("#Std_medium_ID").val();
                                          var P_Std_medium_ID= $("#P_Std_medium_ID").val();
                                          var Std_shift_ID = $("#Std_shift_ID").val();
                                          var P_Std_shift_ID = $("#P_Std_shift_ID").val();
                                          // var Subject_ID   = $('#subjectList').val();
                                          // var Subject_Name   = $('#subjectList').text();
                                        
                                              // alert(Class_ID);
                                              // alert(Subject_ID);
                                          $.getJSON("<?php echo base_url();?>promotion/promotion/promotion_search?1=1&Class_ID="+Class_ID+"&Section_ID="+Section_ID+"&Group_ID="+Group_ID+"&Std_shift_ID="+Std_shift_ID+"&Std_medium_ID="+Std_medium_ID, function(data) { 
                                             $('#voucher_container').empty();
                                              // alert(data.queryData);
                                              // alert(data.promotion_search_List['Std_class_ID']);
                                              if (data.total=='0') {
                                             ...
                                             for (i = 1; i <= data.total; i++) {  
                                                ...
                                                $("#voucher_container").append('<tr id="trr_'+i+'" class="gradeC">'
                                                  ...
                                                  +'<td>'+'<input type="text" readonly class="form-control" style="width: 100%; text-align:center" value="'+data.promotion_search_List[i]['Class_Name']+'">'+'</td>'
                                                  +'<td>'+'<input type="text" readonly class="form-control" name="Std_Name[]" style="width: 100%; text-align:center" value="'+data.promotion_search_List[i]['Std_Name']+'">'+'</td>'
                                                  +'<td>'+'<input type="text" readonly class="form-control" name="STD_UNQ_ID[]" style="width: 100%; text-align:center" value="'+data.promotion_search_List[i]['STD_UNQ_ID']+'">'+'</td>'
                                                  +'<td>'+'<input type="text" class="form-control" name="Std_roll[]" style="width: 100%; text-align:center" value="'+data.promotion_search_List[i]['Std_roll']+'">'+'</td>'
                                                  ...
                                                  +'<td>'
                                                    +'<select class="form-control select2" name="P_Section_ID[]" id="P_Section_ID" required="required">'
                                                              +'<option value="'+data.promotion_search_List[i]['Std_section_ID']+'" selected>'+data.promotion_search_List[i]['Section_Name']+'</option>'
                                                              +'<?php
                                                                  foreach($Section_Data as $key=>$sectionInfo) {?>'
                                                                          +'<option value="<?php echo $sectionInfo->Section_ID; ?>"><?php echo $sectionInfo->Section_Name; ?></option>'
                                                                      +'<?php
                                                  ...
                                                  +'<td>'
                                                    +'<select class="form-control select2" name="P_Group_ID[]" id="P_Group_ID" required="required">'
                                                              ...
                                                              +'<option value="'+data.promotion_search_List[i]['Std_group_ID']+'">'+data.promotion_search_List[i]['Group_Name']+'</option>'
                                                              +'<?php
                                                                  foreach($Group_Data as $key=>$GroupInfo) {?>'
                                                                          +'<option value="<?php echo $GroupInfo->Group_ID; ?>"><?php echo $GroupInfo->Group_Name; ?></option>'
                                                                      +'<?php
