                  ...
                  <div class="wrapper wrapper-content">
                     <div class="ibox float-e-margins">
                        <div class="ibox-title" style="background:#1979CA">
                           <h5 style="color:#D7E1ED"><i class="fa fa-user-plus"></i>Book Update Info</h5>
                           <div class="ibox-tools">
                              <a class="btn btn-primary" style="padding: 0 10px 0 10px;" href="<?php echo base_url();?>library/library/library_list"><i class='fa fa-user'></i> Book List</a>
                           ...
                           <div class="panel with-nav-tabs panel-default">
                              <div class="panel-heading">
                                 <ul class="nav nav-tabs tab-menu">
                                    <li class="active"><a href="#tab1default" data-toggle="tab">Book Update Info</a></li>
                              ...
                              <div class="panel-body">
                                 <div class="tab-content">
                                    <div class="tab-pane fade in active" id="tab1default">
                                       ...
                                       <form class="well form-horizontal" action="<?php echo base_url();?>library/library/book_update" method="post" enctype="multipart/form-data">
                                          <fieldset   style="width:900px; height:px; text-align:center;margin:auto;" >
                                             <h2 style="text-align: center;color:#000;"> <u>Book Basic Information Edit </u></h2>
                                             <div class="col-md-12" style="text-align: left;">
                                                <div class="col-md-8">
                                                   ...
                                                   <div class="form-group  col-md-12 data_1">
                                                      ...
                                                      <input value="<?php echo $edit_library_book_finding[0]['Lib_ID'] ?>" name="Lib_ID" type="hidden">
                                                         <input value="<?php if (!empty($edit_library_book_finding[0]['Lib_Book_Name'])) {
                                                         echo $edit_library_book_finding[0]['Lib_Book_Name'] ;}?>" name="Lib_Book_Name"  class="form-control"  type="text">
                                                      </div>
                                                   </div>
                                 ...
                                 <div class="col-md-4">
                                    <label style="text-align:left" class="control-label"> <span class="required"></span>Category</label>
                                 </div>
                                 <div class="col-md-8 selectContainer" style="margin-top:5px;">
                                     <select name="Lib_Book_cat_ID" style="text-align:left" class="form-control selectpicker select2">
                                          ...
                                          ?>
                                        <option value="<?php echo $value['Book_cat_ID'] ?>" <?php if($edit_library_book_finding['0']['Lib_Book_cat_ID']==$value['Book_cat_ID']) { echo "selected";}?>><?php echo $value['Book_cat_Name'] ?></option>
                                       ...
                                       <?php endforeach ?>
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer">
                                                         <input value="<?php if (!empty($edit_library_book_finding[0]['Lib_author_Name'])) {
                                                            echo $edit_library_book_finding[0]['Lib_author_Name'] ;}?>" 
                                                            name="Lib_author_Name"  class="form-control" type="text">
                                                      </div>
                                                   </div>   
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer">
                                                         <input value="<?php if (!empty($edit_library_book_finding[0]['Lib_Quantity'])) {
                                                      echo $edit_library_book_finding[0]['Lib_Quantity'] ;}?>" name="Lib_Quantity" class="form-control"  type="text">
                                                      </div>
                                                   </div>
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                         <textarea name="Lib_Book_details" class="form-control">
                                                         <?php if (!empty($edit_library_book_finding[0]['Lib_Book_details'])) {
                                                         echo $edit_library_book_finding[0]['Lib_Book_details'] ;}?>
                                                            </textarea>
                                                      </div>
                                                   </div>
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                         ...
                                                         <input type="hidden"  id="old"  name="old_image"  value="<?php echo $edit_library_book_finding['0']['Image']; ?>">
                                                         <input type="file" name="image"  id="imgInp" class="form-control" style="padding-top:5px;">
                                                         <br>
                                                         <img  class="img-responsive" style="width:80px;height:70px;" alt="No Image Found" id="blah"  src="<?php echo base_url('/images/Book/').$edit_library_book_finding['0']['Image'];?>"/>
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <select name="Lib_status" class="form-control">
                                                            <option value="">Select Status</option>
                                                            <option value="1" <?php if ($edit_library_book_finding['0']['Lib_status']==1) {echo 
                                                            'selected';} ?>>Active</option>
                                                            <option value="2" <?php if ($edit_library_book_finding['0']['Lib_status'] ==2) { echo 'selected';
                                                            }?>>Inactive</option>
                                                        </select>
                                                      </div>
                                                   </div>
