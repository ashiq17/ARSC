                                        ...
                                        <div class="ibox float-e-margins">
                                            <div id="" class="panel blank-panel">
                                                <div class="ibox-title" >
                                                    <h5 style="color:#000;"> <strong>All  guardian </strong> <a class="sd-button" style="padding: 0 10px 0 10px;" href="<?php echo base_url();?>library/library/add_new_book">Add New guardian</a>
                                                        ...
                                                        <div class="tab-content">
                                                            <div id="tab-1" class="tab-pane active">
                                                                <table style="background: #000;" class="table table-striped table-bordered table-hover" id="editable" >
                                                                     <thead style=" background: #1979CA; color: #000;">
                                                                        <tr>
                                                                            ...
                                                                            <th style="color:#000;text-align:center;" >Profile</th>
                                                                             <th style="color:#000;text-align:center;" >Book Name</th> 
                                                                            <th style="color:#000;text-align:center;" >Category Name</th>
                                                                            <th style="color:#000;text-align:center;" >Author Name</th>
                                                                    ...
                                                                    <tbody style="text-align: center !important;" >
                                                                        <?php
                                                                        $sl = 1;
                                                                        foreach($all_books_find as $key=>$value) {?>
                                                                    <tr class="gradeC">
                                                                <td style="text-align:center;" ><?php echo $sl; ?></td>
                                                                <td> <img class="img-responsive" style="margin: auto;
                                                                    vertical-align: middle;" alt="No Image Found" id="blah"  src="<?php echo base_url('/images/Book/').$value['Image'];?>" width="25" height="25"/></td>

                                                                    <td  style="text-align:center; "><?php echo $value['Lib_Book_Name']; ?></td>
                                                                    <td  style="text-align:center; "><?php echo $value['Lib_Book_cat_ID']; ?></td>

                                                                  
                                                                    <td style="text-align:center;"><?php echo $value['Lib_author_Name']; ?></td>

                                                                    <td style="text-align:center;"  ><?php echo $value['Lib_Quantity']; ?></td>

                                                                     <td class="text-center"> <?php if($value['Lib_status']==1){echo '<span style = "color:green;"><i class="fa fa-thumbs-up" aria-hidden="true"></i>
                                                                    active</spane>';}else{echo '<span style = "color:red;"><i class="fa fa-thumbs-down" aria-hidden="true"></i>
                                                                    inactive</spane>';} ?>

                                                                </td>
                                                          
                                                                 <td style=" vertical-align: middle;text-align: center; width: 7%;"><a target="_blank" href="<?php echo base_url();?>library/library/print_guardian_single/<?php echo $value['Lib_ID']; ?>">Print</a>
                                                                </td> 
                                                                <td  style="text-align: center;">
                                                                <a href="<?php echo base_url();?>library/library/edit_guardian/<?php echo $value['Lib_ID']; ?>">
                                                            <button class="btn btn-primary btn-xs">
                                                                <i class="fa fa-pencil"></i>
                                                                </button>
                                                                </a>
                                                              <a data-toggle="modal" data-professionid="<?php echo $value['Lib_ID']; ?>" data-title="<?php echo $value['Lib_Book_Name']; ?>" class="open-deleteModal" href="#deleteModal" > 
                                                            ...
                                                            <div id="tab-2" class="tab-pane ">
                                                                ...
                                                                <td> <img class="img-responsive" style="margin: auto;
                                                                    ...
                                                                    <td style="text-align:center;"  ><?php echo $value['Guardian_BloodGroup']; ?></td>

                                                                     <td class="text-center"> <?php if($value['Guardian_status']==1){echo '<span style = "color:green;"><i class="fa fa-thumbs-up" aria-hidden="true"></i>
                                                                    active</spane>';}else{echo '<span style = "color:red;"><i class="fa fa-thumbs-down" aria-hidden="true"></i>
                                                                    inactive</spane>';} ?>
                                                                ...
                                                                data-gender="<?php 
                                                                if($value['Guardian_gender']=='1'){echo 'Male';}
                                                                elseif($value['Guardian_gender']=='2'){echo 'Female';}?>"
                                                                data-religion="<?php 
                                                                if($value['Guardian_religion']=='1'){echo 'MUSLIM';}
                                                                elseif($value['Guardian_religion']=='2'){echo 'HINDUS';}?>"
                                                                data-address="<?php echo $value['Guardian_address'];?>"
                                                                data-email="<?php echo $value['Guardian_email'];?>"
                                                                data-bloodgroup="<?php
                                                                if($value['Guardian_BloodGroup']==1){echo 'A +';}
                                                                if($value['Guardian_BloodGroup']==2){echo 'A -';}
                                                                if($value['Guardian_BloodGroup']==3){echo 'B +';}
                                                                if($value['Guardian_BloodGroup']==4){echo 'B -';}
                                                                if($value['Guardian_BloodGroup']==5){echo 'AB +';}
                                                                if($value['Guardian_BloodGroup']==6){echo 'AB -';}
                                                                if($value['Guardian_BloodGroup']==7){echo 'O +';}
                                                                if($value['Guardian_BloodGroup']==8){echo 'O -';}?>"
                                                                data-status="<?php 
                                                                if($value['Guardian_status']==1){echo 'Active';}
                                                                elseif($value['Guardian_status']==2){echo 'Inactive';}?>"
