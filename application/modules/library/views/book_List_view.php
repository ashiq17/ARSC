...
<body>
                                        ...
                                        <div class="ibox float-e-margins">
                                            <div id="" class="panel blank-panel">
                                                <div class="ibox-title" >
                                                    <h5 style="color:#000;"> <a class="sd-button" style="padding: 0 10px 0 10px;" href="<?php echo base_url();?>library/library/add_new_book">Add New Book</a>
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="panel-options" style="padding-bottom: 10px;">
                                                            <ul class="nav nav-tabs">
                                                                <li class="active"><a id="allPosts" data-toggle="tab" href="#tab-1">  <strong>All Book List</strong> </a></li>
                                                                <li class=""><a id="active" data-toggle="tab" href="#tab-2"><strong>Available</strong></a></li>
                                                                <li class=""><a id="inactive" data-toggle="tab" href="#tab-3"><strong>Unavailable</strong></a></li>
                                                            </ul>
                                                        </div>
                                                        <div class="tab-content">
                                                            <div id="tab-1" class="tab-pane active">
                                                                <table style="background: #000;" class="table table-striped table-bordered table-hover" id="editable" >
                                                                     <thead style=" background: #1979CA; color: #000;">
                                                                        <tr>
                                                                            ...
                                                                            <th style="color:#000;text-align:center;" >Book Image</th>
                                                                ...
                                                                <td> <img class="img-responsive" style="margin: auto;
                                                                    ...
                                                                    <td  style="text-align:center; "><?php echo $value['Book_cat_Name']; ?></td>
                                                                ...
                                                                <a href="<?php echo base_url();?>library/library/edit_library_book/<?php echo $value['Lib_ID']; ?>">
                                                            ...
                                                            <div id="tab-2" class="tab-pane ">
                                                                <table class="table table-striped table-bordered table-hover" id="editable1" >
                                                                    ...
                                                                    <tbody style="text-align: center !important;" >
                                                                        <?php
                                                                        $sl = 1;
                                                                        foreach($all_active_lib_Book_finding as $key=>$value) {
                                                                              $active_books = strtolower(trim($value['Lib_status']));
                                                                         if($active_books=='1'){
                                                            ...
                                                            <div id="tab-3" class="tab-pane ">
                                                               ...
                                                               <thead style=" background: #1979CA; color: #000;">
                                                                    ...
                                                                    <tbody style="text-align: center !important;" >
                                                                        <?php
                                                                        $sl = 1;
                                                                        foreach($all_inactive_lib_book_finding as $key=>$value) {
                                                                              $active_books = strtolower(trim($value['Lib_status']));
                                                                         if($active_books=='2'){
 ...
 <script>
        ...
        $(document).on("click", ".open-deleteModal", function () {
            var Lib_ID = $(this).attr('data-professionid');
             // alert(ProfessionID);
            var Lib_Book_Name = $(this).attr('data-title');
               // alert(ProfessionName);
            $("#Lib_Book_Name").html(Lib_Book_Name);
            $("#delete_Guardian_ID").val(Lib_ID);
    ...
    <div class="modal fade" id="deleteModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url();?>library/library/library_delete" method="post" enctype="multipart/form-data">
                        ...
                        <div id="media-upload" class="panel blank-panel">
                            ...
                            <div class="panel-heading">
                                <div class="panel-options">
                                    <h3>Are your sure to delete " <span style="font-size: 12px;" id="Lib_Book_Name"></span>
