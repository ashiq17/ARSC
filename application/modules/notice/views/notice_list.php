    ...
    <div class="ibox float-e-margins">
        <div id="" class="panel blank-panel">
            ...
            <div class="ibox-title" style="background:#1969ca">
                <h5 style="color:#D7E1ED"><i class='fa fa-user'></i> Notice List</h5> 
                <div class="ibox-tools ">
                	<a class="btn btn-primary" style="padding: 0 10px 0 10px;" href="<?php echo base_url();?>notice/notice/notice_notes"><i class='fa fa-user-plus'></i> Add Notice</a>
                        ...
                        <div id="tab-1" class="tab-pane active">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="myTable" >
                                ...
                                <tbody>
                                    ...
                                    <tr class="gradeC">
                                        <td><?php echo $i; ?></td>
                                        <td><?php echo $value['note_title'] ?></td>
                                       <!--  <td><?php echo $value['noteBody'] ?></td> -->
                                        <td>
                                        ...
                                        <td class='text-center'>
                                        	...
                                        	<a class="btn btn-rounded btn-sm btn-icon btn-primary" href="<?php echo base_url(); ?>notice/notice/notice_edit/<?php echo $value['note_id'] ?>"><i class='fa fa-edit'></i> Edit</a> | 
                                        	<a  data-toggle="modal" data-roleid="<?php echo $value['note_id']; ?>" data-title="<?php echo $value['note_title']; ?>" class="open-deleteModal btn btn-rounded btn-sm btn-icon btn-danger" href="#deleteModal"><i class='fa fa-times text-white text'></i> Delete</a>
                                        </td>
...
<form action="<?php echo base_url();?>notice/notice/delete_notice" method="post" enctype="multipart/form-data">
...
<h3>Are your sure to delete " <span style="font-size: 12px;" id="roleName"></span> " Notice note?</h3>
</div>
</div>                            
                 ...
                 <div class="modal-content"> 
                     ...
                     <div class="modal-header"> 
                          ...
                          <h4 class="modal-title text-center">
                             <i class="glyphicon glyphicon-eye-open"></i> Notice Details
                          </h4> 
                     </div> 
                     <div class="modal-body"> 
