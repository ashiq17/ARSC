    ...
    <div class="ibox float-e-margins">
        <div id="" class="panel blank-panel">
            ...
            <div class="ibox-title" style="background:#243948">
                <h5 style="color:#D7E1ED"><i class='fa fa-user'></i> Note List</h5> 
                <div class="ibox-tools ">
                	<a class="btn btn-primary" style="padding: 0 10px 0 10px;" href="<?php echo base_url();?>employee/employee/leave_notes"><i class='fa fa-user-plus'></i> Add Notes</a>
                                    ...
                                    <tr class="gradeC">
                                       ...
                                       <!--  <td><?php echo $value['noteBody'] ?></td> -->
                                        ...
                                        <td class='text-center'>
                                        	...
                                        	<a class="btn btn-rounded btn-sm btn-icon btn-primary" href="<?php echo base_url(); ?>employee/employee/note_edit/<?php echo $value['note_id'] ?>"><i class='fa fa-edit'></i> Edit</a> | 
 ...
 <script>
    $(document).ready(function(){
        ...
        $(document).on('click', '#getUser', function(e){
            ...
            $.ajax({
                url: BASE_URL+'employee/employee/getuser', 
                 ...
                 <div class="modal-content"> 
                     ...
                     <div class="modal-header"> 
                          ...
                          <h4 class="modal-title text-center">
                             <i class="glyphicon glyphicon-eye-open"></i> Notes Details
                          </h4> 
                     </div> 
                     <div class="modal-body"> 
