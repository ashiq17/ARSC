                                ...
                                <table class="table table-striped table-bordered table-hover" id="editable" >
                                  ...
                                  <tbody>
                                    ...
                                    <tr class="gradeC">
                                      ...
                                      vertical-align: middle;" alt="<?php echo base_url('/images/student/student_demo.jpg');?>" id="blah"  src="<?php echo base_url('/images/student/').$value['Image'];?>" width="25" height="25"/>
                                    </td> 
