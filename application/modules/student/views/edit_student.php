                        ...
                        <div class="wrapper wrapper-content">
                            <div class="ibox float-e-margins">
                                    ...
                                    <div class="panel with-nav-tabs panel-default">
                                        <div class="panel-heading">
                                            <ul class="nav nav-tabs tab-menu">
                                                <li class="active"><a href="#tab1default" data-toggle="tab">Student Admission Info Edit</a></li>
                                                <!-- 
                                                 <li><a href="" data-target="#tab2default" data-toggle="tab">System User Info</a></li>
                                                 <li><a href="#tab4default" data-toggle="tab">Student Summery</a></li> -->
                                            </ul>
                                        </div>
                                        <div class="panel-body">
                                            <div class="tab-content">
                                                <div class="tab-pane fade in active" id="tab1default">
                                                    ...
                                                    <form class="well form-horizontal" action="<?php echo base_url(); ?>student/student/student_update" method="post" enctype="multipart/form-data">
                                                        <fieldset style="width:900px; height:px; text-align:left;margin:auto;" >
                                                            ...
                                                            <h1 style="text-align: center;color:black;"> <u>Student Basic Information Edit</u></h1>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="form-group col-md-12">
                                                                        <div class="col-md-4">
                                                                            <label style="text-align:left;margin-top: 7px" class=" control-label"><span></span>Student Unique ID</label> 
                                                                        </div>
                                                                        <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                                            <input value="<?php if (!empty($edit_student_find[0]['STD_UNQ_ID'])) {
                                    echo $edit_student_find[0]['STD_UNQ_ID'];
                                }
                                ?>" name="STD_UNQ_ID" class="form-control"  type="text"  >
                                                                        </div>
                                                                    </div> 
                                                                    <div class="form-group  col-md-12 data_1">
                                                                        <div class="col-md-4">
                                                                            <label style="text-align:left" class="control-label"> <span class="required"></span>Student Name</label> 
                                                                        </div>
                                                                        <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                                            <input value="<?php echo $edit_student_find[0]['Std_ID'] ?>" name="Std_ID" type="hidden">
                                                                            <input value="<?php if (!empty($edit_student_find[0]['Std_Name'])) {
                                                                                       echo $edit_student_find[0]['Std_Name'];
                                                                                   }
                                ?>" name="Std_Name"  class="form-control"  type="text" >
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group col-md-12">
                                                                        <div class="col-md-4">
                                                                            <label style="text-align:left" class="control-label"><span ></span>Father's Name</label> 
                                                                        </div>
                                                                        <div class="col-md-8 inputGroupContainer">
                                                                            <input value="<?php if (!empty($edit_student_find[0]['Std_parent'])) {
                                                                                       echo $edit_student_find[0]['Std_parent'];
                                                                                   }
                                ?>" name="Std_parent" class="form-control" type="text" >
                                                                        </div>
                                                                    </div>

                                                                    <div class="form-group col-md-12">
                                                                        <div class="col-md-4">
                                                                            <label style="text-align:left" class="control-label"><span ></span>Mother's Name</label> 
                                                                        </div>
                                                                        <div class="col-md-8 inputGroupContainer">
                                                                            <input value="<?php if (!empty($edit_student_find[0]['Std_parent2'])) {
                                                                                       echo $edit_student_find[0]['Std_parent2'];
                                                                                   }
                                ?>" name="Std_parent2" class="form-control" type="text" >
                                                                        </div>
                                                                    </div>

                                                                    <div class="form-group col-md-12">
                                                                        <div class="col-md-4">
                                                                            <label style="text-align:left" class="control-label"><span ></span>Contact No</label> 
                                                                        </div>
                                                                        <div class="col-md-8 inputGroupContainer">
                                                                            <input value="<?php if (!empty($edit_student_find[0]['Std_parent_mobile'])) {
                                                                                       echo $edit_student_find[0]['Std_parent_mobile'];
                                                                                   }
                                ?>" name="Std_parent_mobile"  class="form-control" type="text">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group col-md-12">
                                                                        <div class="col-md-4">
                                                                            <label style="text-align:left" class="control-label"><span ></span>Email Address</label> 
                                                                        </div>
                                                                        <div class="col-md-8 inputGroupContainer">
                                                                            <input value="<?php echo $edit_student_find[0]['Std_email'] ?>" name="Std_email" type="hidden">
                                                                            <input value="<?php if (!empty($edit_student_find[0]['Std_email'])) {
                                                                                       echo $edit_student_find[0]['Std_email'];
                                                                                   }
                                ?>" name="Std_email" class="form-control"  type="text">
                                                                        </div>
                                                                    </div>

                                                                    <div class="form-group col-md-12">
                                                                        <div class="col-md-4">
                                                                            <label style="text-align:left;margin-top: 7px" class="control-label"><span></span>Birth Cert. ID</label> 
                                                                        </div>
                                                                        <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                                            <input value="<?php if (!empty($edit_student_find[0]['Std_birth_ID'])) {
                                                                                       echo $edit_student_find[0]['Std_birth_ID'];
                                                                                   }
                                ?>" name="Std_birth_ID" class="form-control"  type="text" >
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group col-md-12">
                                                                        <div class="col-md-4">
                                                                        ...
                                                                        <div class="col-md-8 selectContainer" style="margin-top:5px;">
                                                                            <select name="Student_BloodGroup" style="text-align:center" class="form-control selectpicker select2">
                                                                                <option value=""> Select an option</option>
                                                                                <option value="1" <?php if ($edit_student_find['0']['Student_BloodGroup'] == '1') {
                                                                                       echo 'selected';
                                                                                   } ?>>A</option>

                                                                                <option value="2" <?php if ($edit_student_find['0']['Student_BloodGroup'] == '2') {
                                                                                            echo 'selected';
                                                                                        }
                                ?>>A -</option> 
                                                                                <option value="3" <?php if ($edit_student_find['0']['Student_BloodGroup'] == '3') {
                                                                                            echo 'selected';
                                                                                        }
                                ?>>B +</option>
                                                                                <option value="4" <?php if ($edit_student_find['0']['Student_BloodGroup'] == '4') {
                                                                                            echo 'selected';
                                                                                        }
                                ?>>B -</option> 
                                                                                <option value="5" <?php if ($edit_student_find['0']['Student_BloodGroup'] == '5') {
                                                                                            echo 'selected';
                                                                                        }
                                ?>>AB +</option> 
                                                                                <option value="6" <?php if ($edit_student_find['0']['Student_BloodGroup'] == '6') {
                                                                                            echo 'selected';
                                                                                        }
                                ?>>AB -</option> 
                                                                                <option value="7" <?php if ($edit_student_find['0']['Student_BloodGroup'] == '7') {
                                                                                            echo 'selected';
                                                                                        }
                                ?>>O +</option> 
                                                                                <option value="8" <?php if ($edit_student_find['0']['Student_BloodGroup'] == '8') {
                                                                                            echo 'selected';
                                                                                        }
                                ?>>O -</option>
                                                                    ...
                                                                    <div class="form-group col-md-12" style="margin-top:5px;">
                                                                        <div class="col-md-4">
                                                                            <label style="text-align:left" class="control-label"> <span class="required"></span>Gender</label>
                                                                        </div>
                                                                        <div class="col-md-8 selectContainer" style="margin-top:5px;">
                                                                            <select name="Std_gender" class="form-control" required="">

                                                                                <option value="1" <?php if ($edit_student_find['0']['Std_gender'] == '1') {
                                                                                            echo 'selected';
                                                                                        } ?>>Male</option>
                                                                                <option value="2" <?php if ($edit_student_find['0']['Std_gender'] == '2') {
                                                                                            echo 'selected';
                                                                                        }
                                ?>>Female</option>
                                                                            </select>
                                                                    ...
                                                                    <div class="form-group col-md-12" style="margin-top:5px;">
                                                                        <div class="col-md-4">
                                                                            <label style="text-align:left" class="control-label"> <span class="required"></span>Religion</label>
                                                                        </div>
                                                                        <div class="col-md-8 selectContainer" style="margin-top:5px;">
                                                                            <select name="Std_religion" class="form-control" required="">

                                                                                <option value="1" <?php if ($edit_student_find['0']['Std_religion'] == '1') {
                                                                                            echo
                                                                                            'selected';
                                                                                        }
                                ?>>MUSLIM</option>
                                                                                <option value="2" <?php if ($edit_student_find['0']['Std_religion'] == '2') {
                                                                                            echo 'selected';
                                                                                        }
                                ?>>HINDU</option>
                                                                                <option value="3" <?php if ($edit_student_find['0']['Std_religion'] == '3') {
                                                                                            echo 'selected';
                                                                                        }
                                ?>>OTHER RELIGION</option>
                                                                    ...
                                                                    <div class="form-group col-md-12 data_1 ">
                                                                        <div class="col-md-4">
                                                                            <label style="text-align:left" class="control-label"> <span class="required"></span>Birth Date</label>
                                                                        </div>
                                                                        <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                                            <div class="input-group date">
                                                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                                                <input id="date1" value="<?php if (!empty($edit_student_find[0]['Std_birthday'])) {
                                                                                            echo $edit_student_find[0]['Std_birthday'];
                                                                                        }
                                ?>" name="Std_birthday" class="start_date form-control"  type="text" >
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group col-md-12 data_2">
                                                                        <div class="col-md-4">
                                                                            <label style="text-align:left" class="control-label"> <span class="required"></span>Registration Date</label>
                                                                        </div>
                                                                        <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                                            <div class="input-group date">
                                                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                                                <input id="date2" value="<?php if (!empty($edit_student_find[0]['Std_registration_date'])) {
                                                                                            echo $edit_student_find[0]['Std_registration_date'];
                                                                                        }
                                ?>" name="Std_registration_date"  class="start_date form-control" type="text" >
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group col-md-12">
                                                                        <div class="col-md-4">
                                                                            <label style="text-align:left" class="control-label"><span class="required" color:red;></span>Address </label>
                                                                        </div>
                                                                        <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                                            <textarea class="form-control" name="Std_address" rows="3">
                                                                                <?php if (!empty($edit_student_find[0]['Std_address'])) {
                                                                                    echo $edit_student_find[0]['Std_address'];
                                                                                }
                                                                                ?>
                                                                            </textarea>
                                                                        </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group col-md-12" style="margin-top:5px;">
                                                                        <div class="col-md-4">
                                                                            <label style="text-align:left" class="control-label"> <span class="required"></span>Academic Year</label>
                                                                        </div>
                                                                        <div class="col-md-8 selectContainer" style="margin-top:5px;">
                                                                            <select name="Std_academic_ID" style="text-align:left"  class="form-control selectpicker select2">
                                                                                <?php foreach ($Year_Data as $key => $value):
                                                                                    ?>
                                                                                    <option value="<?php echo $value['Year_ID'] ?>" <?php if ($edit_student_find['0']['Std_academic_ID'] == $value['Year_ID']) {
                                                                                    echo "selected";
                                                                                } ?>><?php echo $value['Year_Name'] ?></option>
...
<?php endforeach ?>
                                                                    ...
                                                                    <div class="form-group col-md-12" style="margin-top:5px;">
                                                                        <div class="col-md-4">
                                                                            <label style="text-align:left" class="control-label"> <span class="required"></span>Class</label>
                                                                        </div>
                                                                        <div class="col-md-8 selectContainer" style="margin-top:5px;">
                                                                            <select name="Std_class_ID" style="text-align:left" class="form-control selectpicker select2">
                                                                                        <?php foreach ($Class_Data as $key => $value):
                                                                                            ?>
                                                                                    <option value="<?php echo $value['Class_ID'] ?>" <?php if ($edit_student_find['0']['Std_class_ID'] == $value['Class_ID']) {
                                                                                            echo "selected";
...
<?php endforeach ?>
                                                                    ...
                                                                    <div class="form-group col-md-12" style="margin-top:5px;">
                                                                        <div class="col-md-4">
                                                                            <label style="text-align:left" class="control-label"> <span class="required"></span>Section</label>
                                                                        </div>
                                                                        <div class="col-md-8 selectContainer" style="margin-top:5px;">
...
<?php foreach ($Section_Data as $key => $value):
    ?>
                                                                                    <option value="<?php echo $value['Section_ID'] ?>" <?php if ($edit_student_find['0']['Std_section_ID'] == $value['Section_ID']) {
        echo "selected";
...
<?php endforeach ?>
                                                                    ...
                                                                    <div class="form-group col-md-12" style="margin-top:5px;">
                                                                        <div class="col-md-4">
                                                                            <label style="text-align:left" class="control-label"> <span class="required"></span>Group</label>
                                                                        </div>
...
<?php foreach ($Group_Data as $key => $value):
    ?>
                                                                                    <option value="<?php echo $value['Group_ID'] ?>" <?php if ($edit_student_find['0']['Std_group_ID'] == $value['Group_ID']) {
        echo "selected";
...
<?php endforeach ?>
                                                                    ...
                                                                    <div class="form-group col-md-12">
                                                                        ...
                                                                        <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                                            <select name="Std_shift_ID"  style="text-align:left "  class="form-control selectpicker">
                                                                                <option value="1" <?php if ($edit_student_find['0']['Std_shift_ID'] == '1') {
    echo
    'selected';
}
?>>Day</option>
                                                                                <option value="2" <?php if ($edit_student_find['0']['Std_shift_ID'] == '2') {
                                                                                            echo 'selected';
                                                                                        }
?>>Morning</option>
                                                                            </select>
                                                                    ...
                                                                    <div class="form-group col-md-12">
                                                                        ...
                                                                        <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                                            <select name="Std_medium_ID"  style="text-align:left "  class="form-control selectpicker">
                                                                                <option value="1" <?php if ($edit_student_find['0']['Std_medium_ID'] == '1') {
                                                                                            echo
                                                                                            'selected';
                                                                                        }
?>>Bangla</option>
                                                                                <option value="2" <?php if ($edit_student_find['0']['Std_medium_ID'] == '2') {
                                                                                            echo 'selected';
                                                                                        }
?>>English</option>
                                                                    ...
                                                                    <div class="form-group col-md-12">
                                                                        ...
                                                                        <div class="col-md-8 inputGroupContainer">
                                                                            <input  value="<?php if (!empty($edit_student_find[0]['Std_roll'])) {
                                                                                            echo $edit_student_find[0]['Std_roll'];
                                                                                        }
?>" name="Std_roll" class="form-control"  type="text" >
                                                                        </div>
                                                                    </div>

                                                                    <div class="form-group col-md-12">
                                                                        <div class="col-md-4">
                                                                            <label style="text-align:left" class="control-label"><span class="required"></span>Image Upload </label>
                                                                        </div>
                                                                        <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">

                                                                            <input type="hidden"  id="old" name="old_image" value="<?php echo $edit_student_find['0']['Image']; ?>">
                                                                            <input type="file" name="image" id="imgInp" class="form-control" style="padding-top:5px;">
                                                                            <br>
                                                                            <img class="img-responsive" alt="No Image Found" id="blah" style="width:120px;height:110px;" src="<?php echo base_url('/images/student/') . $edit_student_find['0']['Image']; ?>"/>
                                                                    ...
                                                                    <div class="form-group col-md-12">
                                                                        ...
                                                                        <div class="col-md-8 inputGroupContainer selectContainer" style="margin-top:2px;">
                                                                            <select name="Std_status" class="form-control" required="">
                                                                                ...
                                                                                <option value="1" <?php if ($edit_student_find['0']['Std_status'] == 1) {
                                                                                            echo
                                                                                            'selected';
                                                                                        }
?>>Active</option>
                                                                                <option value="2" <?php if ($edit_student_find['0']['Std_status'] == 2) {
                                                                                            echo 'selected';
                                                                                        }
?>>Inactive</option>
                                                                            </select>
                                                ...
                                                <div class="tab-pane fade" id="tab2default">
                                                    <div class="panel-body  well" id="emp_basic_info2" style="display:none;">
                                                    ...
                                                    <form id="basicform" class="well form-horizontal" action="<?php echo base_url(); ?>employee/employee/employee_info_add" method="post" enctype="multipart/form-data">
                                                        <fieldset style="width:600px; text-align:left;margin:auto;">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-6 selectContainer">
                                                                    <select name="employee_id" class="form-control selectpicker select2" onchange="employyeInfo(this.value, 2)" required="">
...
<?php endforeach ?>
                                                ...
                                                <div class="tab-pane fade" id="tab4default">
                                                    <div class="panel-body" id="emp_basic_info4" style="display:none;">
                                                        <fieldset class="" style="width:950px; height:px; text-align:left;margin:auto;" >
                                                            <!-- <legend>Employee Basic info</legend> -->
                                                            <div class="col-sm-12">
                                                                <div class="panel panel-default">
                                                                    <div class="panel-body ">
                                                    ...
                                                    <form id="basicform" class="well form-horizontal" action="<?php echo base_url(); ?>employee/employee/employee_salary_add" method="post" enctype="multipart/form-data">
                                                                                    ...
                                                                                    <div class="card-body ">
                                                                                        <div class="table-responsive">
                                                                                            <table class="table table-striped custom-table table-hover">
                                                                                                <thead style=" background: #1ab394; color: #ffffff;">
                                                                                                    <tr>
