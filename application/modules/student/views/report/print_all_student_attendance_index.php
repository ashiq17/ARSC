                ...
                <div class="col-md-12 ">
                    <div class="wrapper wrapper-content">
                        <div class="ibox float-e-margins">
                                    ...
                                    <h4 style="font-size: 15px; margin-top: 0px; text-align: center">Student Attendance Report <strong></strong></h4>
                                    </div>
                                ...
                                <div class="panel-heading">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade in active" id="tab1default">
                                            <form class="well form-horizontal" action="<?php echo base_url();?>student/student/print_all_student_attendance" target="_blank" method="post" enctype="multipart/form-data">
                                               ...
                                               <div class="col-md-12" style="text-align: left;">
                                                 <div class="form-group col-md-12 data_1">
                                                   ...
                                                   <div class="form-group col-md-12 data_1">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <div class="col-md-4">
                                                            <label style="text-align:left" class=" control-label"><span class="" color:red;></span>Class Name </label>
                                                        </div>  
                                                        <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                           <select name="Std_class_ID" id="Std_class_ID" style="text-align:left" required="required"  class="form-control selectpicker select2" onchange="ClassTitle(this.value)">
                                                                <option value="" ></option>
