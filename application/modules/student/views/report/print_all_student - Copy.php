            ...
            <table id="tblExport" class="table table-striped table-bordered table-hover dataTables-example" style="margin-bottom: 5px;">
                ...
                <thead class="theight">
                    ...
                    <tr>
                        ...
                        <th style="width: 14%; text-align: left"><span style="margin-left:10px; ">Student's Name</span></th> 
                        <th style="width: 6%; text-align: center"><span style="margin-left:10px; ">Student's ID</span></th> 
                        <th style="width: 10%; text-align: left"><span style="margin-left:10px; ">Father's Name</span></th>
                    ...
                    <td style="width: 14%; text-align:left"><strong style="margin-left:10px;"><?php echo $info['Std_Name'] ?></strong></td>
                    <td style="width: 6%; text-align:center"><strong style="margin-left:10px;"><?php echo $info['STD_UNQ_ID'] ?></strong></td>
                    <td style="width: 10%; text-align:left"><strong style="margin-left:10px;"><?php echo $info['Std_parent'] ?></strong></td>
                    ...
                    <td style="width: 4%; text-align:center"><strong style="margin-left:10px;"><?php if ($info['Std_gender']==1) {echo 'Son';} elseif ($info['Std_gender']==2) { echo 'Daughter';
                              }?></strong></td>
