                  ...
                  <div class="wrapper wrapper-content">
                     <div class="ibox float-e-margins">
                        <div class="ibox-title" style="background:#1979CA;">
                           <h5 style="color:#ffffff"><i class="fa fa-user-plus"></i>Student Info</h5>
                           ...
                           <div class="panel with-nav-tabs panel-default">
                              <div class="panel-heading">
                                 <ul class="nav nav-tabs tab-menu">
                                    <li >
                                       <a  href="#tab1default" data-toggle="tab">Student Admission Info</a>
                                    </li>

                                    <li class="active">
                                       <a  href="#tab2default" data-toggle="tab">Student System Info</a>
                                    </li>
                              ...
                              <div class="panel-body">
                                 <div class="tab-content">
                                       ...
                                       <form class=" form-horizontal" action="<?php echo base_url();?>student/student/student_info_add" method="post" enctype="multipart/form-data">
                                          <fieldset   style="width:900px; height:px; text-align:left;margin:auto;" >
                                             <!--  <div   style="width:900px;border:1px solid red; height:400px; text-align:center;margin:auto;" > -->
                                                 <h2 style="text-align: center;color:#3F3F3F;"> <u>Student Basic Information </u></h2>
                                             <div class="col-md-12">
                                                <div class="col-md-6">
                                                    <div class="form-group col-md-12 data_1">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer">
                                                         <input name="STD_UNQ_ID" id="student_uniqueid" onchange="teacher_uniqueid_keyup()" style="margin-top:5px;" class="form-control"  type="text">
                                                      </div>
                                                      <span id="student_uniqueid_msg" style="color: red;"></span>
                                                   </div> 
                                                   <div class="form-group  col-md-12 data_1">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class=" control-label"> <span class=""></span> Student Name</label> 
                                                      </div>
                                                      <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                         <input  name="Std_Name"  class="form-control"  type="text" required>
                                                      </div>
                                                   </div>
                                                    <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer">
                                                         <input name="Std_parent" style="margin-top:5px;" class="form-control"  type="text">
                                                      </div>
                                                   </div>
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer">
                                                         <input name="Std_parent2" style="margin-top:5px;" class="form-control"  type="text">
                                                      </div>
                                                   </div>
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer">
                                                         <input name="Std_parent_mobile" style="margin-top:5px;" class="form-control"  type="text"   >
                                                      </div>
                                                   </div>
                                                   <div class="form-group col-md-12">
                                                      <div class="col-md-4">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer">
                                                         <input name="Std_email" style="margin-top:5px;" class="form-control"  type="email"   >
                                                      </div>
                                                   </div>
                                                   <div class="form-group col-md-12">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class=" control-label"><span ></span>Birth Cert. ID </label> 
                                                      </div>
                                                      <div class="col-md-8 inputGroupContainer">
                                                         <input name="Std_birth_ID" style="margin-top:5px;" class="form-control"  type="text"   >
                                                      </div>
                                                   </div>
                                                    <div class="form-group col-md-12">
                                                      <div class="col-md-4">
                                                      ...
                                                      <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                         <select name="Student_BloodGroup"  style="text-align:left "  class="form-control selectpicker select2">
                                                             <option value="" ></option> 
                                                   ...
                                                   <div class="form-group col-md-12" style="margin-top:5px;">
                                                      ...
                                                      <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                         <select name="Std_gender"  style="text-align:left "  class="form-control selectpicker">
                                                   ...
                                                   <div class="form-group col-md-12" style="margin-top:5px;">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class=" control-label"> <span class=""></span>Religion</label>
                                                      </div>
                                                      <div class="col-md-8 selectContainer" style="margin-top:5px;">
                                                         <select name="Std_religion"  style="text-align:left "  class="form-control selectpicker">
                                                   ...
                                                   <div class="form-group col-md-12 data_1">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class="control-label"> <span class=""></span> Date Of Birth</label>
                                                      </div>
                                                      <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                   ...
                                                   <div class="form-group col-md-12 data_1">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class=" control-label"> <span class=""></span>Registration Date</label>
                                                      </div>
                                                      <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                         <div class="input-group date">
                                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input id="date1" type="text" name="Std_registration_date" class="start_date form-control">
                                                         </div>
                                                      </div>
                                                   </div>
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class=" control-label"><span class="" color:red;></span>Address </label>
                                                      </div>
                                                      <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                         <textarea name="Std_address" class="form-control"></textarea>
                                                      </div>
                                                   </div>
                                                ...
                                                <div class="col-md-6">
                                                   <div class="form-group col-md-12" style="margin-top:5px;">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class=" control-label"> <span class=""></span>Academic Year</label>
                                                      </div>
                                                      <div class="col-md-8 selectContainer" style="margin-top:5px;">
                                                            <select name="Std_academic_ID" style="text-align:left"  class="form-control selectpicker select2" onchange="ClassTitle(this.value)">
                                                                <option value="" ></option>
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class=" control-label"><span ></span> Class Roll</label> 
                                                      </div>
                                                      <div class="col-md-8 inputGroupContainer">
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                         ...
                                                         <br>
                                                         <img class="img-responsive" style="width:120px;height:110px;" id="blah" alt="Student Image"/>  
                                                      </div>
                                                   </div>
                                                   <div class="form-group col-md-12">
                                                      <div class="col-md-4">
                                    ...
                                    <div class="tab-pane fade in active " id="tab2default">
                                       ...
                                       <form id="basicform" class=" form-horizontal" action="<?php echo base_url();?>student/student/student_user_info_add"   target=”_blank" method="post" enctype="multipart/form-data">
                                          <fieldset style="width:600px; text-align:left;margin:auto;">
                                              <?php
                                                ...
                                                <?php 
                                                   ...
                                                   ?>
                                                  <legend style="text-align: center; border-bottom: 1px solid;">Student System  Info. Add</legend>
                                             <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                <div class="col-md-3">
                                                   <label style="text-align:left" class="control-label"> <span class="">*</span>Username</label>
                                                </div>
                                                <div class="col-md-6 inputGroupContainer" style="margin-top:5px;">
                                                    
                                                      <input id="new_username" onchange="userid_keyup()" type="readonly" name="username" placeholder="Type your username!"  class="stu_unq_id form-control"  required="required">     
                                             ...
                                             <div class="form-group">
                                                <div class="col-md-3">
                                                   <label style="text-align:left" class="control-label"> <span class=""></span>Email</label>
                                                </div>
                                                <div class="col-md-6 inputGroupContainer">
                                                     <input  name="email" id="email" onchange="email_keyup()" class="form-control" type="text" >
                                                </div>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-6 inputGroupContainer">
                                                   ...
                                                   <input id="" name="password"  class="form-control randPassword"  type="text" required>
                                                </div>
                                             </div>
                                             <div class="form-group">
                                                <div class="col-md-3">
                                                ...
                                                <div class="col-md-6 inputGroupContainer">
                                                   <input id="passconf"  name="passconf"  class="form-control randPassword"  type="" required>
                                                </div>
                                             </div>
                                             <div class="form-group">
                                                <div class="col-md-3">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-6"><br>
                                                   <input type="reset" name="reset" class="btn btn-info btn-sm" value="Reset">
                                                   <input type="submit" name="submit" class="btn btn-primary btn-sm" value="Submit" id="buttondisabled">
                                                </div>
                                             </div>
                                          </fieldset>
                                       </form>
                                                               ...
                                                               <div class="card-body ">
                                                                  <div class="table-responsive">
                                                                     <table class="table table-striped custom-table table-hover">
                                                                        <thead style=" background: #1969CA; color: #3F3F3F;">
                                                                           <tr>
...
<script type="text/javascript">
   ...
   // alert(data[0].exist);
      ...
      if(data[0].exist==1){
                ...
                document.getElementById('unique_username_msg').innerHTML = "<span style='color:green;'>Available</span>";
                $("#buttondisabled").removeAttr("disabled", "disabled");
            }
   ...
   $(".stu_unq_id").val(data[i].STD_UNQ_ID);
   $(".randPassword").val(data[i].randPassword);
   } // for
