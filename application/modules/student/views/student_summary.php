                  ...
                  <div class="wrapper wrapper-content">
                     <div class="ibox float-e-margins">
                        <div class="ibox-title" style="background:#1979CA">
                           <h5 style="color:#ffffff"><i class="fa fa-user-plus"></i>Student Summary </h5>
                                       ...
                                       <div class="panel-body" id="emp_basic_info4" style="display:none;">
                                          ...
                                          <form id="basicform" class="well form-horizontal" action="<?php echo base_url();?>student/student/student_summary" method="post" enctype="multipart/form-data">
                                             <fieldset style="width:100%; text-align:center;margin:auto;">
                                                  <h2 style="text-align: center;color:#3F3F3F; padding: 10PX 0PX;"> <u>Student Summary Information </u></h2>
                                                <div class="col-md-12">
                                                   <div class="row">
                                                      <div class="col-md-12">
                                                         <div class="row">
