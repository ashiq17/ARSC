    ...
    <script type="text/javascript">
        $(document).on("click", ".open-messageView", function () {
            ...
            $(".ibox-content #msgText").html( message ); 
             ...
             $.getJSON("<?php echo base_url();?>contact/contact_message/read_status_change?1=1&msgID="+id, function(data) { 
                /* $('.ibox-content img').attr('src', "<?php echo base_url(); ?>images/students/"+data.userfile); */
            });
    ...
    <!-- Message View Modal start-->
        ...
        <div class="modal" id="deleteModal" role="dialog"  aria-hidden="true">
            <div class="modal-dialog" >
                ...
                <form class="form-horizontal form_class" id="form_id" action="<?php echo base_url();?>contact/contact_message/delete_unread_message" role="form" method="post" enctype="multipart/form-data">
                       <div class="ibox-content" style="padding-top: 10px;">
                        <!--<p>Sign in today for more expirience.</p>-->
