                                        ...
                                        <div class="ibox float-e-margins">
                                            <div id="" class="panel blank-panel">
                                                ...
                                                <div class="ibox-title" >
                                                    <h5>Sidebar Widgets <a class="sd-button" style="padding: 0 10px 0 10px;" href="<?php echo base_url();?>appearance/widgets/new_page_widget">Add New</a></h5> 
                                                    ...
                                                    <div class="panel-body">
                                                        <table class="table table-striped table-bordered table-hover dataTables-example" style="margin-bottom: 5px; width: 100%;">
                                                            ...
                                                            <tbody>
                                                                    ...
                                                                    <?php 
                                                                    $sl = 1;
                                                                        foreach($page_widget as $key=>$widgetInfo) {
                                                                            ?>
                                                                                <tr>
                                                                                    <td><?php echo $sl; ?></td>
                                                                                    ...
                                                                                    <?php 
                                                                                        if($widgetInfo->IsEditable == 0) {
                                                                                            ...
                                                                                            ?>
                                                                                                <td style="text-align: center;"><a href="<?php echo base_url();?>appearance/widgets/edit_page_widget/<?php echo $widgetInfo->ID; ?>">Edit</a></td>
                                                                                            <?php
                                                                                        }
                                                                                    ?>
