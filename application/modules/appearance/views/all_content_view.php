...
<div class="ibox-title" >
    <h5><i class="fa fa-plus"></i> Content Add</h5>
    <h5 class="col-md-10 text-right">
        <a class="sd-button" style="padding: 0 10px 0 10px;" href="<?php echo base_url();?>appearance/contents/add_content">Add Content New</a> 
    </h5>
                        ...
                        foreach($news_data as $key=>$Newsinfo) {
                            ...
                            <tr class="gradeC">
                                ...
                                <td><?php 
                                    ...
                                    <td style="text-align: center;"><a href="<?php echo base_url();?>appearance/contents/content_edit/<?php echo $newsId; ?>">Edit</a></td>
                                    ...
                                    if($pubinfo->PublishStatus == 1) {
                                        ...
                                        <tr class="gradeC">
                                            ...
                                            <td><?php 
                                                ...
                                                <td style="text-align: center;"><a href="<?php echo base_url();?>appearance/contents/content_edit/<?php echo $newsId; ?>">Edit</a></td>
                                                <td style="text-align: center;"><a href="<?php echo base_url();?>appearance/contents/news_delete/<?php echo $newsId; ?>">Delete</a></td>
...
<h4 class="modal-title" id="myModallabel"></i> Delete This Content !</h4>

</div><!-- modal header -->

<form action="<?php echo base_url();?>appearance/contents/news_delete" method="post" enctype="multipart/form-data">
...
<h3>Are your sure to delete " <span style="font-size: 12px;" id="newsName"></span> " ?</h3>
</div>
</div>                            
