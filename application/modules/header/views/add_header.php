                                        ...
                                        <div class="panel-body">
                                            <div class="tab-content">
                                                <div class="tab-pane fade in active" id="tab1default">
                                                    <form class="well form-horizontal" action="<?php echo base_url(); ?>header/header/add_header_info" method="post" enctype="multipart/form-data">
                                                        <fieldset>
                                                            ...
                                                            <div class="form-group">
                                                                <label style="text-align:left" class="col-md-2 control-label"> <span ></span>
                                                                    Title</label>  
                                                                <div class="col-md-6 inputGroupContainer">
                                                                    <input  name="header_title" class="form-control"  type="text">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                        ...
                        <div class="modal-content"> 
                            ...
                            <div class="modal-body"> 
                                ...
                                <div class="tab-pane fade in " id="tab1default">
                                    <form class="well form-horizontal" action="<?php echo base_url(); ?>header/header/header_info_edit" method="post" enctype="multipart/form-data">
                                        <fieldset>

                                            <div class="row">
                                                <input type="hidden" name="header_id"  value="<?php
                                                if (!empty($header_data[0]['HeaderID'])) {
                                                    echo $header_data[0]['HeaderID'];
                                                }
                                                ?>">  
                                                <div class="col-lg-12">
                                                    <div class="ibox">
                                                        <div class="ibox-content">
                                                            <div class="col-md-6">
                                                                <p>Old Image</p>
                                                                <input type="hidden"  id="old"  name="old_image"  value="<?php echo $header_data['0']['Image']; ?>">
                                                                <br>
                                                                <img class="img-responsive" id="" style="width:160px;height:100px;" alt="No Image Found" src="<?php echo base_url('/assets/images/headerImages/') . $header_data['0']['Image'] ?>"/>
                                            ...
                                            <div class="form-group">
                                                <label style="text-align:left" class="col-md-3 control-label"></span>Header Title </label>  
                                                <div class="col-md-9 inputGroupContainer">
                                                    <input value="<?php
                                                    if (!empty($header_data[0]['HeaderTitle'])) {
                                                        echo $header_data[0]['HeaderTitle'];
                                                    }
                                                    ?>" name="header_title"  class="form-control"  type="text" >
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 inputGroupContainer">
                                                    <input value="<?php
                                                    if (!empty($header_data[0]['MobileNo'])) {
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 inputGroupContainer">
                                                    <input value="<?php
                                                    if (!empty($header_data[0]['TelephoneNo'])) {
                                                        echo $header_data[0]['TelephoneNo'];
                                                    }
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 inputGroupContainer">
                                                    <input value="<?php
                                                    if (!empty($header_data[0]['Website'])) {
                                                        echo $header_data[0]['Website'];
                                                    }
                                                    ?>" name="website" class="form-control"  type="text" >
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 inputGroupContainer">
                                                    <input value="<?php
                                                    if (!empty($header_data[0]['Address1'])) {
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 inputGroupContainer">
                                                    <input value="<?php
                                                    if (!empty($header_data[0]['Address2'])) {
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 inputGroupContainer">
                                                    <input value="<?php
                                                    if (!empty($header_data[0]['FacebookLink'])) {
                                                        echo $header_data[0]['FacebookLink'];
                                                    }
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 inputGroupContainer">
                                                    <input value="<?php
                                                    if (!empty($header_data[0]['TwitterLink'])) {
                                                        echo $header_data[0]['TwitterLink'];
                                                    }
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 inputGroupContainer">
                                                    <input value="<?php
                                                    if (!empty($header_data[0]['YouTubeLink'])) {
                                                        echo $header_data[0]['YouTubeLink'];
                                                    }
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 inputGroupContainer">
                                                    <input value="<?php
                                                    if (!empty($header_data[0]['AddLink1'])) {
                                                        echo $header_data[0]['AddLink1'];
                                                    }
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 inputGroupContainer">
                                                    <input value="<?php
                                                    if (!empty($header_data[0]['AddLink2'])) {
                                                        echo $header_data[0]['AddLink2'];
                                                    }
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 inputGroupContainer">
                                                    <input value="<?php
                                                    if (!empty($header_data[0]['ExtraInfo'])) {
                                                        echo $header_data[0]['ExtraInfo'];
                                                    }
                                            ...
                                            <!-- <div class="form-group">
                                                <label style="text-align:left" class="col-md-3 control-label">header Status</label>  
                                                <div class="col-md-9 inputGroupContainer">
                                                    <input value="<?php
                                            if (!empty($header_data[0]['headerStatus'])) {
                                                echo $header_data[0]['headerStatus'];
                                            }
                                            ?>" name="header_status" class="form-control"  type="text">
                                                </div>
                                            </div> -->
                                            <div class="form-group">
