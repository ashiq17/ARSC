                  ...
                  <div class="wrapper wrapper-content">
                     <div class="ibox float-e-margins">
                        <div class="ibox-title" style="background:#1979CA;">
                           <h5 style="color:#D7E1ED"><i class="fa fa-star"></i>New Expense Entry Form</h5>
                           <div class="ibox-tools">
                              <a class="btn btn-success" style="padding: 0 10px 0 10px;" href="<?php echo base_url();?>Expense/Expense/expense_list"><i class='fa fa-star'></i> Expense List</a>
                           ...
                           <div class="panel with-nav-tabs panel-default">
                              <div class="panel-heading">
                                 <ul class="nav nav-tabs tab-menu">
                                    <li class="active">
                                       <a  href="#tab1default" data-toggle="tab">Add Expense</a>
                                    </li>
                              ...
                              <div class="panel-body">
                                 <div class="tab-content">
                                    <div class="tab-pane fade in active" id="tab1default">
                                       ...
                                       <form class="well form-horizontal" action="<?php echo base_url();?>Expense/Expense/expense_add" method="post" enctype="multipart/form-data">
                                             ...
                                             <div class="col-md-12" style="margin-top: 10!important;">
                                                <div class="col-md-8">
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class="control-label"><span ></span>Expense Category</label> 
                                                      </div>
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer">
                                                         <input name="Expense_Amount" style="margin-top:5px;" class="form-control" type="mobile">
                                                      </div>
                                                   </div>
                                                      ...
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class="control-label"> <span class=""></span> Date</label>
                                                      </div>
                                                      <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
                                                         <div class="input-group date">
                                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input id="date1"  type="text" name="Expense_Date" class="start_date form-control">
                                                         </div>
                                                      </div>
                                                   </div>
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      <div class="col-md-4">
                                                         <label style="text-align:left" class=" control-label"><span class="required" color:red;></span>Notes </label>
                                                      </div>
                                                      <div class="col-md-8 inputGroupContainer"  style="margin-top:5px;">
                                                         <textarea name="Expense_notes" class="form-control"></textarea>
                                                      </div>
                                                   </div>
