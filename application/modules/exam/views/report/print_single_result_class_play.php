...
<div style="display: none;">
 ...
 ?> 
        ...
        <div class="ibox float-e-margins">
                    ...
                    <tr >
                       ...
                       <th style="width: 50%; text-align: left"> <?php if (!empty($info['0']['Std_Name'])) {
                        ...
                        <th style="width: 10%; text-align: left">Roll :</th>
                         ...
                         <th style="width: 20%; text-align: left"> <?php if (!empty($info['0']['Std_roll'])) {
                        echo $info['0']['Std_roll'];
                       } ?></th> 
                    </tr>
                </table>
            ...
            <table class="" style="width:75%; margin: auto; margin-top: 5px; border-color: #ddd;" border="1">
                    <tr >
                     ...
                     foreach ($print_exam_report_single_find as $key => $info):
                      ...
                      $sub_highest_marks = $this->Exam_result_model->find_sub_highest_marks($subject_id,$exam_code_ID,$class_ID,$medium_ID,$shift_ID,$section_ID);
                      foreach ($sub_highest_marks as $key => $sub_highest_marks) {
                    
                      ?>
                     <tr >
                        <!-- <th style="width: 2%; text-align: center"><?php echo $sl ;?></th> -->
                        <th style="width: 20%; text-align: left;padding-left: 15px;"><?php if (!empty($info['Subject_Name'])) {
            ...
            <a href=" " id="print-container-body" download>Download</a>
