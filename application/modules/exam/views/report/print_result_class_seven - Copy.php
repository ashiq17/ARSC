 ...
 ?> 
        ...
        <div class="ibox float-e-margins">
            <div class="" style="margin-top: 1px;">
                <div style="width:50%; margin-left: 20px;margin-top: 5px; ">
                   ...
                   <!--  <span><p class="backside_bottom"><?php if(!empty($header_data[0]['Address2'])){
                    ...
                    <span> <p class="backside_bottom">
                      ...
                      <!--   <span style="margin-left: 50px;"> Class <span  style="margin-left: 10px;">:</span><strong> <?php echo $exam_class ;?></strong> </span> -->
                        ...
                        <span style="margin-left: 50px;"> Shift <span  style="margin-left: 10px;">:</span><strong> <?php echo $exam_Std_shiftName ;?></strong> </span>

                        <span style="margin-left: 50px;"> Section <span  style="margin-left: 10px;">:</span><strong> <?php echo $exam_sectionName ;?></strong> </span> 
                        <span style="margin-left: 50px;"> Group <span  style="margin-left: 10px;">:</span><strong> <?php echo $exam_groupName ;?></strong> </span>
            ...
            <table id="tblExport" class="table table-striped table-bordered table-hover dataTables-example" style="margin-bottom: 5px;">
                ...
                <thead class="theight">
                    ...
                    <td style="width: 7%; text-align:center"><strong style="margin-left:10px;">
                      <?php 
                        foreach ($marks_result as $key => $marks_value) {
                            if(trim(strtolower($marks_value['Marks_stu_sub_name'])) == 'Bangla 1st Paper'){
                    ...
                    <td style="width: 7%; text-align:center"><strong style="margin-left:10px;">
                      <?php 
                        foreach ($marks_result as $key => $marks_value) {
                            if(trim(strtolower($marks_value['Marks_stu_sub_name'])) == 'Bangla 2nd Paper'){
                              echo $marks_value['Marks_stu_sub_total_marks'];
                        }
                        }      
                       ?>
                    ...
                    <td style="width: 7%; text-align:center"><strong style="margin-left:10px;">
                      <?php 
                        foreach ($marks_result as $key => $marks_value) {
                            if(trim(strtolower($marks_value['Marks_stu_sub_name'])) == 'English 1st Paper'){
                              echo $marks_value['Marks_stu_sub_total_marks'];
                        }
                        }      
                       ?>
                    ...
                    <td style="width: 7%; text-align:center"><strong style="margin-left:10px;">
                      <?php 
                        foreach ($marks_result as $key => $marks_value) {
                            if(trim(strtolower($marks_value['Marks_stu_sub_name'])) == 'English 2nd Paper'){
                              echo $marks_value['Marks_stu_sub_total_marks'];
                        }
                        }      
                       ?>
                    ...
                    <td style="width: 7%; text-align:center"><strong style="margin-left:10px;">
                      <?php 
                        foreach ($marks_result as $key => $marks_value) {
                            if(trim(strtolower($marks_value['Marks_stu_sub_name'])) == 'B & G Science'){
                              echo $marks_value['Marks_stu_sub_total_marks'];
                        }
                        }      
                       ?>
                    ...
                    <td style="width: 7%; text-align:center"><strong style="margin-left:10px;">
                      <?php 
                        foreach ($marks_result as $key => $marks_value) {
                            if(trim(strtolower($marks_value['Marks_stu_sub_name'])) == 'Science'){
                              echo $marks_value['Marks_stu_sub_total_marks'];
                        }
                        }      
                       ?>
                    ...
                    <td style="width: 7%; text-align:center"><strong style="margin-left:10px;">
                      <?php 
                        foreach ($marks_result as $key => $marks_value) {
                            if(trim(strtolower($marks_value['Marks_stu_sub_name'])) == 'Agri./H. Science'){
                              echo $marks_value['Marks_stu_sub_total_marks'];
                        }
                        }      
                       ?>
                    ...
                    <td style="width: 7%; text-align:center"><strong style="margin-left:10px;">
                      <?php 
                        foreach ($marks_result as $key => $marks_value) {
                            if(trim(strtolower($marks_value['Marks_stu_sub_name'])) == 'I.C.T'){
                              echo $marks_value['Marks_stu_sub_total_marks'];
                        }
                        }      
                       ?>
                    ...
                    <td style="width: 7%; text-align:center"><strong style="margin-left:10px;">
                      ...
                      <?php if(!empty($TOTAL_MARKS[0]['TOTAL_MARKS'])){
