        ...
        <div class=" float-e-margins">
            <div class="" style="margin-top: 1px;">
                ...
                <div class="company-head" style="">
                     ...
                     <h2 class=""><?php if(!empty($header_data[0]['HeaderTitle'])){
                        echo $header_data[0]['HeaderTitle'];} ?></h2>
            ...
            <table id="tblExport" class="table table-striped table-bordered table-hover dataTables-example" style="margin-bottom: 5px;">
                ...
                <thead class="theight">
                    ...
                    <tr>
                        ...
                        <th style="width: 18%; text-align: left"><span style="margin-left:5px; ">Student's Name</span></th> 
                        ...
                        <th style="width: 7%;  text-align: center"><span style="margin-left:10px; ">Arabic</span></th> 
                        <th style="width: 7%;  text-align: center"><span style="margin-left:10px; ">G. Knowledge </span></th> 
                        <th style="width: 7%;  text-align: center"><span style="margin-left:10px; ">Moktab</span></th> 
                        <th style="width: 7%;  text-align: center"><span style="margin-left:10px; ">Drowing</span></th> 
                        <th style="width: 7%;  text-align: center"><span style="margin-left:10px; ">Practical</span></th> 
                       
                        <th style="width: 10%;  text-align: center"><span style="margin-left:10px; ">Total Marks</span></th> 
                    ...
                    <td style="width: 18%; text-align:left"><strong style="margin-left:10px;"><?php if (!empty($value['Std_Name'])) {
                   ...
                   <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($value['Std_roll'])) {echo $value['Std_roll'];} ?></strong></td> 
                    ...
                    <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($marks_result[0]['Marks_Sum_Arabic'])) { echo  $marks_result[0]['Marks_Sum_Arabic'];
                    } ?></strong></td>
                    
                    <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($marks_result[0]['Marks_Sum_GKnowledge'])) { echo  $marks_result[0]['Marks_Sum_GKnowledge'];
                    } ?></strong></td> 
                    ...
                    <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($marks_result[0]['Marks_Sum_Drawing'])) { echo  $marks_result[0]['Marks_Sum_Drawing'];
                    } ?></strong></td>
                  ...
                  <td style="width: 12%; text-align:center"><strong style="margin-left:10px;">
                      <?php  
                        ...
                        if (!empty($marks_result[0]['Marks_Sum_Arabic'])) { 
                        $arabic  =$marks_result[0]['Marks_Sum_Arabic']; }; 

                        if (!empty($marks_result[0]['Marks_Sum_GKnowledge'])) { 
                        ...
                        if (!empty($marks_result[0]['Marks_Sum_Drawing'])) { 
                        ...
                        $TOTAL_MARKS  =$bangla+$english+$mathematics+$arabic+$gknowledge+$moktab+$drawing+$practical;
