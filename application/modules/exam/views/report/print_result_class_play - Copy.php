            ...
            <table id="tblExport" class="table table-striped table-bordered table-hover dataTables-example" style="margin-bottom: 5px;">
                ...
                <thead class="theight">
                    ...
                    <tr>
                        ...
                        <th style="width: 4%;  text-align: center"><span style="margin-left:10px; ">Section </span></th> 
                    ...
                    <td style="width: 4%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($value['Section_Name'])) {echo $value['Section_Name'];} ?></strong></td>
                    ...
                    <td style="width: 7%; text-align:center"><strong style="margin-left:10px;"><?php if (!empty($marks_result[0]['Marks_Sum_Computer'])) { echo  $marks_result[0]['Marks_Sum_Computer'];
                    } ?></strong></td> 
                  ...
                  <td style="width: 7%; text-align:center"><strong style="margin-left:10px;">
                      <?php  
                        ...
                        if (!empty($marks_result[0]['Marks_Sum_Computer'])) { 
