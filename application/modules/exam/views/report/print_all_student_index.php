                                ...
                                <div class="panel with-nav-tabs panel-default">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade in active" id="tab1default">
                                            <form class="well form-horizontal" action="<?php echo base_url();?>student/student/print_all_student" method="post" enctype="multipart/form-data">
                                               ...
                                               <div class="col-md-12" style="text-align: left;">
                                                 <div class="form-group col-md-12 data_1">
                                                   ...
                                                   <div class="form-group col-md-12 data_1">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <div class="col-md-4">
                                                            <label style="" class=" control-label"><span class="" color:red;></span> Shift Medium </label>
                                                        </div>  
                                                        <div class="col-md-8 inputGroupContainer" style="margin-top:5px;">
