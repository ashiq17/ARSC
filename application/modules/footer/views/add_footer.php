                        ...
                        <div class="wrapper wrapper-content">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title" style="background:#1969ca">
                                    <h5 style="color:#D7E1ED"><i class="fa fa-user-plus"></i> Footer Info</h5> 
                                    ...
                                    <div class="panel with-nav-tabs panel-default">
                                        <div class="panel-heading">
                                            <ul class="nav nav-tabs tab-menu">
                                                <li class="active"><a href="#tab1default" data-toggle="tab">Footer Info Add</a></li>
                                            </ul>
                                        </div>
                                        <div class="panel-body">
                                            <div class="tab-content">
                                                <div class="tab-pane fade in active" id="tab1default">
                                                    <form class="well form-horizontal" action="<?php echo base_url(); ?>footer/footer/add_footer_info" method="post" enctype="multipart/form-data">
                                                        <fieldset>
                                                            <div class="form-group">
                                                                <label style="text-align:left" class="col-md-2 control-label"><span >*</span>Logo Upload </label>  
                                                            ...
                                                            <div class="form-group">
                                                                <label style="text-align:left" class="col-md-2 control-label"> <span ></span>Telephone No.</label>  
                                                                <div class="col-md-6 inputGroupContainer">
                ...
                <div id="view-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                        ...
                        <div class="modal-content"> 
                            ...
                            <div class="modal-header"> 
                                ...
                                <h4 class="modal-title text-center">
                                    <i class="fa fa-edit"></i> Edit Footer
                                </h4> 
                            </div> 
                            <div class="modal-body"> 
                                ...
                                <div class="tab-pane fade in active" id="tab1default">
                                    <form class="well form-horizontal" action="<?php echo base_url(); ?>footer/footer/footer_info_edit" method="post" enctype="multipart/form-data">
                                        <fieldset>

                                            <div class="row">
                                                <input type="hidden" name="footer_id"  value="<?php if (!empty($footer_data[0]['FooterID'])) {
                    echo $footer_data[0]['FooterID'];
                } ?>">  
                                                <div class="col-lg-12">
                                                    <div class="ibox">
                                                        <div class="ibox-content">
                                                            <div class="col-md-6">
                                                                <p>Old Image</p>
                                                                <input type="hidden"  id="old"  name="old_image"  value="<?php echo $footer_data['0']['Image']; ?>">
                                                                <br>
                                                                <img class="img-responsive" id="" style="width:160px;height:100px;" alt="No Image Found" src="<?php echo base_url('/assets/images/footerImages/') . $footer_data['0']['Image'] ?>"/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 inputGroupContainer">
                                                    <input value="<?php if (!empty($footer_data[0]['MobileNo'])) {
                    echo $footer_data[0]['MobileNo'];
                } ?>" name="mobile_no"  class="form-control"  type="text" >
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label style="text-align:left" class="col-md-3 control-label"></span>Telephone No.</label>  
                                                <div class="col-md-9 inputGroupContainer">
                                                    <input value="<?php if (!empty($footer_data[0]['TelephoneNo'])) {
                    echo $footer_data[0]['TelephoneNo'];
                } ?>" name="telephone_no" class="form-control"  type="text" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 inputGroupContainer">
                                                    <input value="<?php if (!empty($footer_data[0]['Email'])) {
                    echo $footer_data[0]['Email'];
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 inputGroupContainer">
                                                    <input value="<?php if (!empty($footer_data[0]['Website'])) {
                    echo $footer_data[0]['Website'];
                } ?>" name="wsebsite" class="form-control"  type="text" >
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label style="text-align:left" class="col-md-3 control-label"></span>Address 1</label>  
                                                <div class="col-md-9 inputGroupContainer">
                                                    <input value="<?php if (!empty($footer_data[0]['Address1'])) {
                    echo $footer_data[0]['Address1'];
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 inputGroupContainer">
                                                    <input value="<?php if (!empty($footer_data[0]['Address2'])) {
                    echo $footer_data[0]['Address2'];
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 inputGroupContainer">
                                                    <input value="<?php if (!empty($footer_data[0]['FacebookLink'])) {
                    echo $footer_data[0]['FacebookLink'];
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 inputGroupContainer">
                                                    <input value="<?php if (!empty($footer_data[0]['TwitterLink'])) {
                    echo $footer_data[0]['TwitterLink'];
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 inputGroupContainer">
                                                    <input value="<?php if (!empty($footer_data[0]['YouTubeLink'])) {
                    echo $footer_data[0]['YouTubeLink'];
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 inputGroupContainer">
                                                    <input value="<?php if (!empty($footer_data[0]['AddLink1'])) {
                    echo $footer_data[0]['AddLink1'];
                } ?>" name="add_link1" class="form-control"  type="text" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 inputGroupContainer">
                                                    <input value="<?php if (!empty($footer_data[0]['AddLink2'])) {
                    echo $footer_data[0]['AddLink2'];
                } ?>" name="add_link2" class="form-control"  type="text" >
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label style="text-align:left" class="col-md-3 control-label"></span>Extra Info.</label>  
                                                <div class="col-md-9 inputGroupContainer">
                                                    <input value="<?php if (!empty($footer_data[0]['ExtraInfo'])) {
                    echo $footer_data[0]['ExtraInfo'];
                } ?>" name="extra_info" class="form-control"  type="text" >
                                                </div>
                                            </div>


                                            <!-- <div class="form-group">
                                                <label style="text-align:left" class="col-md-3 control-label">Footer Status</label>  
                                                <div class="col-md-9 inputGroupContainer">
                                                    <input value="<?php if (!empty($footer_data[0]['FooterStatus'])) {
                    echo $footer_data[0]['FooterStatus'];
                } ?>" name="footer_status" class="form-control"  type="text">
                                                </div>
                                            </div> -->
                                            <div class="form-group">
