        ...
        <div class="ibox float-e-margins">
            <div class="" style="">
                <div class="" style="width:100%;">
                     <?php $info=$print_teacher_single_find; ?>
                <table class="table table-striped table-hover dataTables-example topics" style="margin-bottom: 2px;">
                    ...
                    <span> <p class="backside_bottom">
                       Website: <?php if(!empty($header_data[0]['Website'])){
                        echo $header_data[0]['Website'];} ?></p>
                         ...
                         <th style="width: 30%;text-align:  left;"><img style="width: 90px; height:95px; margin-top: 15px;" src="<?php echo base_url('images/teacher/').$info['0']['Image']?>"?> </th>
                    </tr>
                </table>
                 <table class="table table-striped" style="margin-bottom: 5px;">
                    
                        <tr >
                            <th style="width: 25%;text-align: right"><span style="margin-left:2px;"> Teacher's ID # </span></th>
                            <th style="width: 15%;text-align: left"><strong style="color: red; padding-left:10px">   <?php echo $info['0']['Teacher_UniqueID'] ?></strong></th>
                 ...
                 <div class="ibox-title" style="height:10px;">
                    <h6 style="font-size: 15px; "><strong style="border-bottom:  2px solid #bbb; margin-bottom:10px;">Teacher Information</strong></h6>
                </div>
            </table>
            ...
            <table  class="table" id="table1" class="" style="width:50%; border: 1px solid #ddd; margin: auto;">
                    ...
                    <tr >
                        <th style="width: 40%;text-align: left"><span style="margin-left:10px;">1. Teacher's Name :</span></th>
                        <th style="width: 60%; text-align: left"><span style="color: red; margin-left:8px;"> <?php echo $info['0']['Teacher_Name'] ?></span></th>
                        
                    </tr>
                    <tr>
                        <th style="width: 40%; text-align: left"><span style="margin-left:10px;"> 2. Father's Name:</span></th>
                        <th style="width: 60%; text-align: left"><span style="margin-left:8px;"> <?php echo $info['0']['Teacher_FathersName'] ?></span></th>
                    ...
                    <tr>
                        <th style="width: 40%; text-align: left"><span style="margin-left:10px;">4.Blood Group:</span></th>
                          <th style="width: 60%; text-align: left"><span style="margin-left:8px;">
                            <?php if ($info['0']['Teacher_BloodGroup']==1) {echo 'A+';} 
                            if ($info['0']['Teacher_BloodGroup']==2) { echo 'A -';}
                            if ($info['0']['Teacher_BloodGroup']==3) { echo 'B +';}
                            if ($info['0']['Teacher_BloodGroup']==4) { echo 'B -';}
                            if ($info['0']['Teacher_BloodGroup']==5) { echo 'AB +';}
                            if ($info['0']['Teacher_BloodGroup']==6) { echo 'AB -';}
                            if ($info['0']['Teacher_BloodGroup']==7) { echo 'O +';}
                            if ($info['0']['Teacher_BloodGroup']==8) { echo 'O +';}
                            ?>
                           </span>
                       </th>
                    </tr>
                     ...
                     <tr>
                        ...
                        <th style="width: 60%; text-align: left"><span style="margin-left:8px;"> <?php if ($info['0']['Teacher_medium']==1) {echo 'Bangla';} elseif ($info['0']['Teacher_medium']==2) { echo 'English';
                              }?> </span></th>
                    </tr>
                    <tr>
                        <th style="width: 40%; text-align: left"><span style="margin-left:10px;"> 6. Shift Name:</span></th>
                        <th style="width: 60%; text-align: left"><span style="margin-left:8px;"> <?php if ($info['0']['Teacher_shift']==1) {echo 'Day';} elseif ($info['0']['Teacher_shift']==2) { echo 'Morning';
                              }?> </span></th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <th style="width: 60%; text-align: left"><span style="margin-left:8px;"> <?php echo $info['0']['Teacher_address'] ?></span></th>
                   ...
                   <!--  <tr>
                     ...
                     <tr>
                        ...
                        <th style="width: 60%; text-align: left"><span style="margin-left:8px;"> <?php if ($info['0']['Teacher_religion']==1) {echo 'Muslim';} elseif ($info['0']['Teacher_religion']==2) { echo 'Hindus';
                              }?> </span></th>
                    </tr>

                    <tr>
                        <th style="width: 40%; text-align: left"><span style="margin-left:10px;"> 9. Gender:</span></th>
                        <th style="width: 60%; text-align: left"><span style="margin-left:8px;"> <?php if ($info['0']['Teacher_gender']==1) {echo 'Male';} elseif ($info['0']['Teacher_gender']==2) { echo 'Female';
                              }?> </span></th>
                    </tr>
                   
                    <tr>
                        <th style="width: 40%; text-align: left"><span style="margin-left:10px;">10. Mobile No:</span></th>
                        <th style="width: 60%; text-align: left"><span style="margin-left:8px;"> <?php echo $info['0']['Teacher_mobile'] ?></span></th>
                    </tr> 
                   
                    <tr>
                        <th style="width: 40%; text-align: left"><span style="margin-left:10px;">11. Email ID:</span></th>
                        <th style="width: 60%; text-align: left"><span style="margin-left:8px;"> <?php echo $info['0']['Teacher_email'] ?></span></th>
                    </tr>
                    <tr>
                        <th style="width: 40%; text-align: left"><span style="margin-left:10px;"> 13. Index No.:</span></th>
                        <th style="width: 60%; text-align: left"><span style="margin-left:8px;"> <?php echo $info['0']['Teacher_IndexNo'] ?></span></th>
                    </tr> 

                   <tr>
                        <th style="width: 40%; text-align: left"><span style="margin-left:10px;"> 14. National ID:</span></th>
                        <th style="width: 60%; text-align: left"><span style="margin-left:8px;"> <?php echo $info['0']['Teacher_NationalID'] ?></span></th>
                    </tr>
                    
                    <tr>
                        <th style="width: 40%; text-align: left"><span style="margin-left:10px;"> 15. Joining Date :</span></th>
                        <th style="width: 60%; text-align: left"><span style="margin-left:8px;"> <?php echo $info['0']['Teacher_joining_date'] ?></span></th>
                    </tr> 
            </table>
