...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="my-bg dashbard-1">
            ...
            <form action="<?php echo base_url();?>teacher/designation/designation_update" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="col-lg-12">
                        ...
                        if ($this->session->has_userdata('message')) {
                            ...
                            $this->session->unset_userdata('error_msg');
                    				    ...
                    				    //   echo "<pre>";
                    						// print_r($edit_designation_find['0']['images']);
                    						// echo "</pre>";
                    						// die();
                        ?>
                                            <div class="ibox-title" style="background:#243948">
                                                <h5 style="color:#D7E1ED"><i class=""></i> Edit designation</h5> 
                                                <div class="ibox-tools">
                                                    <a class="btn btn-primary" style="padding: 0 10px 0 10px;" href="<?php echo base_url();?>teacher/designation/all_designation"><i class='fa fa-user'></i>  designation List</a>
                                             ...
                                             <fieldset>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 inputGroupContainer" style="margin-top:15px;">
                                                        ...
                                                        <input value="<?php echo $edit_designation_find[0]['DesignationID'] ?>" name="DesignationID" type="hidden">
                                                      <input value="<?php if (!empty($edit_designation_find[0]['DesignationName'])) {
                                                 echo $edit_designation_find[0]['DesignationName'] ;}?>" name="designation_name"  class="form-control"  type="text" required>
                                                        </div>
                                                    </div>
                                                   ...
                                                   <div class="col-md-12">
                                                        ...
                                                        <select name="designation_status" class="form-control" required="required">
                                                            <option value="">Select Status</option>
                                                            <option value="1" <?php if ($edit_designation_find['0']['DesignationStatus']==1) {echo 
                                                            'selected';} ?>>Active</option>
                                                            <option value="0" <?php if ($edit_designation_find['0']['DesignationStatus'] ==0) { echo 'selected';
                                                            }?>>Inactive</option>
                                                        </select>
                                                       </div>
                                                    </div>
    ...
    <script src="<?php echo base_url();?>assets/dashboard/js/upload.js"></script>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                $("#designation_name").on('change keydown paste input', function(){
                    var designation_name = $('#designation_name').val();
                    var CategorySlug1  = designation_name.replace(/[&\/\\#,+()$~%.'":*?<>{}]অ/g, '');
