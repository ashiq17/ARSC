                              ...
                              <div class="panel-body">
                                 <div class="tab-content">
                                    <div class="tab-pane fade in active" id="tab1default">
                                       <div class="panel-body" id="teacher_basic_info1" style="display:none;">
                                       ...
                                       <form class=" form-horizontal" action="<?php echo base_url();?>teacher/teacher/teacher_info_add" method="post" enctype="multipart/form-data">
                                          <fieldset   style="width:900px; margin-top: 1px!important;  text-align:left;margin:auto;" >
                                             <!--  <div   style="width:900px;border:1px solid red; height:400px; text-align:center;margin:auto;" > -->
                                                <h2 style="text-align: center;color:#000;"> <u>Teacher Basic Information </u></h2>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group col-md-12 data_1">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer">
                                                         <input name="Teacher_UniqueID" id="teacher_uniqueid" onchange="teacher_uniqueid_keyup()" style="margin-top:5px;" class="form-control"  type="text">
                                                      </div>
                                                      <span id="teacher_uniqueid_msg" style="color: red;"></span>
                                                   </div> 
                                                   <div class="form-group  col-md-12 data_1">
                                                      <div class="col-md-4">
                                                   ...
                                                   <div class="form-group col-md-12 data_1">
                                                      ...
                                                      <div class="col-md-8 inputGroupContainer"  style="margin-top:5px;">
                                                         <div class="input-group date">
                                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input id="date2"  type="text" name="Teacher_joining_date" class="start_date form-control">
                                                         </div>
                                                      </div>
                                                   </div>
                                                ...
                                                <div class=" col-md-6">
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                         <select name="Teacher_BloodGroup"  style="text-align:left "  class="form-control selectpicker select2">
                                                   ...
                                                   <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                         <select name="Teacher_gender"  style="text-align:left "  class="form-control selectpicker">
                                                            <option value="" >SELECT</option>
                                                   ...
                                                   <div class="form-group col-md-12">
                                                     ...
                                                     <div class="form-group col-md-12">
                                                      ...
                                                      <div class="col-md-8 selectContainer"  style="margin-top:5px;">
                                                         <select name="Teacher_religion"  style="text-align:left "  class="form-control selectpicker">
                                                            <option value="" >SELECT</option>
                                   ...
                                   <div class="tab-pane fade" id="tab2default">
                                       <div class="panel-body  well" id="teacher_basic_info2" style="display:none;">
                                                ...
                                                <div class="panel panel-default">
                                                   <div class="panel-body ">
                                                      <div class="col-md-12">
                                                         <div class="col-md-7">
                                                         <div class="col-md-4">
                                                            <label style="text-align:left; padding:0px">Teacher Name:</label>
                                                         </div>
                                                         <div class="col-md-8 inputGroupContainer">
                                                      ...
                                                      <div class=" col-md-12 clearfix">
                                                         <div class="col-md-7">
                                                            ...
                                                            <div class="col-md-8 inputGroupContainer">
                                                               <span class="teacher_medium bold"></span>
                                                            </div>
                                                         </div>
                                                         <div class="col-md-5">
                                                            <div class="col-md-4">
                                                            ...
                                                            <div class="col-md-8 inputGroupContainer">
                                                               <span class="teacher_shift bold"></span>
                                                            </div>
                                                         </div>
                                                      </div>
                                                   </div>
                                       ...
                                       <form id="basicform" class="well form-horizontal" action="<?php echo base_url();?>teacher/teacher/teacher_user_info_add" method="post" enctype="multipart/form-data">
                                          <fieldset style="width:600px; text-align:left;margin:auto;">
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-6 selectContainer">
                                                   <select name="Teacher_UniqueID" class="form-control selectpicker select2" onchange="teacherInfo(this.value, 2)" required="required">
                                                      <option value="" title=""></option>
                                                      <?php foreach ($all_teacher_find_summary as $key => $value): ?>
                                                      <option value="<?php echo $value['Teacher_UniqueID'] ?>"><?php echo $value['Teacher_UniqueID']; ?></option>
                                                      <?php endforeach ?>
                                                   </select>
                                                </div>
                                             </div>
...
<script type="text/javascript">
   function teacherInfo(teacherid, tabid){
       for (var i = 0; i <= 11; i++) {
           if(i == tabid) {
               $("#teacher_basic_info"+tabid).show(500);
           } else {
               $("#teacher_basic_info"+i).hide();
           }
       };
   ...
   $.ajax({
   type: "POST",
   url: "<?php echo base_url();?>teacher/get_teacher_data",
   data: data,
   dataType: 'json',
   ...
   $(".designation").text(data[i].DesignationName);
    // alert(designation);
   $(".teacher_shift").text(data[i].Teacher_shift);
   $(".teacher_medium").text(data[i].Teacher_medium);
   $(".name").text(data[i].Teacher_Name);
   $(".email").text(data[i].Teacher_email);
   } // for
...
<script type="text/javascript">
   ...
   function teacher_uniqueid_keyup(){
       var teacher_uniqueid = $("#teacher_uniqueid").val();
   // alert(teacher_uniqueid);
   $.getJSON("<?php echo base_url();?>teacher/teacher/json_teacher_uniqueid_check?1=1&teacher_uniqueid="+teacher_uniqueid, function(data) {
   if(data.exist==1){
       document.getElementById('teacher_uniqueid_msg').innerHTML = "This Teacher ID is already existed!";
       document.getElementById('teacher_uniqueid').value = "";
   }else{
       document.getElementById('teacher_uniqueid_msg').innerHTML = "<span style='color:green;'>Available</span>";
   }
   });
   }
   ...
   function userid_keyup(){
    ...
    // alert(username);
        $.getJSON("<?php echo base_url();?>teacher/teacher/json_unique_username_check?1=1&username="+username, function(data) {
            // alert(data.exist);
            if(data.exist==1){
   ...
   function email_keyup(){
       var email = $("#email").val();
   // alert(email);
   $.getJSON("<?php echo base_url();?>teacher/teacher/json_unique_email_check?1=1&email="+email, function(data) {
   if(data.exist==1){
