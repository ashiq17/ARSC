                                            ...
                                            <fieldset>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 inputGroupContainer">
                                                        <input value="<?php echo $company_basic_info_find[0]['company_info_id'] ?>" readonly name="company_info_id" type="hidden"> 
                                                        <input onchange="userid_keyup()" 
                                                        value="<?php echo $company_basic_info_find[0]['company_id'] ?>" readonly name="company_id" id="comapny_id" class="form-control"  type="text" required>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 inputGroupContainer">  
                                                        <input  onchange="userid_keyup()" 
                                                        value="<?php echo $company_basic_info_find[0]['company_name'] ?>" readonly name="company_name"  class="form-control"  type="text" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 inputGroupContainer">
                                                        <input  onchange="userid_keyup()" 
                                                        value="<?php echo $company_basic_info_find[0]['website_address'] ?>" readonly name="website_address" class="form-control"  type="text" required >
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 inputGroupContainer">
                                                        <input onchange="userid_keyup()" 
                                                        value="<?php echo $company_basic_info_find[0]['email_address'] ?>" readonly name="email_address" class="form-control"  type="email" required  >
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 inputGroupContainer">
                                                            ...
                                                            <input onchange="userid_keyup()" 
                                                        value="<?php echo $company_basic_info_find[0]['mobile_no'] ?>" readonly name="mobile_no" class="form-control" type="text" id="phone" required>
                                                    </div>
                                                </div>
                                                <div class="form-group data_1">
                                                    ...
                                                    <div class="col-md-6 inputGroupContainer">
                                                        <div class="input-group date">
                                                            ...
                                                            <input id="date1" type="text" onchange="userid_keyup()" value="<?php echo $company_basic_info_find[0]['establishment_date'] ?>" readonly name="establishment_date" class="start_date form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 inputGroupContainer">
                                                        ...
                                                        value="" readonly name="address" class="form-control"><?php echo $company_basic_info_find[0]['address'] ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
