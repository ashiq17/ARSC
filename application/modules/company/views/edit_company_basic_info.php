                                ...
                                <div class="ibox float-e-margins">
                                    <div class="ibox-title" style="background:#243948">
                                        ...
                                        <div class="ibox-tools">
                                           <!--  <a class="btn btn-primary" style="padding: 0 10px 0 10px;" href="<?php echo base_url();?>company/company/company_list"><i class='fa fa-user'></i> Company List</a> -->
                                             <a class="btn btn-primary unreadable" style="padding: 0 10px 0 10px;" href="<?php echo base_url();?>company/company/company_basic_info" ><i class='fa fa-user'></i> Back </a>
                                        </div>
                                    </div>
                                    <?php
                                    ...
                                    <?php 
                                          ...
                                          // echo "<pre>";
                                          // print_r($company_basic_info_find);
                                          // echo "</pre>";
                                    ?>
                                    ...
                                    <div class="tab-pane fade in active" id="tab1default">
                                        <form class="well form-horizontal" action="<?php echo base_url();?>company/company/company_basic_info_update" method="post" enctype="multipart/form-data">
                                            <fieldset>
                                                <div class="form-group">
                                                    <label style="text-align:left" class="col-md-2 control-label"> <span class="required">*</span> Company Id No.</label>  
                                                    <div class="col-md-6 inputGroupContainer">
                                                        <input value="<?php echo $company_basic_info_find[0]['company_info_id'] ?>" name="company_info_id" type="hidden"> 
                                                        <input onchange="userid_keyup()" 
                                                        value="<?php echo $company_basic_info_find[0]['company_id'] ?>" name="company_id" id="comapny_id" class="form-control"  type="text" required>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 inputGroupContainer">  
                                                        <input  onchange="userid_keyup()" 
                                                        value="<?php echo $company_basic_info_find[0]['company_name'] ?>" name="company_name"  class="form-control"  type="text" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 inputGroupContainer">
                                                        <input  onchange="userid_keyup()" 
                                                        value="<?php echo $company_basic_info_find[0]['website_address'] ?>" name="website_address" class="form-control"  type="text" required >
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 inputGroupContainer">
                                                        <input onchange="userid_keyup()" 
                                                        value="<?php echo $company_basic_info_find[0]['email_address'] ?>" name="email_address" class="form-control"  type="email" required  >
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 inputGroupContainer">
                                                            ...
                                                            <input onchange="userid_keyup()" 
                                                        value="<?php echo $company_basic_info_find[0]['mobile_no'] ?>" name="mobile_no" class="form-control" type="text" id="phone" required>
                                                    </div>
                                                </div>
                                                <div class="form-group data_1">
                                                    ...
                                                    <div class="col-md-6 inputGroupContainer">
                                                        <div class="input-group date">
                                                            ...
                                                            <input id="date1" type="text" onchange="userid_keyup()" value="<?php echo $company_basic_info_find[0]['establishment_date'] ?>" name="establishment_date" class="start_date form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 inputGroupContainer">
                                                        <textarea  onchange="userid_keyup()" 
                                                        value="" name="address" class="form-control"><?php echo $company_basic_info_find[0]['address'] ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-3">
                                                    <img class="img-responsive" alt="No Image Found" src="<?php echo base_url('/images/company_images/').$company_basic_info_find[0]['company_logo'];?>"/>
                                                   
                                                    </div>
                                                      <div class="col-md-3 inputGroupContainer">
                                                        <input type="file" name="company_logo" id="imgInp" class="form-control" style="padding-top:5px;">
                                                       <input type="hidden"  id="old"  name="old_image"  value="<?php echo $company_basic_info_find[0]['company_logo']; ?>">
                                                        <br>
